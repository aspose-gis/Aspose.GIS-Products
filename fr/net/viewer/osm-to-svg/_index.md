...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Un aperçu pour convertir l'API OSM vers SVG .NET." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galerie d'Applications Web
      ...
      <p>
        Nous présentons des applications gratuites qui utilisent l’API .NET pour implémenter le <a href="https://products.aspose.app/gis/viewer/osm-to-svg" >"Convertisseur OSM vers SVG"</a> et d'autres. Vous pouvez explorer les fonctionnalités et la qualité de son fonctionnement ici. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Exemple pour .NET - Convertisseur OSM vers SVG
    </h2>
    <p>
     Voici comment convertir OSM vers SVG en utilisant les paramètres par défaut :
    </p>
