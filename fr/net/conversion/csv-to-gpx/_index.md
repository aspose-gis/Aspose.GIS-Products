...
{{% blocks/products/pf/agp/content h2="Comment convertir CSV en GPX à l'aide de C#" %}}

Afin de convertir CSV en GPX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir CSV en GPX en C#" %}}
...
1.  Un chemin d'accès au fichier du type chaîne vers le fichier CSV source
2.  Pilote source pour informer l'API sur le format d'entrée. Définissez-le sur Drivers.Csv
3.  Le chemin d'accès au fichier du type chaîne vers le fichier de données GPX de destination
...
{{% blocks/products/pf/agp/code-block title="Enregistrer CSV en tant que GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de CSV à GPX" sectionDescription="Convertissez CSV en GPX dès maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/csv-to-gpx). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier CSV, il sera instantanément converti en GPX." >}}
