---
title: Convertir TopoJSON en données SIG Shapefile via .NET ou C#
weight: 120
url: /fr/net/conversion/topojson-to-shapefile/ 
description: Essayez nos API sur site pour convertir TopoJSON en Shapefile sur .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir TopoJSON en Shapefile en C#" h2="Exporter TopoJSON en Shapefile à l'aide d'API côté serveur, sans avoir besoin de logiciels tels qu'ArcGIS, ArcMap, QGIS ou Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Shapefile" pfName="Aspose.GIS" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TopoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir TopoJSON en Shapefile à l'aide de C#" %}}

 Afin de convertir TopoJSON en Shapefile, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TopoJSON en Shapefile en C#" %}}
...
3.  Le chemin d'accès au fichier de données Shapefile de destination de type chaîne de caractères
...
{{% blocks/products/pf/agp/code-block title="Enregistrer TopoJSON en tant que Shapefile - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct TopoJSON vers Shapefile" sectionDescription="Convertissez TopoJSON en Shapefile dès maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/topojson-to-shapefile). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier TopoJSON, il sera instantanément converti en Shapefile." >}}
...
SHP est l'extension de fichier pour l'un des principaux types de fichiers utilisés pour la représentation d'ESRI Shapefile. Il représente les informations géospatiales sous forme de données vectorielles à utiliser par les applications de systèmes d'information géographique (SIG). Le format a été développé comme une spécification ouverte afin de faciliter l'interopérabilité entre ESRI et d'autres produits logiciels.
