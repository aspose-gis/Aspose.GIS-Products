...
{{% blocks/products/pf/agp/content h2="Comment convertir GPX en SHX à l'aide de C#" %}}

 Afin de convertir GPX en SHX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir GPX en SHX en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Enregistrer GPX en SHX - C#" offSpacer="" %}}

```cs
// Convertir les données SIG GPX en données SHX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct GPX vers SHX" sectionDescription="Convertissez GPX en SHX maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/gpx-to-shx). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier GPX, il sera instantanément converti en SHX." >}}
