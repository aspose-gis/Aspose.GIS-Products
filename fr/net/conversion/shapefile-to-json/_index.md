...
{{% blocks/products/pf/agp/content h2="Comment convertir Shapefile en JSON à l'aide de C#" %}}

Afin de convertir Shapefile en JSON, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir Shapefile en JSON en C#" %}}
...
1.  Un chemin d'accès au fichier de type chaîne vers le fichier Shapefile source
...
{{% blocks/products/pf/agp/code-block title="Enregistrer Shapefile en tant que JSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile to JSON Live Demos" sectionDescription="Convertir Shapefile en JSON maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/shapefile-to-json). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier Shapefile, il sera instantanément converti en JSON." >}}
