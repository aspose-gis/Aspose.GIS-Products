---
title: Convertir GDB en CSV GIS Data via .NET ou C#
weight: 120
url: /fr/net/conversion/gdb-to-csv/ 
description: Essayez nos API On-Premise pour convertir GDB en CSV sur .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir GDB en CSV en C#" h2="Exporter GDB vers CSV en utilisant des API côté serveur, sans avoir besoin de logiciels comme ArcGIS, ArcMap, QGIS ou Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="Aspose.GIS" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GDB" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir GDB en CSV avec C#" %}}

 Afin de convertir GDB en CSV, nous allons utiliser
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir GDB en CSV en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Enregistrer GDB en tant que CSV - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GDB to CSV Live Demos" sectionDescription="Convertir GDB en CSV maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/gdb-to-csv). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier GDB, il sera instantanément converti en CSV." >}}
