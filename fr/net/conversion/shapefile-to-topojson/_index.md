---
title: Convertir Shapefile en données TopoJSON GIS via .NET ou C#
weight: 120
url: /fr/net/conversion/shapefile-to-topojson/ 
description: Essayez nos API sur site pour convertir Shapefile en TopoJSON sur .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convertir Shapefile en TopoJSON en C#" h2="Exporter Shapefile en TopoJSON à l'aide d'API côté serveur, sans avoir besoin de logiciels tels que ArcGIS, ArcMap, QGIS ou Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TopoJSON" pfName="Aspose.GIS" subTitlepfName="pour .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir Shapefile en TopoJSON à l'aide de C#" %}}

 Afin de convertir Shapefile en TopoJSON, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir Shapefile en TopoJSON en C#" %}}
...
1.  Un chemin d'accès au fichier du type chaîne pour le fichier Shapefile source
2.  Pilote source pour informer l'API sur le format d'entrée. Définissez-le sur Drivers.Shapefile
3.  Le chemin d'accès au fichier du type chaîne pour le fichier de données TopoJSON de destination
...
{{% blocks/products/pf/agp/code-block title="Enregistrer Shapefile en tant que TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile vers TopoJSON - Démonstrations en direct" sectionDescription="Convertissez Shapefile en TopoJSON dès maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/shapefile-to-topojson). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier Shapefile, il sera instantanément converti en TopoJSON." >}}
