...
{{% blocks/products/pf/agp/content h2="Comment convertir TopoJSON en GeoJSON à l'aide de C#" %}}

 Afin de convertir TopoJSON en GeoJSON, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir TopoJSON en GeoJSON en C#" %}}
...
3.  Le chemin d'accès au fichier GeoJSON de destination de type chaîne de caractères
...
{{% blocks/products/pf/agp/code-block title="Enregistrer TopoJSON en tant que GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct TopoJSON vers GeoJSON" sectionDescription="Convertissez TopoJSON en GeoJSON dès maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/topojson-to-geojson). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier TopoJSON, il sera instantanément converti en GeoJSON." >}}
...
GeoJSON est un format basé sur JSON conçu pour représenter les entités géographiques avec leurs attributs non spatiaux. Ce format définit différents objets JSON (JavaScript Object Notation) et leur mode d'assemblage. Le JSON représente des informations collectives sur les entités géographiques, leurs étendues spatiales et leurs propriétés.
