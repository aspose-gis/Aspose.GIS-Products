...
{{% blocks/products/pf/agp/content h2="Comment convertir SHX en JSON à l'aide de C#" %}}

 Afin de convertir SHX en JSON, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir SHX en JSON en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Enregistrer SHX en tant que JSON - C#" offSpacer="" %}}

```cs
// Convertir les données SIG SHX en données JSON
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct SHX vers JSON" sectionDescription="Convertissez SHX en JSON dès maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/shx-to-json). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier SHX, il sera instantanément converti en JSON." >}}
