...
{{% blocks/products/pf/agp/content h2="Comment convertir CSV en SHP à l'aide de C#" %}}

 Afin de convertir CSV en SHP, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir CSV en SHP en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Enregistrer CSV en SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de CSV à SHP" sectionDescription="Convertissez CSV en SHP dès maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/csv-to-shp). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier CSV, il sera instantanément converti en SHP." >}}
...
Les fichiers avec l'extension CSV (Comma Separated Values) représentent des fichiers texte simples qui contiennent des enregistrements de données avec des valeurs séparées par des virgules. Chaque ligne d'un fichier CSV est un nouvel enregistrement de l'ensemble des enregistrements contenus dans le fichier. Ces fichiers sont générés lorsque le transfert de données est prévu d'un système de stockage à un autre. Étant donné que toutes les applications peuvent reconnaître les enregistrements séparés par une virgule, l'importation de ces fichiers de données dans une base de données se fait très facilement.
 ...
 Shapefile est un format de fichier multi (connu sous le nom de ESRI Shapefile). Le principal a l'extension SHP. Shapefile est un format de fichier vectoriel géographique populaire. Développé et maintenu par ESRI pour la compatibilité entre les produits Esri et d'autres programmes.
