...
{{% blocks/products/pf/agp/content h2="Comment convertir KML en GPX à l'aide de C#" %}}

 Afin de convertir KML en GPX, nous allons utiliser
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir KML en GPX en C#" %}}
...
1.  Un chemin d'accès au fichier source KML de type chaîne de caractères
2.  Pilote source pour indiquer à l'API le format d'entrée. Définissez-le sur Drivers.Kml
...
{{% blocks/products/pf/agp/code-block title="Enregistrer KML en tant que GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de KML à GPX" sectionDescription="Convertissez KML en GPX dès maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/kml-to-gpx). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier KML, il sera instantanément converti en GPX." >}}
