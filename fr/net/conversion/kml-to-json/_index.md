...
{{% blocks/products/pf/agp/content h2="Comment convertir KML en GeoJSON à l'aide de C#" %}}

 Afin de convertir KML en GeoJSON, nous allons utiliser
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir KML en GeoJSON en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Enregistrer KML au format GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de KML à GeoJSON" sectionDescription="Convertissez KML en GeoJSON dès maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/kml-to-json). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier KML, il sera instantanément converti en GeoJSON." >}}
