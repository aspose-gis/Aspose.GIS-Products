...
{{% blocks/products/pf/agp/content h2="Comment convertir CSV en GeoJSON à l'aide de C#" %}}

Afin de convertir CSV en GeoJSON, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir CSV en GeoJSON en C#" %}}
...
1.  Un chemin d'accès au fichier de type chaîne vers le fichier CSV source
...
{{% blocks/products/pf/agp/code-block title="Enregistrer CSV au format GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de CSV à GeoJSON" sectionDescription="Convertissez CSV en GeoJSON dès maintenant en visitant notre [site web de démonstrations en direct](https://products.aspose.app/gis/conversion/csv-to-geojson). La démo en direct présente les avantages suivants" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez votre fichier CSV, il sera instantanément converti en GeoJSON." >}}
