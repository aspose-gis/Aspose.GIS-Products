---
title: แปลง GeoJSON เป็นข้อมูล GIS CSV ผ่าน .NET หรือ C#
weight: 120
url: /th/net/conversion/geojson-to-csv/
description: ลองใช้ On-Premise APIs ของเราเพื่อแปลง GeoJSON เป็น CSV บน .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง GeoJSON เป็น CSV ใน C#" h2="ส่งออก GeoJSON ไปยัง CSV โดยใช้ APIs ด้านเซิร์ฟเวอร์ โดยไม่ต้องใช้ซอฟต์แวร์เช่น ArcGIS, ArcMap, QGIS หรือ Google Earth" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="Aspose.GIS" subTitlepfName="สำหรับ .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GeoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง GeoJSON เป็น CSV โดยใช้ C#" %}}

 เพื่อที่จะแปลง GeoJSON เป็น CSV เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง GeoJSON เป็น CSV ใน C#" %}}
...
2.  ไดรเวอร์แหล่งที่มาเพื่อให้ API ทราบเกี่ยวกับรูปแบบอินพุต ตั้งค่าเป็น Drivers.GeoJson
...
{{% blocks/products/pf/agp/code-block title="บันทึก GeoJSON เป็น CSV - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="การสาธิตสด GeoJSON ถึง CSV" sectionDescription="แปลง GeoJSON เป็น CSV ทันทีโดยไปที่ [เว็บไซต์การสาธิตสด](https://products.aspose.app/gis/conversion/geojson-to-csv) การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ GeoJSON ของคุณ จะถูกแปลงเป็น CSV ทันที." >}}
 ...
 Aspose.GIS for .NET เป็น API การจัดการและการแปลงข้อมูล GIS รองรับการอ่าน เขียน และแปลงรูปแบบข้อมูล GIS ที่มีชื่อเสียง เช่น ESRI Shapefiles, GeoJSON, TopoJSON, ESRI Geodatabase, Geography Markup Language, Google Earth, GPS Exchange Format, MapInfo Formats และ OpenStreetMap อย่างเต็มที่ เป็น API ที่ใช้ .NET แบบสแตนด์อโลนและไม่ต้องการซอฟต์แวร์ GIS ใดๆ เช่น ArcGIS / ArcMap, QGIS เป็นต้น
