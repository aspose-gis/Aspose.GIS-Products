...
{{% blocks/products/pf/agp/content h2="วิธีแปลง KML เป็น SHP โดยใช้ C#" %}}

 เพื่อที่จะแปลง KML เป็น SHP เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง KML เป็น SHP ใน C#" %}}
...
2.  ไดรเวอร์ต้นฉบับเพื่อให้ API ทราบเกี่ยวกับรูปแบบอินพุต ตั้งค่าเป็น Drivers.Kml
...
{{% blocks/products/pf/agp/code-block title="บันทึก KML เป็น SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML to SHP Live Demos" sectionDescription="แปลง KML เป็น SHP ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/kml-to-shp). การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ KML ของคุณ จะถูกแปลงเป็น SHP ทันที" >}}
...
KML (Keyhole Markup Language) มีข้อมูลเชิงพื้นที่ในรูปแบบ XML KML สามารถเปิดได้ในแอปพลิเคชัน Geographic Information System (GIS) หากรองรับ แอปพลิเคชันจำนวนมากเริ่มให้การสนับสนุนรูปแบบ KML หลังจากได้รับการยอมรับว่าเป็นมาตรฐานสากล

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="SHP" readMoreLink="https://docs.fileformat.com/gis/shp/" >}}

 Shapefile เป็นรูปแบบไฟล์หลายไฟล์ (ที่รู้จักกันในชื่อ ESRI Shapefile) หลักมีนามสกุล SHP Shapefile เป็นรูปแบบไฟล์เวกเตอร์ทางภูมิศาสตร์ยอดนิยม พัฒนาและบำรุงรักษาโดย ESRI เพื่อความเข้ากันได้ระหว่างผลิตภัณฑ์ Esri และโปรแกรมอื่นๆ
