...
{{% blocks/products/pf/agp/content h2="วิธีแปลง SHP เป็น GPX โดยใช้ C#" %}}

 เพื่อที่จะแปลง SHP เป็น GPX เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง SHP เป็น GPX ใน C#" %}}
...
1.  ประเภทสตริง path ไฟล์ไปยังไฟล์ SHP ต้นทาง
2.  source driver เพื่อให้ API ทราบเกี่ยวกับรูปแบบอินพุต ตั้งค่าเป็น Drivers.Shapefile
3.  path ไฟล์ประเภทสตริงไปยังไฟล์ข้อมูล GPX ปลายทาง
...
{{% blocks/products/pf/agp/code-block title="บันทึก SHP เป็น GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SHP to GPX Live Demos" sectionDescription="แปลง SHP เป็น GPX ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/shp-to-gpx) การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ SHP ของคุณ จะถูกแปลงเป็น GPX ทันที." >}}
 ...
 GPX extension แสดงถึงรูปแบบ GPS Exchange สำหรับการแลกเปลี่ยนข้อมูล GPS ระหว่างแอปพลิเคชันและบริการเว็บบนอินเทอร์เน็ต เป็นรูปแบบ XML ที่มีน้ำหนักเบาซึ่งมีข้อมูล GPS เช่น waypoints, routes และ tracks เพื่อนำเข้าและอ่านโดยโปรแกรมต่างๆ GPX เปิดและได้รับการสนับสนุนจากแอปพลิเคชันและอุปกรณ์ GPS หลากหลาย
