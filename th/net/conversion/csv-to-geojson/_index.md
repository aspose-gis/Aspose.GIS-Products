---
title: แปลง CSV เป็นข้อมูล GIS GeoJSON ผ่าน .NET หรือ C#
weight: 120
url: /th/net/conversion/csv-to-geojson/
description: ลองใช้ On-Premise APIs ของเราเพื่อแปลง CSV เป็น GeoJSON บน .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง CSV เป็น GeoJSON ใน C#" h2="ส่งออก CSV เป็น GeoJSON โดยใช้ APIs ด้านเซิร์ฟเวอร์ โดยไม่ต้องใช้ซอฟต์แวร์อย่าง ArcGIS, ArcMap, QGIS หรือ Google Earth" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="สำหรับ .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง CSV เป็น GeoJSON โดยใช้ C#" %}}

 เพื่อที่จะแปลง CSV เป็น GeoJSON เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแปลง CSV เป็น GeoJSON ใน C#" %}}
...
4.  ปลายทางไดรเวอร์เพื่อระบุรูปแบบเอาต์พุต ตั้งค่าเป็น Drivers.GeoJson
...
{{% blocks/products/pf/agp/code-block title="บันทึก CSV เป็น GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV to GeoJSON Live Demos" sectionDescription="แปลง CSV เป็น GeoJSON ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/csv-to-geojson) การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ CSV ของคุณ จะถูกแปลงเป็น GeoJSON ทันที" >}}
