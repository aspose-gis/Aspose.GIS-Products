...
{{% blocks/products/pf/agp/content h2="วิธีแปลง GEOJSON เป็น SHX โดยใช้ C#" %}}

 เพื่อที่จะแปลง GEOJSON เป็น SHX เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนสำหรับการแปลง GEOJSON เป็น SHX ใน C#" %}}
...
3.  เส้นทางไฟล์ประเภทสตริงไปยังไฟล์ข้อมูล SHX ปลายทาง
...
{{% blocks/products/pf/agp/code-block title="บันทึก GEOJSON เป็น SHX - C#" offSpacer="" %}}

```cs
// แปลงข้อมูล GIS GEOJSON เป็นข้อมูล SHX
...
{{< blocks/products/pf/agp/demobox sectionTitle="การสาธิตสด GEOJSON ถึง SHX" sectionDescription="แปลง GEOJSON เป็น SHX ทันทีโดยไปที่เว็บไซต์ [การสาธิตสด](https://products.aspose.app/gis/conversion/geojson-to-shx) ของเรา การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ GEOJSON ของคุณ จะถูกแปลงเป็น SHX ทันที" >}}
...
GeoJSON เป็นรูปแบบตาม JSON ที่ออกแบบมาเพื่อแสดงคุณสมบัติทางภูมิศาสตร์พร้อมกับแอตทริบิวต์ที่ไม่ใช่เชิงพื้นที่ รูปแบบนี้กำหนดออบเจกต์ JSON ต่างๆ และวิธีการเชื่อมต่อกัน ออบเจกต์ของไฟล์นี้อาจระบุรูปทรงเรขาคณิต (จุด เส้นตรง รูปหลายเหลี่ยม) คุณสมบัติ หรือชุดคุณสมบัติ คุณสมบัติสะท้อนถึงที่อยู่และสถานที่ในรูปแบบจุด ถนนสายหลักและพรมแดนในรูปแบบเส้นตรง และประเทศ จังหวัด และภูมิภาคที่ดินในรูปแบบรูปหลายเหลี่ยม การใช้ GeoJSON แอปพลิเคชันการนำทางและการกำหนดเส้นทางบนมือถือต่างๆ สามารถระบุขอบเขตของบริการได้ การขยาย GEOJSON คือ TopoJSON ซึ่งมีขนาดเล็กกว่าและเข้ารหัสโทโพโลยีเชิงพื้นที่
อ่านเพิ่มเติม
...
รูปแบบดัชนีรูปทรง เป็นดัชนีตำแหน่งของเรขาคณิตคุณสมบัติเพื่อให้สามารถค้นหาไปข้างหน้าและย้อนกลับได้อย่างรวดเร็ว
อ่านเพิ่มเติม
