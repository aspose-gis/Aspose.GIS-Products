---
title: แปลง TopoJSON เป็นข้อมูล GIS Shapefile ผ่าน .NET หรือ C#
weight: 120
url: /th/net/conversion/topojson-to-shapefile/
description: ลองใช้ On-Premise APIs ของเราเพื่อแปลง TopoJSON เป็น Shapefile บน .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง TopoJSON เป็น Shapefile ใน C#" h2="ส่งออก TopoJSON เป็น Shapefile โดยใช้ APIs ด้านเซิร์ฟเวอร์ โดยไม่ต้องใช้ซอฟต์แวร์เช่น ArcGIS, ArcMap, QGIS หรือ Google Earth" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Shapefile" pfName="Aspose.GIS" subTitlepfName="สำหรับ .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TopoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง TopoJSON เป็น Shapefile โดยใช้ C#" %}}

 เพื่อที่จะแปลง TopoJSON เป็น Shapefile เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง TopoJSON เป็น Shapefile ใน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="บันทึก TopoJSON เป็น Shapefile - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON to Shapefile Live Demos" sectionDescription="แปลง TopoJSON เป็น Shapefile ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/topojson-to-shapefile) สาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ TopoJSON ของคุณ จะถูกแปลงเป็น Shapefile ทันที" >}}
...
SHP เป็นนามสกุลไฟล์สำหรับหนึ่งในประเภทไฟล์หลักที่ใช้สำหรับการแสดง ESRI Shapefile แสดงข้อมูลเชิงพื้นที่ในรูปแบบข้อมูลเวกเตอร์ที่จะใช้โดยแอปพลิเคชัน Geographic Information Systems (GIS) รูปแบบได้รับการพัฒนาเป็นข้อกำหนดเปิดเพื่อให้เอื้อต่อการทำงานร่วมกันระหว่าง ESRI และผลิตภัณฑ์ซอฟต์แวร์อื่นๆ
