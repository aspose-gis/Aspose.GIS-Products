---
title: แปลง OSM เป็นข้อมูล GIS แบบ KML โดยใช้ .NET หรือ C#
weight: 120
url: /th/net/conversion/osm-to-kml/ 
description: ลองใช้ On-Premise APIs ของเราเพื่อแปลง OSM เป็น KML บน .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง OSM เป็น KML ใน C#" h2="ส่งออก OSM เป็น KML โดยใช้ APIs ด้านเซิร์ฟเวอร์ โดยไม่ต้องใช้ซอฟต์แวร์อย่าง ArcGIS, ArcMap, QGIS หรือ Google Earth" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="สำหรับ .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="OSM" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง OSM เป็น KML โดยใช้ C#" %}}

 เพื่อที่จะแปลง OSM เป็น KML เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนการแปลง OSM เป็น KML ใน C#" %}}

{{% blocks/products/pf/agp/text %}}

 การแปลงสามารถทำได้ด้วยบรรทัดโค้ดเดียวขณะใช้
 *VectorLayer.Convert* 
...
{{% blocks/products/pf/agp/code-block title="บันทึก OSM เป็น KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="OSM to KML Live Demos" sectionDescription="แปลง OSM เป็น KML ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/osm-to-kml). การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ OSM ของคุณ จะถูกแปลงเป็น KML ทันที." >}}
...
{{< blocks/products/pf/agp/other-supported-section title="การแปลงอื่นๆ ที่รองรับ" subTitle="คุณยังสามารถแปลง OSM เป็นรูปแบบไฟล์อื่น ๆ ได้อีกมากมาย รวมถึงรายการด้านล่างนี้" >}}
