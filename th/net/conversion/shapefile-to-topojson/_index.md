---
title: แปลง Shapefile เป็นข้อมูล GIS TopoJSON ผ่านทาง .NET หรือ C#
weight: 120
url: /th/net/conversion/shapefile-to-topojson/ 
description: ลองใช้ On-Premise APIs ของเราเพื่อแปลง Shapefile เป็น TopoJSON บน .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="แปลง Shapefile เป็น TopoJSON ใน C#" h2="ส่งออก Shapefile ไปยัง TopoJSON โดยใช้ APIs ด้านเซิร์ฟเวอร์ โดยไม่ต้องใช้ซอฟต์แวร์เช่น ArcGIS, ArcMap, QGIS หรือ Google Earth" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TopoJSON" pfName="Aspose.GIS" subTitlepfName="สำหรับ .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง Shapefile เป็น TopoJSON โดยใช้ C#" %}}

 เพื่อที่จะแปลง Shapefile เป็น TopoJSON เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง Shapefile เป็น TopoJSON ใน C#" %}}
...
3.  พาธไฟล์ประเภทสตริงไปยังข้อมูล TopoJSON ปลายทาง
...
{{% blocks/products/pf/agp/code-block title="บันทึก Shapefile เป็น TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile to TopoJSON Live Demos" sectionDescription="แปลง Shapefile เป็น TopoJSON ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/shapefile-to-topojson) สาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ Shapefile ของคุณ จะถูกแปลงเป็น TopoJSON ทันที" >}}
...
{{< blocks/products/pf/agp/other-supported-section title="การแปลงอื่นๆ ที่รองรับ" subTitle="คุณยังสามารถแปลง Shapefile เป็นรูปแบบไฟล์อื่น ๆ ได้อีกมากมาย รวมถึงรายการด้านล่าง" >}}
