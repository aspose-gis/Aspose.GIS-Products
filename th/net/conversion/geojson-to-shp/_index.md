...
{{% blocks/products/pf/agp/content h2="วิธีแปลง GeoJSON เป็น SHP โดยใช้ C#" %}}

 เพื่อที่จะแปลง GeoJSON เป็น SHP เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนสำหรับการแปลง GeoJSON เป็น SHP ใน C#" %}}
...
3.  พาธไฟล์ประเภทสตริงไปยังไฟล์ข้อมูล SHP ปลายทาง
...
{{% blocks/products/pf/agp/code-block title="บันทึก GeoJSON เป็น SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="การสาธิตสด GeoJSON ถึง SHP" sectionDescription="แปลง GeoJSON เป็น SHP ทันทีโดยไปที่เว็บไซต์ [Live Demos](https://products.aspose.app/gis/conversion/geojson-to-shp) ของเรา การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ GeoJSON ของคุณ จะถูกแปลงเป็น SHP ทันที" >}}
...
GeoJSON เป็นรูปแบบตาม JSON ที่ออกแบบมาเพื่อแสดงคุณสมบัติทางภูมิศาสตร์พร้อมกับแอตทริบิวต์ที่ไม่ใช่เชิงพื้นที่ รูปแบบนี้กำหนดออบเจกต์ JSON ต่างๆ และวิธีการเชื่อมต่อกัน JSON แสดงข้อมูลโดยรวมเกี่ยวกับคุณสมบัติทางภูมิศาสตร์ ขอบเขตเชิงพื้นที่ และคุณสมบัติ
 ...
 Shapefile เป็นรูปแบบไฟล์หลายไฟล์ (ที่รู้จักกันในชื่อ ESRI Shapefile) หลักมีนามสกุล SHP Shapefile เป็นรูปแบบไฟล์เวกเตอร์ทางภูมิศาสตร์ยอดนิยม พัฒนาและดูแลโดย ESRI เพื่อความเข้ากันได้ระหว่างผลิตภัณฑ์ Esri และโปรแกรมอื่นๆ
