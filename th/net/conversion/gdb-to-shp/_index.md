...
{{% blocks/products/pf/agp/content h2="วิธีแปลง GDB เป็น SHP โดยใช้ C#" %}}

 เพื่อที่จะแปลง GDB เป็น SHP เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนสำหรับการแปลง GDB เป็น SHP ใน C#" %}}
...
1.  เส้นทางไฟล์ประเภทสตริงไปยังไฟล์ GDB ต้นฉบับ
2.  แหล่งที่มาของไดรเวอร์เพื่อให้ API ทราบเกี่ยวกับรูปแบบอินพุต ตั้งค่าเป็น Drivers.FileGdb
...
{{% blocks/products/pf/agp/code-block title="บันทึก GDB เป็น SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GDB to SHP Live Demos" sectionDescription="แปลง GDB เป็น SHP ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/gdb-to-shp). การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ GDB ของคุณ จะถูกแปลงเป็น SHP ทันที" >}}
...
GDB คือรูปแบบที่ใช้โดยแพลตฟอร์ม Esri ArcGIS นี่คือโฟลเดอร์ที่มีคอลเลกชันของไฟล์ .gdbtable, .gdbtablx, .gdbindexes, .atx, .spx และ .freelist เป็นต้น

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="SHP" readMoreLink="https://docs.fileformat.com/gis/shp/" >}}

 Shapefile เป็นรูปแบบไฟล์แบบหลายไฟล์ (ที่รู้จักกันในชื่อ ESRI Shapefile) หลักมีนามสกุล SHP Shapefile เป็นรูปแบบไฟล์เวกเตอร์ทางภูมิศาสตร์ยอดนิยม พัฒนาและดูแลโดย ESRI เพื่อความเข้ากันได้ระหว่างผลิตภัณฑ์ Esri และโปรแกรมอื่นๆ
