...
{{% blocks/products/pf/agp/content h2="วิธีแปลง Shapefile เป็น KML โดยใช้ C#" %}}

 เพื่อที่จะแปลง Shapefile เป็น KML เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง Shapefile เป็น KML ใน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="บันทึก Shapefile เป็น KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile to KML Live Demos" sectionDescription="แปลง Shapefile เป็น KML ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/shapefile-to-kml) การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ Shapefile ของคุณ จะถูกแปลงเป็น KML ทันที." >}}
...
KML (Keyhole Markup Language) มีข้อมูลเชิงพื้นที่ในรูปแบบ XML KML สามารถเปิดได้ในแอปพลิเคชัน Geographic Information System (GIS) ที่รองรับ หลังจากที่ได้รับการยอมรับว่าเป็นมาตรฐานสากล แอปพลิเคชันหลายแห่งเริ่มให้การสนับสนุนรูปแบบ KML
