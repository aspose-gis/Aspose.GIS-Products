...
{{% blocks/products/pf/agp/content h2="วิธีแปลง KML เป็น GPX โดยใช้ C#" %}}

 เพื่อที่จะแปลง KML เป็น GPX เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนสำหรับการแปลง KML เป็น GPX ใน C#" %}}
...
1.  เส้นทางไฟล์ประเภท string ไปยังไฟล์ KML ต้นฉบับ
2.  source driver เพื่อให้ API ทราบเกี่ยวกับรูปแบบอินพุต ตั้งค่าเป็น Drivers.Kml
...
{{% blocks/products/pf/agp/code-block title="บันทึก KML เป็น GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML to GPX Live Demos" sectionDescription="แปลง KML เป็น GPX ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/kml-to-gpx). การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ KML ของคุณ จะถูกแปลงเป็น GPX ทันที" >}}
