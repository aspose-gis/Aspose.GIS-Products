...
{{% blocks/products/pf/agp/content h2="วิธีแปลง JSON เป็น GeoJSON โดยใช้ C#" %}}

 เพื่อที่จะแปลง JSON เป็น GeoJSON เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง JSON เป็น GeoJSON ใน C#" %}}
...
4.  ปลายทางของไดรเวอร์เพื่อระบุรูปแบบเอาต์พุต ตั้งค่าเป็น Drivers.GeoJson
...
{{% blocks/products/pf/agp/code-block title="บันทึก JSON เป็น GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="JSON to GeoJSON Live Demos" sectionDescription="แปลง JSON เป็น GeoJSON ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/json-to-geojson) การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ JSON ของคุณ จะถูกแปลงเป็น GeoJSON ทันที" >}}
