...
{{% blocks/products/pf/agp/content h2="วิธีแปลง GML เป็น SHP โดยใช้ C#" %}}

 เพื่อที่จะแปลง GML เป็น SHP เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง GML เป็น SHP ใน C#" %}}
...
1.  เส้นทางไฟล์ประเภทสตริงไปยังไฟล์ GML ต้นฉบับ
...
{{% blocks/products/pf/agp/code-block title="บันทึก GML เป็น SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML to SHP Live Demos" sectionDescription="แปลง GML เป็น SHP ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/gml-to-shp). การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ GML ของคุณ จะถูกแปลงเป็น SHP ทันที" >}}
...
Geographic Markup Language (หรือที่เรียกว่า GML) เป็นรูปแบบตาม XML ที่ใช้ใน GIS GML เป็นรูปแบบการแลกเปลี่ยนแบบเปิดสำหรับการทำธุรกรรมทางภูมิศาสตร์บนอินเทอร์เน็ต รูปแบบนี้เน้นข้อมูลและโครงสร้าง
 ...
 Shapefile เป็นรูปแบบไฟล์แบบหลายไฟล์ (หรือที่เรียกว่า ESRI Shapefile) ไฟล์หลักมีนามสกุล SHP Shapefile เป็นรูปแบบไฟล์เวกเตอร์ทางภูมิศาสตร์ยอดนิยม พัฒนาและดูแลโดย ESRI เพื่อความเข้ากันได้ระหว่างผลิตภัณฑ์ Esri และโปรแกรมอื่นๆ
