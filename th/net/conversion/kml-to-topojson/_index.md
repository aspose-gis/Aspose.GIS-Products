...
{{% blocks/products/pf/agp/content h2="วิธีแปลง KML เป็น TopoJSON โดยใช้ C#" %}}

 เพื่อที่จะแปลง KML เป็น TopoJSON เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง KML เป็น TopoJSON ใน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="บันทึก KML เป็น TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML to TopoJSON Live Demos" sectionDescription="แปลง KML เป็น TopoJSON ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/kml-to-topojson) การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ KML ของคุณ จะถูกแปลงเป็น TopoJSON ทันที" >}}
