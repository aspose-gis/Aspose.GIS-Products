...
{{% blocks/products/pf/agp/content h2="วิธีแปลง KML เป็น Shapefile โดยใช้ C#" %}}

 เพื่อที่จะแปลง KML เป็น Shapefile เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง KML เป็น Shapefile ใน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="บันทึก KML เป็น Shapefile - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML to Shapefile Live Demos" sectionDescription="แปลง KML เป็น Shapefile ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/kml-to-shapefile). การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ KML ของคุณ จะถูกแปลงเป็น Shapefile ทันที" >}}
...
SHP คือนามสกุลไฟล์สำหรับหนึ่งในประเภทไฟล์หลักที่ใช้สำหรับการแสดง ESRI Shapefile แสดงข้อมูลเชิงพื้นที่ในรูปแบบเวกเตอร์เพื่อใช้โดยแอปพลิเคชัน Geographic Information System (GIS) รูปแบบได้รับการพัฒนาเป็นข้อกำหนดเปิดเพื่อให้เอื้อต่อการทำงานร่วมกันระหว่าง ESRI และผลิตภัณฑ์ซอฟต์แวร์อื่นๆ
