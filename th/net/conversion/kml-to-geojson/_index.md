...
weight: 120
url: /th/net/conversion/kml-to-geojson/
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนสำหรับการแปลง KML เป็น GeoJSON ใน C#" %}}
...
GeoJSON เป็นรูปแบบตาม JSON ที่ออกแบบมาเพื่อแสดงคุณสมบัติทางภูมิศาสตร์พร้อมกับแอตทริบิวต์ที่ไม่ใช่เชิงพื้นที่ รูปแบบนี้กำหนดออบเจ็กต์ JSON (JavaScript Object Notation) ต่างๆ และวิธีการรวมกัน JSON แสดงข้อมูลโดยรวมเกี่ยวกับคุณสมบัติทางภูมิศาสตร์ ขอบเขตเชิงพื้นที่ และคุณสมบัติ
