...
{{% blocks/products/pf/agp/content h2="วิธีแปลง Shapefile เป็น JSON โดยใช้ C#" %}}

 เพื่อที่จะแปลง Shapefile เป็น JSON เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง Shapefile เป็น JSON ใน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="บันทึก Shapefile เป็น JSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile to JSON Live Demos" sectionDescription="แปลง Shapefile เป็น JSON ได้ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/gis/conversion/shapefile-to-json) สาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" อัปโหลดไฟล์ Shapefile ของคุณ จะถูกแปลงเป็น JSON ทันที" >}}
...
SHP คือส่วนขยายไฟล์สำหรับหนึ่งในประเภทไฟล์หลักที่ใช้สำหรับการแสดง ESRI Shapefile แสดงข้อมูลทางภูมิศาสตร์ในรูปแบบข้อมูลเวกเตอร์เพื่อใช้กับแอปพลิเคชัน Geographic Information Systems (GIS) รูปแบบได้รับการพัฒนาเป็นข้อกำหนดเปิดเพื่อให้เอื้อต่อการทำงานร่วมกันระหว่าง ESRI และผลิตภัณฑ์ซอฟต์แวร์อื่นๆ

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="JSON" readMoreLink="https://docs.fileformat.com/gis/geojson/" >}}

รูปแบบตาม JSON ที่ออกแบบมาเพื่อแสดงคุณสมบัติทางภูมิศาสตร์พร้อมกับแอตทริบิวต์ที่ไม่ใช่เชิงพื้นที่ รูปแบบนี้กำหนดออบเจ็กต์ JSON ต่างๆ และวิธีการเชื่อมต่อกัน JSON แสดงข้อมูลโดยรวมเกี่ยวกับคุณสมบัติทางภูมิศาสตร์ ขอบเขตเชิงพื้นที่ และคุณสมบัติ
