---
title: Konwertuj GeoJSON do SHP GIS Data za pomocą .NET lub C#
weight: 120
url: /pl/net/conversion/geojson-to-shp/ 
description: Wypróbuj nasze API On-Premise, aby konwertować GeoJSON do SHP w .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj GeoJSON do SHP w C#" h2="Eksportuj GeoJSON do SHP za pomocą API po stronie serwera, bez konieczności używania oprogramowania takiego jak ArcGIS, ArcMap, QGIS lub Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SHP" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GeoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować GeoJSON do SHP za pomocą C#" %}}

Aby przekonwertować GeoJSON do SHP, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki konwersji GeoJSON do SHP w C#" %}}
...
3.  Ścieżka do pliku docelowego SHP danych w typie string
...
{{% blocks/products/pf/agp/code-block title="Zapisz GeoJSON jako SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GeoJSON do SHP Live Demos" sectionDescription="Konwertuj GeoJSON do SHP już teraz, odwiedzając naszą [stronę z demonstracjami na żywo](https://products.aspose.app/gis/conversion/geojson-to-shp). Demonstracja na żywo ma następujące korzyści" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Prześlij swój plik GeoJSON, zostanie natychmiast przekonwertowany na SHP." >}}
