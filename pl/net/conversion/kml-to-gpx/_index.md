---
title: Konwertuj KML do GPX GIS Data za pomocą .NET lub C#
weight: 120
url: /pl/net/conversion/kml-to-gpx/ 
description: Wypróbuj nasze API On-Premise, aby konwertować KML do GPX na platformie .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj KML do GPX w C#" h2="Eksportuj KML do GPX za pomocą API po stronie serwera, bez konieczności oprogramowania takiego jak ArcGIS, ArcMap, QGIS lub Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GPX" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować KML do GPX za pomocą C#" %}}

Aby przekonwertować KML na GPX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki konwersji KML do GPX w C#" %}}
...
3.  Ścieżka do pliku danych wyjściowych GPX w typie string
...
{{% blocks/products/pf/agp/code-block title="Zapisz KML jako GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML do GPX Live Demos" sectionDescription="Konwertuj KML na GPX już teraz, odwiedzając naszą stronę [Live Demos](https://products.aspose.app/gis/conversion/kml-to-gpx). Demo na żywo ma następujące korzyści" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Prześlij plik KML, zostanie natychmiast przekonwertowany na GPX." >}}
