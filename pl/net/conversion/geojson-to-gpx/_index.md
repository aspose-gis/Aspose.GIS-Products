---
title: Konwertuj GeoJSON do GPX GIS Data za pomocą .NET lub C#
weight: 120
url: /pl/net/conversion/geojson-to-gpx/ 
description: Wypróbuj nasze API On-Premise, aby konwertować GeoJSON do GPX w .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj GeoJSON do GPX w C#" h2="Eksportuj GeoJSON do GPX za pomocą serwerowych API, bez konieczności używania oprogramowania takiego jak ArcGIS, ArcMap, QGIS lub Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GPX" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GeoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować GeoJSON do GPX za pomocą C#" %}}

Aby przekonwertować GeoJSON do GPX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki konwersji GeoJSON do GPX w C#" %}}
...
1.  Ścieżka do pliku źródłowego GeoJSON typu string
2.  Źródło sterownika, aby poinformować API o formacie wejściowym. Ustaw go na Drivers.GeoJson
3.  Ścieżka do pliku docelowego GPX z danymi typu string
...
{{% blocks/products/pf/agp/code-block title="Zapisz GeoJSON jako GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GeoJSON do GPX Live Demos" sectionDescription="Konwertuj GeoJSON na GPX już teraz, odwiedzając naszą stronę [Live Demos](https://products.aspose.app/gis/conversion/geojson-to-gpx). Demo online ma następujące korzyści" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Prześlij plik GeoJSON, zostanie natychmiast przekonwertowany na GPX." >}}
