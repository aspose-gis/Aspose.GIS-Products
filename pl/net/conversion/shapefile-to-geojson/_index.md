---
title: Konwertuj Shapefile do GeoJSON GIS Data za pomocą .NET lub C#
weight: 120
url: /pl/net/conversion/shapefile-to-geojson/ 
description: Wypróbuj nasze API On-Premise, aby przekonwertować Shapefile na GeoJSON w .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj Shapefile do GeoJSON w C#" h2="Eksportuj Shapefile do GeoJSON za pomocą API po stronie serwera, bez konieczności używania oprogramowania takiego jak ArcGIS, ArcMap, QGIS lub Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować Shapefile do GeoJSON za pomocą C#" %}}

Aby przekonwertować Shapefile na GeoJSON, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki konwersji Shapefile do GeoJSON w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Zapisz Shapefile jako GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile do GeoJSON Live Demos" sectionDescription="Przekonwertuj Shapefile na GeoJSON już teraz, odwiedzając naszą [stronę z demonstracjami na żywo](https://products.aspose.app/gis/conversion/shapefile-to-geojson). Demonstracja na żywo ma następujące korzyści" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Prześlij swój plik Shapefile, zostanie natychmiast przekonwertowany na GeoJSON." >}}
