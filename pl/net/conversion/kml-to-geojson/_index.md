---
title: Konwertuj KML do GeoJSON GIS Data za pomocą .NET lub C#
weight: 120
url: /pl/net/conversion/kml-to-geojson/ 
description: Wypróbuj nasze API On-Premise, aby konwertować KML do GeoJSON na platformie .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj KML do GeoJSON w C#" h2="Eksportuj KML do GeoJSON za pomocą API po stronie serwera, bez konieczności używania oprogramowania takiego jak ArcGIS, ArcMap, QGIS lub Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="dla .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować KML do GeoJSON za pomocą C#" %}}
...
2.  Sterownik źródłowy, aby poinformować API o formacie wejściowym. Ustaw go na Drivers.Kml
3.  Ścieżka do pliku danych GeoJSON docelowego w typie string
4.  Sterownik docelowy, aby określić format wyjściowy. Ustaw go na Drivers.GeoJson
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML do GeoJSON Live Demos" sectionDescription="Konwertuj KML na GeoJSON już teraz, odwiedzając naszą stronę [Live Demos](https://products.aspose.app/gis/conversion/kml-to-geojson). Demo online ma następujące korzyści" >}}
