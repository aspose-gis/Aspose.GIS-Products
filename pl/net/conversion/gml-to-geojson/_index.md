---
title: Konwertuj GML do GeoJSON GIS Data za pomocą .NET lub C#
weight: 120
url: /pl/net/conversion/gml-to-geojson/ 
description: Wypróbuj nasze API On-Premise, aby konwertować GML do GeoJSON na platformie .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj GML do GeoJSON w C#" h2="Eksportuj GML do GeoJSON za pomocą API po stronie serwera, bez konieczności używania oprogramowania takiego jak ArcGIS, ArcMap, QGIS lub Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować GML do GeoJSON za pomocą C#" %}}

Aby przekonwertować GML do GeoJSON, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki konwersji GML do GeoJSON w C#" %}}
...
2.  Sterownik źródłowy, aby poinformować API o formacie wejściowym. Ustaw go na Drivers.Gml
3.  Ścieżka do pliku docelowego GeoJSON w typie string
...
{{% blocks/products/pf/agp/code-block title="Zapisz GML jako GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML do GeoJSON Live Demos" sectionDescription="Konwertuj GML na GeoJSON już teraz, odwiedzając naszą stronę [Live Demos](https://products.aspose.app/gis/conversion/gml-to-geojson). Demo online ma następujące korzyści" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Prześlij plik GML, zostanie natychmiast przekonwertowany na GeoJSON." >}}
