---
title: Konwertuj TopoJSON do KML GIS Data przez .NET lub C#
weight: 120
url: /pl/net/conversion/topojson-to-kml/ 
description: Wypróbuj nasze API On-Premise, aby konwertować TopoJSON do KML na .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj TopoJSON do KML w C#" h2="Eksportuj TopoJSON do KML używając API po stronie serwera, bez potrzeby oprogramowania takiego jak ArcGIS, ArcMap, QGIS lub Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="dla .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TopoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Jak konwertować TopoJSON do KML używając C#" %}}

Aby przekonwertować TopoJSON na KML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki konwersji TopoJSON do KML w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Zapisz TopoJSON jako KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON do KML Live Demos" sectionDescription="Konwertuj TopoJSON na KML już teraz, odwiedzając naszą stronę [Live Demos](https://products.aspose.app/gis/conversion/topojson-to-kml). Demo online ma następujące korzyści" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Prześlij plik TopoJSON, zostanie natychmiast przekonwertowany na KML." >}}
