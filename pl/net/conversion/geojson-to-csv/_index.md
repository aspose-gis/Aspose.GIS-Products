---
title: Konwertuj GeoJSON do CSV GIS Data za pomocą .NET lub C#
weight: 120
url: /pl/net/conversion/geojson-to-csv/ 
description: Wypróbuj nasze API On-Premise, aby konwertować GeoJSON do CSV w .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konwertuj GeoJSON do CSV w C#" h2="Eksportuj GeoJSON do CSV za pomocą serwerowych API, bez konieczności używania oprogramowania takiego jak ArcGIS, ArcMap, QGIS lub Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GeoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować GeoJSON do CSV za pomocą C#" %}}

Aby przekonwertować GeoJSON do CSV, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki konwersji GeoJSON do CSV w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Zapisz GeoJSON jako CSV - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GeoJSON do CSV Live Demos" sectionDescription="Konwertuj GeoJSON do CSV już teraz, odwiedzając naszą stronę [Live Demos](https://products.aspose.app/gis/conversion/geojson-to-csv). Demo na żywo ma następujące korzyści" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Prześlij plik GeoJSON, zostanie natychmiast przekonwertowany do CSV." >}}
