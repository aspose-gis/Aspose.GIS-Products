...
weight: 120
url: /vi/net/conversion/kml-to-json/ 
description: Thử các API On-Premise của chúng tôi để chuyển đổi KML thành GeoJSON trên .NET Framework, .NET Core, C#.
---
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML to GeoJSON Live Demos" sectionDescription="Chuyển đổi KML sang GeoJSON ngay bây giờ bằng cách truy cập [trang web trình diễn trực tiếp](https://products.aspose.app/gis/conversion/kml-to-json). Bản demo trực tiếp có những lợi ích sau" >}}
...
GeoJSON là định dạng dựa trên JSON được thiết kế để biểu diễn các đối tượng địa lý với các thuộc tính phi không gian của chúng. Định dạng này xác định các đối tượng JSON khác nhau (JavaScript Object Notation) và cách kết hợp chúng. JSON đại diện cho một bộ sưu tập thông tin về các đặc điểm địa lý, phạm vi không gian của chúng và các thuộc tính.
