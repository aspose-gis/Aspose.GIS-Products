---
title: Chuyển đổi TopoJSON thành Dữ liệu GIS KML bằng .NET hoặc C#
weight: 120
url: /vi/net/conversion/topojson-to-kml/ 
description: Thử các API On-Premise của chúng tôi để chuyển đổi TopoJSON sang KML trên .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi TopoJSON thành KML trong C#" h2="Xuất TopoJSON sang KML bằng API phía máy chủ, không cần phần mềm như ArcGIS, ArcMap, QGIS hoặc Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TopoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chuyển đổi TopoJSON sang KML bằng C#" %}}

Để chuyển đổi TopoJSON thành KML, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi TopoJSON sang KML trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Lưu TopoJSON dưới dạng KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON to KML Live Demos" sectionDescription="Chuyển đổi TopoJSON thành KML ngay bây giờ bằng cách truy cập [trang web trình diễn trực tiếp](https://products.aspose.app/gis/conversion/topojson-to-kml). Bản demo trực tiếp có những lợi ích sau" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Tải lên tệp TopoJSON của bạn, nó sẽ được chuyển đổi ngay lập tức sang KML." >}}
...
TopoJSON là phần mở rộng của GeoJSON mã hóa cấu trúc liên kết. Định dạng dựa trên JSON được thiết kế để biểu diễn các đối tượng địa lý với các thuộc tính không gian của chúng. Định dạng này xác định các đối tượng JSON khác nhau (JavaScript Object Notation) và cách kết hợp chúng. Định dạng JSON đại diện cho thông tin tổng thể về các đặc điểm địa lý, phạm vi không gian của chúng và các thuộc tính.
