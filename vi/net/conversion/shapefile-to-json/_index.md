---
title: Chuyển đổi Shapefile thành Dữ liệu GIS JSON bằng .NET hoặc C#
weight: 120
url: /vi/net/conversion/shapefile-to-json/ 
description: Thử các API On-Premise của chúng tôi để chuyển đổi Shapefile sang JSON trên .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi Shapefile thành JSON trong C#" h2="Xuất Shapefile sang JSON bằng API phía máy chủ, mà không cần phần mềm như ArcGIS, ArcMap, QGIS hoặc Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi Shapefile thành JSON bằng C#" %}}

Để chuyển đổi Shapefile thành JSON, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi Shapefile thành JSON trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Lưu Shapefile dưới dạng JSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Chuyển đổi Shapefile thành JSON - Bản trình diễn trực tiếp" sectionDescription="Chuyển đổi Shapefile sang JSON ngay bây giờ bằng cách truy cập [trang web Bản trình diễn trực tiếp](https://products.aspose.app/gis/conversion/shapefile-to-json). Bản trình diễn trực tiếp có những lợi ích sau" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Tải lên tệp Shapefile của bạn, nó sẽ được chuyển đổi ngay lập tức sang JSON." >}}
...
Định dạng dựa trên JSON được thiết kế để biểu diễn các đặc điểm địa lý với các thuộc tính phi không gian của chúng. Định dạng này xác định các đối tượng JSON khác nhau và cách kết hợp chúng. JSON đại diện cho một thông tin tổng thể về các đặc điểm địa lý, phạm vi không gian của chúng và các thuộc tính.
