---
title: Chuyển đổi Dữ liệu GIS KML sang TopoJSON bằng .NET hoặc C#
weight: 120
url: /vi/net/conversion/kml-to-topojson/ 
description: Thử các API On-Premise của chúng tôi để chuyển đổi KML sang TopoJSON trên .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi KML sang TopoJSON trong C#" h2="Xuất KML sang TopoJSON bằng API phía máy chủ, không cần phần mềm như ArcGIS, ArcMap, QGIS hoặc Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TopoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Chuyển đổi KML sang TopoJSON bằng C#" %}}

Để chuyển đổi KML sang TopoJSON, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi KML sang TopoJSON trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Lưu KML dưới dạng TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML to TopoJSON Live Demos" sectionDescription="Chuyển đổi KML sang TopoJSON ngay bây giờ bằng cách truy cập [trang web trình diễn trực tiếp](https://products.aspose.app/gis/conversion/kml-to-topojson). Bản demo trực tiếp có những lợi ích sau" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Tải lên tệp KML của bạn, nó sẽ được chuyển đổi ngay lập tức sang TopoJSON." >}}
...
TopoJSON là một phần mở rộng GeoJSON mã hóa cấu trúc liên kết. Định dạng dựa trên JSON được thiết kế để biểu diễn các đối tượng địa lý cùng với các thuộc tính phi không gian của chúng. Định dạng này xác định các đối tượng JSON khác nhau (JavaScript Object Notation) và cách kết hợp chúng. Định dạng JSON đại diện cho một bộ sưu tập thông tin về các đặc điểm địa lý, phạm vi không gian của chúng và các thuộc tính.
