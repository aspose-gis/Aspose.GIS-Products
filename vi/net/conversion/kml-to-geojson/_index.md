...
{{% blocks/products/pf/agp/content h2="Cách Chuyển đổi KML sang GeoJSON bằng C#" %}}

Để chuyển đổi KML sang GeoJSON, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi KML sang GeoJSON trong C#" %}}

{{% blocks/products/pf/agp/text %}}

Chuyển đổi có thể được thực hiện chỉ với một dòng mã khi sử dụng
*VectorLayer.Convert* 
phương thức. Nó nhận 4 tham số như chi tiết bên dưới.
...
{{% blocks/products/pf/agp/code-block title="Lưu KML dưới dạng GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML to GeoJSON Live Demos" sectionDescription="Chuyển đổi KML sang GeoJSON ngay bây giờ bằng cách truy cập [trang web trình diễn trực tiếp](https://products.aspose.app/gis/conversion/kml-to-geojson). Bản demo trực tiếp có những lợi ích sau" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Tải lên tệp KML của bạn, nó sẽ được chuyển đổi ngay lập tức sang GeoJSON." >}}
...
GeoJSON là định dạng dựa trên JSON được thiết kế để biểu diễn các đối tượng địa lý cùng với các thuộc tính phi không gian của chúng. Định dạng này xác định các đối tượng JSON khác nhau (JavaScript Object Notation) và cách kết hợp chúng. JSON đại diện cho một bộ sưu tập thông tin về các đặc điểm địa lý, phạm vi không gian của chúng và các thuộc tính.
