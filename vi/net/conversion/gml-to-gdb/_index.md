---
title: Chuyển đổi GML thành Dữ liệu GIS GDB qua .NET
weight: 290
url: /vi/net/conversion/gml-to-gdb/
description: Hãy thử các API On-Premise của chúng tôi để chuyển đổi dữ liệu GIS trên .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Chuyển đổi GML thành GDB trong C#" h2="Xuất GML sang GDB bằng API phía máy chủ, mà không cần phần mềm như ArcGIS, ArcMap, QGIS hoặc Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GDB" pfName="Aspose.GIS" subTitlepfName="cho .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GML" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi GML thành GDB bằng C#" %}}

Để chuyển đổi GML sang GDB, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi GML thành GDB trong C#" %}}
...
3.  Đường dẫn tệp kiểu chuỗi đến tệp dữ liệu GDB đích
4.  Trình điều khiển đích để chỉ định định dạng đầu ra. Đặt thành Drivers.FileGdb
...
{{% blocks/products/pf/agp/code-block title="Lưu GML dưới dạng GDB - C#" offSpacer="" %}}

```cs
// Chuyển đổi dữ liệu GIS GML thành dữ liệu GDB
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML to GDB Live Demos" sectionDescription="Chuyển đổi GML thành GDB ngay bây giờ bằng cách truy cập [trang web trình diễn trực tiếp](https://products.aspose.app/gis/conversion/gml-to-gdb). Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="Không cần tải xuống Aspose GIS API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="Chỉ chọn GDB làm định dạng đầu ra và." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Tải lên tệp GML của bạn, nó sẽ được chuyển đổi ngay lập tức thành GDB." >}}
...
GML là viết tắt của Ngôn ngữ đánh dấu địa lý dựa trên các thông số kỹ thuật XML do Open Geospatial Consortium (OGC) phát triển. Định dạng được sử dụng để lưu trữ các tính năng dữ liệu địa lý cho việc trao đổi giữa các định dạng tệp khác nhau. Nó đóng vai trò như một ngôn ngữ mô hình hóa cho các hệ thống địa lý cũng như một định dạng trao đổi mở cho các giao dịch địa lý trên internet.
Đọc thêm
