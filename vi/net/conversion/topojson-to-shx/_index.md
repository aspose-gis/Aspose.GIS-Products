---
title: Chuyển đổi TOPOJSON thành Dữ liệu GIS SHX qua .NET
weight: 260
url: /vi/net/conversion/topojson-to-shx/
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi TOPOJSON thành SHX bằng C#" %}}

Để chuyển đổi TOPOJSON thành SHX, chúng ta sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi TOPOJSON thành SHX trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Lưu TOPOJSON dưới dạng SHX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TOPOJSON thành SHX Live Demos" sectionDescription="Chuyển đổi TOPOJSON thành SHX ngay bây giờ bằng cách truy cập [trang web trình diễn trực tiếp](https://products.aspose.app/gis/conversion/topojson-to-shx). Bản demo trực tiếp có những lợi ích sau" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Tải lên tệp TOPOJSON của bạn, nó sẽ được chuyển đổi ngay lập tức thành SHX." >}}
...
TopoJSON là phần mở rộng của GeoJSON mã hóa cấu trúc liên kết địa hình. Thay vì biểu diễn các hình học một cách riêng biệt, các hình học trong tệp TopoJSON được khâu lại từ các đoạn thẳng dùng chung gọi là cung.
Đọc thêm
