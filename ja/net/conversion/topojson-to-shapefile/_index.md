...
{{< blocks/products/pf/upper-banner h1="C# で TopoJSON を Shapefile に変換する" h2="ArcGIS、ArcMap、QGIS、または Google Earth などのソフトウェアを必要とせずに、サーバー側の API を使用して TopoJSON を Shapefile にエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Shapefile" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TopoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="C# を使用して TopoJSON を Shapefile に変換する方法" %}}

TopoJSON から Shapefile への変換には、
...
{{% blocks/products/pf/agp/feature-section-col title="C# で TopoJSON を Shapefile に変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="TopoJSON を Shapefile として保存する - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON から Shapefile へのライブデモ" sectionDescription="[ライブデモ](https://products.aspose.app/gis/conversion/topojson-to-shapefile) ウェブサイトにアクセスして、今すぐ TopoJSON を Shapefile に変換してください。ライブデモには次の利点があります。" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" TopoJSON ファイルをアップロードすると、すぐに Shapefile に変換されます。" >}}
...
SHP は、ESRI Shapefile の主要なファイルタイプの 1 つで使用されるファイル拡張子です。これは、地理空間情報をベクトルデータとして表現するものであり、地理情報システム (GIS) アプリケーションで使用されます。この形式は、ESRI と他のソフトウェア製品間の相互運用性を促進するために、オープン仕様として開発されました。
