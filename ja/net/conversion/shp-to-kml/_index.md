---
title: SHP to KML GIS データの .NET または C# による変換
weight: 120
url: /ja/net/conversion/shp-to-kml/ 
description: 当社のオンプレミス API を使用して、.NET Framework、.NET Core、C# で SHP を KML に変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# で SHP を KML に変換" h2="ArcGIS、ArcMap、QGIS、または Google Earth などのソフトウェアを必要とせずに、サーバーサイド API を使用して SHP を KML にエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SHP" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# で SHP を KML に変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="SHP を KML として保存 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SHP to KML ライブデモ" sectionDescription="[ライブデモ](https://products.aspose.app/gis/conversion/shp-to-kml) ウェブサイトにアクセスして、今すぐ SHP を KML に変換してください。ライブデモには次の利点があります。" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" SHP ファイルをアップロードすると、KML に即座に変換されます。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" ダウンロードリンクが提供されます。" >}}

    {{% blocks/products/pf/agp/content h2=".NET GIS ライブラリ" %}}

Aspose.GIS for .NET は、GIS データの操作および変換 API です。有名な GIS データ形式 (ESRI Shapefile、GeoJSON、TopoJSON、ESRI Geodatabase、Geography Markup Language、Google Earth、GPS Exchange Format、MapInfo Formats、OpenStreetMap など) の読み取り、書き込み、変換を完全にサポートします。スタンドアロンの .NET ベース API であり、ArcGIS / ArcMap、QGIS などの GIS ベースソフトウェアは必要ありません。
...
{{< blocks/products/pf/agp/other-supported-section title="その他のサポートされている変換" subTitle="SHP を他の多くのファイル形式にも変換できます。以下にいくつか例を示します。" >}}
