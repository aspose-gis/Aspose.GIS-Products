---
title: GeoJSON を KML GIS データに .NET または C# で変換する
weight: 120
url: /ja/net/conversion/geojson-to-kml/ 
description: 当社のオンプレミス API を使用して、.NET Framework、.NET Core、C# で GeoJSON を KML に変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# で GeoJSON を KML に変換する" h2="ArcGIS、ArcMap、QGIS、または Google Earth などのソフトウェアを必要とせずに、サーバー側の API を使用して GeoJSON を KML にエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GeoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="C# を使用して GeoJSON を KML に変換する方法" %}}

GeoJSON を KML に変換するには、
...
{{% blocks/products/pf/agp/feature-section-col title="C# で GeoJSON を KML に変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="GeoJSON を KML として保存 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GeoJSON to KML ライブデモ" sectionDescription="[ライブデモ](https://products.aspose.app/gis/conversion/geojson-to-kml) ウェブサイトにアクセスして、今すぐ GeoJSON を KML に変換してください。ライブデモには以下の利点があります。" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" GeoJSON ファイルをアップロードすると、すぐに KML に変換されます。" >}}
...
KML (Keyhole Markup Language) は、XML 表記で地理空間情報を含むものです。 KML は、それをサポートする地理情報システム (GIS) アプリケーションで開くことができます。多くのアプリケーションは、国際標準として採用された後、KML 形式のサポートを開始しました。
