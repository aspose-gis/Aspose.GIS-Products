...
{{% blocks/products/pf/agp/feature-section-col title="C# で GML を SHP に変換する手順" %}}
...
4.  出力形式を指定する宛先ドライバー。Drivers.Shapefile に設定します。
...
{{% blocks/products/pf/agp/code-block title="GML を SHP として保存 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML から SHP へのライブデモ" sectionDescription="[ライブデモ](https://products.aspose.app/gis/conversion/gml-to-shp) Web サイトにアクセスして、今すぐ GML を SHP に変換してください。ライブデモには以下の利点があります。" >}}
