---
title: .NET または C# を使用して JSON を GeoJSON GIS データに変換する
weight: 120
url: /ja/net/conversion/json-to-geojson/ 
description: オンプレミス API を使用して、.NET Framework、.NET Core、C# で JSON を GeoJSON に変換します。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# で JSON を GeoJSON に変換する" h2="ArcGIS、ArcMap、QGIS、または Google Earth などのソフトウェアを必要とせずに、サーバー側の API を使用して JSON から GeoJSON へエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="C# を使用して JSON を GeoJSON に変換する方法" %}}

JSON から GeoJSON へ変換するには、
...
{{% blocks/products/pf/agp/feature-section-col title="C# で JSON を GeoJSON に変換する手順" %}}
...
2.  入力形式について API に知らせるソースドライバー。Drivers.GeoJson に設定します。
...
{{% blocks/products/pf/agp/code-block title="JSON を GeoJSON として保存 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="JSON to GeoJSON Live Demos" sectionDescription="当社の [Live Demos ウェブサイト](https://products.aspose.app/gis/conversion/json-to-geojson) にアクセスして、今すぐ JSON を GeoJSON に変換してください。ライブデモには以下の利点があります。" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="JSON ファイルをアップロードすると、すぐに GeoJSON に変換されます。" >}}
...
地理的特徴とその非空間属性を表すように設計された JSON ベースの形式です。この形式では、さまざまな JSON (JavaScript Object Notation) オブジェクトとそれらの結合方法を定義します。JSON は、地理的特徴、その空間範囲、およびプロパティに関する集合的な情報を表します。
...
{{< blocks/products/pf/agp/other-supported-section title="Other Supported Conversions" subTitle="JSON を、以下に示す他の多くのファイル形式にも変換できます。" >}}
