...
GPX 拡張子は、インターネット上のアプリケーションおよび Web サービス間で GPS データと交換するための GPS Exchange フォーマットを表します。これは、ウェイポイント、ルート、トラックなどの GPS データを含む軽量の XML フォーマットであり、複数のプログラムによってインポートおよび読み取られます。GPX はオープンであり、さまざまなアプリケーションや GPS デバイスでサポートされています。
