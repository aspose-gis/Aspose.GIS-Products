...
weight: 120
url: /ja/net/conversion/csv-to-kml/ 
description: Try our On-Premise APIs to convert CSV to KML on .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C# で CSV を KML に変換" h2="ArcGIS、ArcMap、QGIS、または Google Earth などのソフトウェアを必要とせずに、サーバー側の API を使用して CSV から KML へエクスポートします。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="C# を使用して CSV を KML に変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# で CSV を KML に変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

*VectorLayer.Convert* 
メソッドを使用すると、1 行のコードで変換できます。以下に示すように、4 つのパラメータを受け取ります。

{{% /blocks/products/pf/agp/text %}}

1.  ソース CSV ファイルへの文字列型のファイルパス
2.  入力形式を API に知らせるソースドライバー。Csvに設定します。
...
{{% blocks/products/pf/agp/code-block title="CSV を KML に保存 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV to KML Live Demos" sectionDescription="[Live Demos website](https://products.aspose.app/gis/conversion/csv-to-kml) にアクセスして、今すぐ CSV を KML に変換してください。ライブデモには以下の利点があります。" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" CSV ファイルをアップロードすると、すぐに KML に変換されます。" >}}
