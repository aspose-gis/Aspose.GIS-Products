...
{{% blocks/products/pf/agp/content h2="C# を使用して TOPOJSON を SHX に変換する方法" %}}

TOPOJSON を SHX に変換するには、
...
{{% blocks/products/pf/agp/feature-section-col title="C# で TOPOJSON を SHX に変換する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="C# - TOPOJSON を SHX として保存" offSpacer="" %}}

```cs
// TOPOJSON GIS データを SHX データに変換します。
...
{{< blocks/products/pf/agp/demobox sectionTitle="TOPOJSON から SHX へのライブデモ" sectionDescription="[ライブデモ](https://products.aspose.app/gis/conversion/topojson-to-shx) ウェブサイトにアクセスして、今すぐ TOPOJSON を SHX に変換してください。ライブデモには以下の利点があります。" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" TOPOJSON ファイルをアップロードすると、すぐに SHX に変換されます。" >}}
...
フィーチャジオメトリの位置インデックスであり、高速な前方および後方検索を可能にする Shape インデックス形式です。
詳細はこちら
