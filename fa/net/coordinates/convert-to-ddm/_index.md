---
title: تبدیل به درجه دقیقه اعشاری (DDM) - API ها برای .NET
weight: 40
url: /fa/net/coordinates/convert-to-ddm
...
<p>
 Aspose.GIS for .NET به شما امکان می دهد واحدهای جغرافیایی را به درجه دقیقه اعشاری (DDM) تبدیل کنید. کتابخانه ما به شما اجازه می‌دهد تا به راحتی و سرعت، عرض و طول جغرافیایی را به فرمت واحد مورد نظر خود تبدیل کنید. همچنین کتابخانه ما این امکان را دارد که مکان‌ها را از یک متن استخراج کند.
</p>

<p>
 Aspose.GIS for .NET با در نظر گرفتن سادگی، عملکرد، کاربردپذیری و قابلیت حمل طراحی شده است. این شامل API هایی برای استفاده با پلتفرم های .NET Framework &amp; .NET Core است که به شما امکان می دهد برنامه های چند پلتفرمی را با سهولت فراوان ایجاد کنید.
</p>
...
{{< blocks/products/pf/carousel-item h3="نگاهی سریع" description="مروری بر API .NET / C# مبدل مختصات." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     تبدیل عرض و طول جغرافیایی به واحدهای مبتنی بر درجه      
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     تشخیص خودکار واحدها هنگام تجزیه عرض و طول جغرافیایی از متن. 
    </p>
   </div>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه های وب
      ...
      <p>
        ما برنامه‌های رایگان را ارائه می‌دهیم که از API .NET برای پیاده‌سازی <a href="https://products.aspose.app/gis/coordinates/convert-to-ddm" >"تبدیل به DDM"</a> و سایر موارد استفاده می‌کنند. در اینجا می‌توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
