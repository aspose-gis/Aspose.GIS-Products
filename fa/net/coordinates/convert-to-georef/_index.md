---
title: تبدیل به سیستم مرجع جهانی جغرافیایی (GeoRef) - API ها برای .NET
weight: 40
url: /fa/coordinates/convert-to-georef
description: تبدیل به سیستم مرجع جهانی جغرافیایی (GeoRef) از طریق کتابخانه طراحی شده به طور خاص برای توسعه دهندگان .NET. API های مبدل مختصات برای DD، DMS، DDM، GeoRef و سایر فرمت ها.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs to convert World Geographic Reference System (GeoRef) for GIS" h2="Develop GeoRef conversion with an API designed specifically for .NET / C# developers." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET به شما امکان می دهد سیستم مرجع جهانی جغرافیایی (GeoRef) را برای واحدهای Geospatial تبدیل کنید. کتابخانه ما به شما این امکان را می دهد که به راحتی و به سرعت طول و عرض جغرافیایی را به فرمت واحد دلخواه تبدیل کنید. همچنین کتابخانه ما شامل قابلیتی برای استخراج مکان ها به یک نقطه از متن است.
</p>

<p>
 Aspose.GIS for .NET با در نظر گرفتن سادگی، عملکرد، قابلیت استفاده و قابلیت حمل طراحی شده است. این کتابخانه حاوی API هایی برای استفاده با پلتفرم های .NET Framework و .NET Core است که به شما امکان می دهد برنامه های چند پلتفرمی را با سهولت فراوان ایجاد کنید.
</p>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     تشخیص خودکار واحدها هنگام تجزیه و تحلیل طول و عرض جغرافیایی از متن. 
    </p>
   </div>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      پشتیبانی از سیستم مرجع جهانی جغرافیایی (GEOREF) فرمت
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      پشتیبانی از سیستم مرجع شبکه نظامی (MGRS) فرمت
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     پشتیبانی از شبکه ملی ایالات متحده (USNG) فرمت
    </p>
   </div>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه های وب
      ...
      <p>
        ما برنامه های رایگان ارائه می دهیم که از API .NET برای پیاده سازی <a href="https://products.aspose.app/gis/coordinates/convert-to-georef" >"تبدیل به GeoRef"</a> و سایر موارد استفاده می کنند. در اینجا می توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - تبدیل به GeoRef 
    </h2>
    <p>
