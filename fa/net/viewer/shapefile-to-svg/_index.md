...
weight: 40
url: /fa/viewer/shapefile-to-svg
description: تبدیل از SHAPEFILE به SVG از طریق کتابخانه طراحی شده به طور خاص برای توسعه دهندگان .NET. API های رندر نقشه برای Kml، GeoJson Gpx، Kml و سایر فایل ها.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs for SHAPEFILE to SVG conversion" h2="تبدیل SHAPEFILE به SVG با یک API طراحی شده به طور خاص برای توسعه دهندگان .NET / C#." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET به شما امکان می دهد SHAPEFILE را به SVG برای فرمت های داده مکانی برداری و رستری تبدیل کنید. داده ها فقط زمانی مفید هستند که کسی بتواند آنها را ببیند. کتابخانه GIS .NET، صادرات آسان و سریع داده های GIS به تصاویر برداری یا رستری را فراهم می کند و نمادگذاری غنی برای سناریوهای تجسم پیچیده ارائه می دهد. 
</p>

<p>
 Aspose.GIS for .NET با در نظر گرفتن سادگی، عملکرد، قابلیت استفاده و قابلیت حمل طراحی شده است. این شامل API هایی برای استفاده با پلتفرم های .NET Framework &amp; .NET Core است و به شما امکان می دهد برنامه های چندسکویی را با سهولت زیادی ایجاد کنید.
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="یک نمای کلی برای تبدیل SHAPEFILE به SVG .NET API." >}}
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="Aspose.GIS for .NET [از فرمت های محبوب](https://docs.aspose.com/gis/net/supported-file-formats/) GIS پشتیبانی می کند." >}}
...
<!--Apps Gallery-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه های کاربردی وب
    </h2>

      <p>
        ما برنامه های رایگان را ارائه می دهیم که از API .NET برای پیاده سازی <a href="https://products.aspose.app/gis/viewer/shapefile-to-svg" >"تبدیل SHAPEFILE به SVG"</a> و موارد دیگر استفاده می کنند. در اینجا می توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - SHAPEFILE به SVG Converter
    </h2>
    <p>
     در اینجا نحوه تبدیل SHAPEFILE به SVG با استفاده از تنظیمات پیش فرض آمده است:
    </p>
