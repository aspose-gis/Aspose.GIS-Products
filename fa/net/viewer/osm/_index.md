...
<p>
 Aspose.GIS for .NET به شما امکان می‌دهد یک نمایشگر OSM برای فرمت‌های داده جغرافیایی برداری و رستری ایجاد کنید. داده‌ها تنها زمانی مفید هستند که کسی بتواند آن‌ها را ببیند. کتابخانه GIS .NET، به‌آسانی و با سرعت داده‌های GIS را به تصاویر برداری یا رستری صادر می‌کند و نمادگذاری غنی برای سناریوهای تجسم پیچیده ارائه می‌دهد. 
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="مروری بر API نمایشگر OSM .NET." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     استفاده از رندرینگ پیشرفته: ترکیب نمادگردهای، تولید کننده هندسه، هندسه‌ی ترکیبی.
    </p>
   </div>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه‌ها
      ...
      <p>
        ما برنامه‌های رایگان را که از API .NET برای پیاده‌سازی <a href="https://products.aspose.app/gis/viewer/osm" >"نمایشگر OSM"</a> و موارد دیگر استفاده می‌کنند، ارائه می‌دهیم. در اینجا می‌توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - نمایشگر OSM
    </h2>
    <p>
     در اینجا نحوه رندر نقشه از فرمت OSM با استفاده از تنظیمات پیش‌فرض آمده است:
    </p>
