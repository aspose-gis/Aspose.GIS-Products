...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="یک نمای کلی برای تبدیل OSM به PNG API .NET." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه‌ها
      ...
      <p>
        ما برنامه‌های رایگان را ارائه می‌دهیم که از API .NET برای پیاده‌سازی <a href="https://products.aspose.app/gis/viewer/osm-to-png" >"تبدیل کننده OSM به PNG"</a> و موارد دیگر استفاده می‌کنند. در اینجا می‌توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - تبدیل کننده OSM به PNG
    </h2>
    <p>
     در اینجا نحوه تبدیل OSM به PNG با استفاده از تنظیمات پیش‌فرض آمده است:
    </p>
