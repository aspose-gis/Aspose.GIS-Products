...
weight: 40
url: /fa/viewer/geojson-to-svg
description: تبدیل از GeoJSON به SVG از طریق کتابخانه‌ای که به‌طور خاص برای توسعه‌دهندگان .NET طراحی شده است. APIهای رندر نقشه برای Kml، GeoJson Gpx، Kml و سایر فایل‌ها.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs for GeoJSON to SVG conversion" h2="تبدیل GeoJSON به SVG با یک API که به‌طور خاص برای توسعه‌دهندگان .NET / C# طراحی شده است." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET به شما این امکان را می‌دهد که GeoJSON را به SVG برای فرمت‌های داده مکانی برداری و رستری تبدیل کنید. داده‌ها فقط زمانی مفید هستند که کسی بتواند آن‌ها را ببیند. کتابخانه GIS .NET، به‌راحتی و با سرعت بالا، صادرات داده‌های GIS را به تصاویر برداری یا رستری فراهم می‌کند و نمادگذاری غنی برای سناریوهای تجسم‌سازی پیچیده ارائه می‌دهد. 
</p>

<p>
 Aspose.GIS for .NET با در نظر گرفتن سادگی، عملکرد، قابلیت استفاده و قابلیت حمل طراحی شده است. این شامل APIهایی برای استفاده با پلتفرم‌های .NET Framework &amp; .NET Core است که به شما امکان می‌دهد برنامه‌های چندسکویی را با سهولت فراوان ایجاد کنید.
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="یک نمای کلی برای تبدیل GeoJSON به SVG API .NET." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      برچسب‌گذاری و متن را بکشید. اعمال استایل برای متن و تشخیص خودکار مکان‌ها در یک نقشه.
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه‌های وب
      ...
      <p>
        ما برنامه‌های رایگان را ارائه می‌دهیم که از API .NET برای پیاده‌سازی <a href="https://products.aspose.app/gis/viewer/geojson-to-svg" >"تبدیل کننده GeoJSON به SVG"</a> و موارد دیگر استفاده می‌کنند. در اینجا می‌توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - تبدیل کننده GeoJSON به SVG
    </h2>
    <p>
     در اینجا نحوه تبدیل GeoJSON به SVG با استفاده از تنظیمات پیش‌فرض آمده است:
    </p>
