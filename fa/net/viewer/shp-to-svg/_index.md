...
<p>
 Aspose.GIS for .NET به شما امکان می‌دهد SHP را به SVG برای فرمت‌های داده مکانی برداری و رستری تبدیل کنید. داده‌ها فقط زمانی مفید هستند که کسی بتواند آن‌ها را ببیند. کتابخانه GIS .NET، صادرات آسان و سریع داده‌های GIS به تصاویر برداری یا رستری را فراهم می‌کند و نمادگذاری غنی برای سناریوهای تجسم پیچیده ارائه می‌دهد. 
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="یک نمای کلی برای تبدیل SHP به SVG .NET API." >}}
 ...
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li>کشیدن همراه با خطوط منحنی</li>
   </ul>
   <header>
    <i class="fa fa-map">
    </i>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="Aspose.GIS for .NET [از فرمت‌های محبوب](https://docs.aspose.com/gis/net/supported-file-formats/) فایل GIS پشتیبانی می‌کند." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه‌ها
      ...
      <p>
        ما برنامه‌های رایگان را ارائه می‌دهیم که از API .NET برای پیاده‌سازی <a href="https://products.aspose.app/gis/viewer/shp-to-svg" >"تبدیل SHP به SVG"</a> و موارد دیگر استفاده می‌کنند. در اینجا می‌توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - SHP به SVG Converter
    </h2>
    <p>
     در اینجا نحوه تبدیل SHP به SVG با استفاده از تنظیمات پیش‌فرض آمده است:
    </p>
