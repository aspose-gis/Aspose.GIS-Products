...
weight: 40
url: /fa/net/viewer
description: توسعه‌ی نمایشگر نقشه از طریق کتابخانه‌ای که به‌طور خاص برای توسعه‌دهندگان .NET طراحی شده است. APIهای رندرینگ نقشه‌ها برای Kml، GeoJson Gpx، Kml و سایر فایل‌ها.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs for GIS Map Rendering" h2="توسعه‌ی یک نمایشگر نقشه با API که به‌طور خاص برای توسعه‌دهندگان .NET طراحی شده است." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="مروری بر API رندرینگ نقشه .NET." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      برچسب‌گذاری و متن را بکشید. اعمال استایل برای متن و تشخیص خودکار مکان‌ها روی نقشه.
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نقشه‌های گالری
      ...
      <div class="row">
        <div class="col-md-12">{{< figure src="london-roads.png" title="نقشه جاده‌های لندن" alt="نقشه جاده‌های لندن" class="img-fluid" width="100%" >}} </div>
      </div>
      <div class="row">
        <div class="col-md-6">{{< figure src="city-quarter.png" title="نقشه یک منطقه شهری" alt="نقشه یک منطقه شهری" class="img-fluid" width="100%" >}} </div>
        <div class="col-md-6">{{< figure src="africa-rivers.png" title="نقشه رودخانه‌های آفریقا" alt="نقشه رودخانه‌های آفریقا" class="img-fluid" width="100%">}} </div>
      </div>
   </div>

   <div class="col-lg-12">
    <h2 class="h2title">
     نمایشگر نقشه - نمونه کد برای .NET
    </h2>
    <p>
     در اینجا نحوه رندر کردن یک نقشه از یک فایل shapefile به SVG با استفاده از تنظیمات پیش‌فرض آمده است:
    </p>
