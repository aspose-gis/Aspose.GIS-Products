...
<p>
 Aspose.GIS for .NET به شما این امکان را می‌دهد تا یک نمایش‌دهنده‌ی GPX برای فرمت‌های داده‌ی جغرافیایی برداری و رستری ایجاد کنید. داده‌ها تنها زمانی مفید هستند که کسی بتواند آن‌ها را ببیند. کتابخانه‌ی GIS .NET، به‌طور ساده و سریع، صادرات داده‌های GIS به تصاویر برداری یا رستری را آسان می‌کند و نمادگذاری غنی برای سناریوهای تجسم پیچیده ارائه می‌دهد. 
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="مروری بر GPX Viewer .NET API." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه‌ها
      ...
      <p>
        ما برنامه‌های رایگان را ارائه می‌دهیم که از API .NET برای پیاده‌سازی <a href="https://products.aspose.app/gis/viewer/gpx" >"GPX Viewer"</a> و موارد دیگر استفاده می‌کنند. در اینجا می‌توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - GPX Viewer
    </h2>
    <p>
     در اینجا نحوه رندر نقشه از فرمت GPX با استفاده از تنظیمات پیش‌فرض آمده است:
    </p>
