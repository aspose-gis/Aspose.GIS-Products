...
weight: 40
url: /fa/viewer/geotiff-to-svg
description: تبدیل از GeoTIFF به SVG از طریق کتابخانه‌ای که به‌طور خاص برای توسعه‌دهندگان .NET طراحی شده است. APIهای رندر نقشه برای Kml، GeoJson Gpx، Kml و سایر فایل‌ها.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs for GeoTIFF to SVG conversion" h2="تبدیل GeoTIFF به SVG با یک API که به‌طور خاص برای توسعه‌دهندگان .NET / C# طراحی شده است." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET به شما امکان می‌دهد GeoTIFF را به SVG برای فرمت‌های داده مکانی برداری و رستری تبدیل کنید. داده‌ها فقط زمانی مفید هستند که کسی بتواند آن‌ها را ببیند. کتابخانه GIS .NET، صادرات آسان و سریع داده‌های GIS به تصاویر برداری یا رستری را فراهم می‌کند و نمادشناسی غنی برای سناریوهای تجسم‌سازی پیچیده ارائه می‌دهد. 
</p>

<p>
 Aspose.GIS for .NET با در نظر گرفتن سادگی، عملکرد، قابلیت استفاده و قابلیت حمل طراحی شده است. این شامل APIهایی برای استفاده با پلتفرم‌های .NET Framework &amp; .NET Core است و به شما امکان می‌دهد برنامه‌های چندسکویی را با سهولت فراوان ایجاد کنید.
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="یک نمای کلی برای تبدیل GeoTIFF به SVG API .NET." >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Independence" description="Aspose.GIS for .NET از .NET Framework 4.7 یا بالاتر در ویندوز و .NET Core 2.0 یا بالاتر در ویندوز یا لینوکس پشتیبانی می‌کند." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
...
{{< blocks/products/pf/carousel-item h3="Supported File Formats" description="Aspose.GIS for .NET [از فرمت‌های فایل GIS محبوب](https://docs.aspose.com/gis/net/supported-file-formats/) پشتیبانی می‌کند." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      ترکیب چندین لایه در یک تصویر نقشه. 
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه‌ها
      ...
      <p>
        ما برنامه‌های رایگان را ارائه می‌دهیم که از API .NET برای پیاده‌سازی <a href="https://products.aspose.app/gis/viewer/geotiff-to-svg" >"تبدیل کننده GeoTIFF به SVG"</a> و موارد دیگر استفاده می‌کنند. در اینجا می‌توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - تبدیل کننده GeoTIFF به SVG
    </h2>
    <p>
     در اینجا نحوه تبدیل GeoTIFF به SVG با استفاده از تنظیمات پیش‌فرض آمده است:
    </p>
