...
weight: 40
url: /fa/viewer/mapinfo-mif
description: توسعه‌ی نمایشگر MapInfo-MIF از طریق کتابخانه‌ای که به‌طور خاص برای توسعه‌دهندگان .NET طراحی شده است. APIهای رندر نقشه برای Kml، GeoJson Gpx، Kml و سایر فایل‌ها.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs for MapInfo-MIF Viewer" h2="توسعه‌ی یک نمایشگر MapInfo-MIF با API که به‌طور خاص برای توسعه‌دهندگان .NET / C# طراحی شده است." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET به شما این امکان را می‌دهد تا یک نمایشگر MapInfo-MIF برای فرمت‌های داده جغرافیایی برداری و رستری ایجاد کنید. داده‌ها تنها زمانی مفید هستند که کسی بتواند آن‌ها را ببیند. کتابخانه GIS .NET، به‌طور آسان و سریع، صادرات داده‌های GIS به تصاویر برداری یا رستری را امکان‌پذیر می‌کند و نمادگذاری غنی برای سناریوهای تجسم پیچیده ارائه می‌دهد. 
</p>

<p>
 Aspose.GIS for .NET با در نظر گرفتن سادگی، عملکرد، قابلیت استفاده و قابلیت حمل طراحی شده است. این کتابخانه شامل APIهایی برای استفاده با پلتفرم‌های .NET Framework &amp; .NET Core است که به شما امکان می‌دهد برنامه‌های چندسکویی را با سهولت فراوان ایجاد کنید.
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="مروری بر API نمایشگر MapInfo-MIF .NET." >}}
...
{{< blocks/products/pf/carousel-item h3="استقلال پلتفرمی" description="Aspose.GIS for .NET از .NET Framework 4.7 یا بالاتر در ویندوز، و .NET Core 2.0 یا بالاتر در ویندوز یا لینوکس پشتیبانی می‌کند." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   <header>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      برچسب‌گذاری و درج متن. اعمال استایل برای متن و تشخیص خودکار مکان‌ها در نقشه.
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     ذخیره نقشه ایجاد شده در فرمت‌های SVG، PNG، BMP یا JPEG.
    </p>
   </div>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه‌ها
      ...
      <p>
        ما برنامه‌های رایگان را که از API .NET برای پیاده‌سازی <a href="https://products.aspose.app/gis/viewer/mapinfo-mif" >"نمایشگر MapInfo-MIF"</a> و موارد دیگر استفاده می‌کنند، ارائه می‌دهیم. در اینجا می‌توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - نمایشگر MapInfo-MIF
    </h2>
    <p>
     در اینجا نحوه رندر نقشه از فرمت MapInfo-MIF با استفاده از تنظیمات پیش‌فرض آمده است:
    </p>
