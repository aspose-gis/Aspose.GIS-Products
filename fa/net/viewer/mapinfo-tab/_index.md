...
weight: 40
url: /fa/net/viewer/mapinfo-tab
description: توسعه‌ی MapInfo-TAB viewer از طریق کتابخانه‌ای که به‌طور خاص برای توسعه‌دهندگان .NET طراحی شده است. APIهای رندر نقشه برای Kml، GeoJson Gpx، Kml و سایر فایل‌ها.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs for MapInfo-TAB Viewer" h2="توسعه‌ی یک MapInfo-TAB viewer با API که به‌طور خاص برای توسعه‌دهندگان .NET / C# طراحی شده است." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET به شما این امکان را می‌دهد که یک MapInfo-TAB viewer برای فرمت‌های داده جغرافیایی برداری و رستری ایجاد کنید. داده‌ها تنها زمانی مفید هستند که کسی بتواند آن‌ها را ببیند. کتابخانه GIS .NET، به‌طور آسان و سریع، صادرات داده‌های GIS را به تصاویر برداری یا رستری فراهم می‌کند و نمادگذاری غنی برای سناریوهای تجسم پیچیده ارائه می‌دهد. 
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="مروری بر MapInfo-TAB Viewer .NET API." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      برچسب‌گذاری و متن. اعمال استایل برای متن و تشخیص خودکار مکان‌ها روی نقشه.
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه‌ها
      ...
      <p>
        ما برنامه‌های رایگان را که از API .NET برای پیاده‌سازی <a href="https://products.aspose.app/gis/viewer/mapinfo-tab" >"MapInfo-TAB Viewer"</a> و موارد دیگر استفاده می‌کنند، ارائه می‌دهیم. در اینجا می‌توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - MapInfo-TAB Viewer
    </h2>
    <p>
     در اینجا نحوه رندر نقشه از فرمت MapInfo-TAB با استفاده از تنظیمات پیش‌فرض آمده است:
    </p>
