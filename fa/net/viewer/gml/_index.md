...
<p>
 Aspose.GIS for .NET به شما این امکان را می‌دهد که یک GML viewer برای فرمت‌های داده‌ای جغرافیایی برداری و رستری ایجاد کنید. داده‌ها تنها زمانی مفید هستند که کسی بتواند آن‌ها را ببیند. کتابخانه GIS .NET، به‌آسانی و با سرعت داده‌های GIS را به تصاویر برداری یا رستری صادر می‌کند و نمادگذاری غنی برای سناریوهای تجسم پیچیده ارائه می‌دهد. 
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="مروری بر GML Viewer .NET API." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه‌ها
      ...
      <p>
        ما برنامه‌های رایگان را که از API .NET برای پیاده‌سازی <a href="https://products.aspose.app/gis/viewer/gml" >"GML Viewer"</a> و موارد دیگر استفاده می‌کنند، ارائه می‌دهیم. در اینجا می‌توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - GML Viewer
    </h2>
    <p>
     در اینجا نحوه رندر نقشه از فرمت GML با استفاده از تنظیمات پیش‌فرض آمده است:
    </p>
