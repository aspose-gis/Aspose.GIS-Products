...
weight: 40
url: /fa/viewer/esri-ascii
description: توسعه‌ی بیننده‌ی ESRI-ASCII از طریق کتابخانه‌ای که به‌طور خاص برای توسعه‌دهندگان .NET طراحی شده است. APIهای رندر نقشه برای Kml، GeoJson Gpx، Kml و سایر فایل‌ها.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs for ESRI-ASCII Viewer" h2="توسعه‌ی یک بیننده‌ی ESRI-ASCII با API که به‌طور خاص برای توسعه‌دهندگان .NET / C# طراحی شده است." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET به شما این امکان را می‌دهد که یک بیننده‌ی ESRI-ASCII برای فرمت‌های داده‌ای جغرافیایی برداری و رستری ایجاد کنید. داده‌ها تنها زمانی مفید هستند که کسی بتواند آن‌ها را ببیند. کتابخانه‌ی GIS .NET، به‌طور ساده و سریع، صادرات داده‌های GIS به تصاویر برداری یا رستری را آسان می‌کند و نمادگذاری غنی برای سناریوهای تجسم پیچیده ارائه می‌دهد. 
</p>

<p>
 Aspose.GIS for .NET با در نظر گرفتن سادگی، عملکرد، قابلیت استفاده و قابلیت حمل طراحی شده است. این شامل APIهایی برای استفاده با پلتفرم‌های .NET Framework &amp; .NET Core است که به شما امکان می‌دهد برنامه‌های چندسکویی را با سهولت زیادی ایجاد کنید.
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="مروری بر API بیننده‌ی ESRI-ASCII .NET." >}}
 ...
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    ...
    <li>تولیدکننده‌ی هندسه</li>
    <li>هندسه‌ی ترکیبی</li>
   </ul>
  </div>
  <!--/left-->
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    ویژگی‌های پیشرفته‌ی API دستکاری داده GIS
   </h2>
   <p>
   </p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     گالری برنامه‌ها
      ...
      <p>
        ما برنامه‌های رایگان را که از API .NET برای پیاده‌سازی <a href="https://products.aspose.app/gis/viewer/esri-ascii" >"بیننده‌ی ESRI-ASCII"</a> و موارد دیگر استفاده می‌کنند، ارائه می‌دهیم. در اینجا می‌توانید عملکرد و کیفیت کار آن را بررسی کنید. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     نمونه برای .NET - ESRI-ASCII Viewer
    </h2>
    <p>
     در اینجا نحوه رندر نقشه از فرمت ESRI-ASCII با استفاده از تنظیمات پیش‌فرض آمده است:
    </p>
