---
title: تبدیل KML به داده های GIS GPX از طریق .NET یا C#
weight: 120
url: /fa/net/conversion/kml-to-gpx/ 
description: API های On-Premise ما را امتحان کنید تا KML را به GPX در .NET Framework، .NET Core، C# تبدیل کنید.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تبدیل KML به GPX در C#" h2="صادرات KML به GPX با استفاده از API های سمت سرور، بدون نیاز به نرم افزارهایی مانند ArcGIS، ArcMap، QGIS یا Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GPX" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="چگونه KML را به GPX با استفاده از C# تبدیل کنیم؟" %}}

 برای تبدیل KML به GPX، ما از
...
{{% blocks/products/pf/agp/feature-section-col title="مراحل تبدیل KML به GPX در C#" %}}
...
{{% blocks/products/pf/agp/code-block title="ذخیره KML به عنوان GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="دموهای زنده KML به GPX" sectionDescription="اکنون KML را به GPX با مراجعه به [وب سایت دموهای زنده](https://products.aspose.app/gis/conversion/kml-to-gpx) تبدیل کنید. دمو زنده دارای مزایای زیر است" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" فایل KML خود را آپلود کنید، بلافاصله به GPX تبدیل می شود." >}}
...
KML (Keyhole Markup Language) حاوی اطلاعات جغرافیایی در نمادگذاری XML است. KML را می توان در برنامه های سیستم اطلاعات جغرافیایی (GIS) باز کرد، به شرطی که از آن پشتیبانی کنند. بسیاری از برنامه ها پس از اینکه به عنوان استاندارد بین المللی پذیرفته شد، شروع به ارائه پشتیبانی برای فرمت KML کردند.
