...
weight: 40
url: /he/net/viewer
description: פתחו צופה מפות באמצעות ספרייה שתוכננה במיוחד עבור מפתחי .NET. ממשקי API להצגת Kml, GeoJson Gpx, Kml ועוד קבצים.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs for GIS Map Rendering" h2="פתחו צופה מפות עם API שתוכנן במיוחד עבור מפתחי .NET." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET מאפשר לכם ליצור צופה מפות עבור פורמטים של נתוני גיאוגרפיים וקטוריים וראסטריים. הנתונים שימושיים רק כאשר מישהו יכול לראות אותם. ספריית GIS .NET מקלה ומזרזת את היצוא של נתוני GIS לתמונות וקטוריות או ראסטריות ומספקת סמלים עשירים עבור תרחישי הדמיה מורכבים. 
</p>

<p>
 Aspose.GIS for .NET תוכנן תוך מחשבה על פשטות, ביצועים, שימושיות וניידות. הוא מכיל ממשקי API לשימוש בפלטפורמות .NET Framework &amp; .NET Core, ומאפשר לכם לבנות יישומים חוצי-פלטפורמה בקלות רבה.
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="סקירה של API להצגת מפות .NET." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     השתמשו בשיפורי הדמיה מתקדמים: שלבו סמלים, מחולל גיאומטריה, גיאומטריה מעורבת.
    </p>
   </div>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     צופה מפות - דוגמת קוד עבור .NET
    </h2>
    <p>
     הנה איך להעביר מפה מקובץ shapefile ל-SVG באמצעות הגדרות ברירת מחדל:
    </p>
