---
title: המרת GDB לנתוני GIS CSV באמצעות .NET או C#
weight: 120
url: /he/net/conversion/gdb-to-csv/ 
description: נסה את ה-API שלנו באתר כדי להמיר GDB ל-CSV ב-.NET Framework, ‎.NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="המרת GDB ל-CSV ב-C#" h2="ייצוא GDB ל-CSV באמצעות ממשקי API בצד השרת, מבלי להזדקק לתוכנות כמו ArcGIS, ArcMap, QGIS או Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="Aspose.GIS" subTitlepfName="עבור .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GDB" >}}
...
{{% blocks/products/pf/agp/content h2="כיצד להמיר GDB ל-CSV באמצעות C#" %}}

 כדי להמיר GDB ל-CSV, נשתמש ב
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת GDB ל-CSV ב-C#" %}}
...
1.  נתיב קובץ מחרוזת לקובץ ה-GDB המקור
2.  מנהל התקנים של מקור כדי ליידע את ה-API על פורמט הקלט. הגדר אותו ל-Drivers.FileGdb
3.  נתיב קובץ מחרוזת למקום בו נמצאים נתוני CSV היעד
...
{{% blocks/products/pf/agp/code-block title="שמור GDB כ-CSV - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="הדגמות חיות של GDB ל-CSV" sectionDescription="המרת GDB ל-CSV עכשיו על ידי ביקור באתר [הדגמות החיות שלנו](https://products.aspose.app/gis/conversion/gdb-to-csv). להדגמה החיה יש את היתרונות הבאים" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" העלה את קובץ ה-GDB שלך, הוא יומר באופן מיידי ל-CSV." >}}
...
{{< blocks/products/pf/agp/other-supported-section title="המרות נתמכות אחרות" subTitle="ניתן להמיר גם GDB לפורמטים קבצים רבים אחרים כולל כמה המופיעים להלן." >}}
