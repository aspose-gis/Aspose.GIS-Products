---
title: המרת GPX לנתוני GIS Shapefile באמצעות .NET או C#
weight: 120
url: /he/net/conversion/gpx-to-shapefile/ 
description: נסה את ה-API שלנו באתר כדי להמיר GPX ל-Shapefile ב-.NET Framework, ‎.NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="המרת GPX ל-Shapefile ב-C#" h2="ייצוא GPX ל-Shapefile באמצעות API בצד השרת, מבלי להזדקק לתוכנות כמו ArcGIS, ArcMap, QGIS או Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Shapefile" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GPX" >}}
...
{{% blocks/products/pf/agp/content h2="כיצד להמיר GPX ל-Shapefile באמצעות C#" %}}

 כדי להמיר GPX ל-Shapefile, נשתמש ב
 ...
 מנהל החבילות, חפש את
 **Aspose.GIS** 
 והתקן. אתה יכול גם להשתמש בפקודה הבאה ממסוף Package Manager.
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת GPX ל-Shapefile ב-C#" %}}
...
3.  נתיב קובץ מחרוזת עבור נתוני Shapefile היעד
...
{{% blocks/products/pf/agp/code-block title="שמור GPX כ-Shapefile - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="הדגמות חיות של GPX ל-Shapefile" sectionDescription="המרת GPX ל-Shapefile עכשיו על ידי ביקור באתר [הדגמות החיות שלנו](https://products.aspose.app/gis/conversion/gpx-to-shapefile). להדגמה החיה יש את היתרונות הבאים" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" העלה את קובץ ה-GPX שלך, הוא יומר באופן מיידי ל-Shapefile." >}}
...
SHP הוא סיומת הקובץ עבור אחד מסוגי הקבצים העיקריים המשמשים לייצוג נתוני ESRI Shapefile. הוא מייצג מידע גיאוגרפי בצורה של נתונים וקטוריים לשימוש ביישומי מערכות מידע גיאוגרפיות (GIS). הפורמט פותח כמפרטים פתוחים על מנת להקל על יכולת ההפעלה בין ESRI לבין מוצרי תוכנה אחרים.
...
{{< blocks/products/pf/agp/other-supported-section title="המרות נתמכות אחרות" subTitle="אתה יכול גם להמיר GPX להרבה פורמטים קבצים אחרים כולל כמה המפורטים להלן." >}}
