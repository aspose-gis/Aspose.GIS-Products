---
title: המרת GPX לנתוני GIS GeoJSON באמצעות .NET או C#
weight: 120
url: /he/net/conversion/gpx-to-geojson/ 
description: נסה את ה-API שלנו באתר כדי להמיר GPX ל-GeoJSON ב-.NET Framework, ‎.NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="המרת GPX ל-GeoJSON ב-C#" h2="ייצוא GPX ל-GeoJSON באמצעות ממשקי API בצד השרת, ללא צורך בתוכנות כמו ArcGIS, ArcMap, QGIS או Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GPX" >}}
...
{{% blocks/products/pf/agp/content h2="כיצד להמיר GPX ל-GeoJSON באמצעות C#" %}}

 כדי להמיר GPX ל-GeoJSON, נשתמש ב
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת GPX ל-GeoJSON ב-C#" %}}
...
3.  נתיב קובץ מחרוזת למנתוני GeoJSON היעד
...
{{% blocks/products/pf/agp/code-block title="שמור GPX כ-GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="הדגמות חיות של GPX ל-GeoJSON" sectionDescription="המרת GPX ל-GeoJSON עכשיו על ידי ביקור באתר [הדגמות החיות שלנו](https://products.aspose.app/gis/conversion/gpx-to-geojson). להדגמה החיה יש את היתרונות הבאים">}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" העלה את קובץ ה-GPX שלך, הוא יומר באופן מיידי ל-GeoJSON." >}}
...
GeoJSON הוא פורמט מבוסס JSON שנועד לייצג תכונות גיאוגרפיות עם התכונות הלא מרחביות שלהן. פורמט זה מגדיר אובייקטים JSON שונים ואת אופן הצטרפותם. JSON מייצג מידע מצטבר על התכונות הגיאוגרפיות, היקפיהן המרחביים והמאפיינים שלהן.
