---
title: המרת Shapefile לנתוני GIS GeoJSON באמצעות .NET או C#
weight: 120
url: /he/net/conversion/shapefile-to-geojson/
description: נסה את ה-API שלנו באתר כדי להמיר Shapefile ל-GeoJSON ב-.NET Framework, ‎.NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="המרת Shapefile ל-GeoJSON ב-C#" h2="ייצוא Shapefile ל-GeoJSON באמצעות ממשקי API בצד השרת, מבלי להזדקק לתוכנות כמו ArcGIS, ArcMap, QGIS או Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="ל-.NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="כיצד להמיר Shapefile ל-GeoJSON באמצעות C#" %}}

 כדי להמיר Shapefile ל-GeoJSON, נשתמש ב
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת Shapefile ל-GeoJSON ב-C#" %}}
...
3.  נתיב קובץ מחרוזת ליעד נתוני GeoJSON
...
{{% blocks/products/pf/agp/code-block title="שמור Shapefile כ-GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="הדגמות חיות של Shapefile ל-GeoJSON" sectionDescription="המר Shapefile ל-GeoJSON עכשיו על ידי ביקור באתר [הדגמות החיות שלנו](https://products.aspose.app/gis/conversion/shapefile-to-geojson). להדגמה החיה יש את היתרונות הבאים" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" העלה את קובץ ה-Shapefile שלך, הוא יומר באופן מיידי ל-GeoJSON." >}}
...
SHP הוא סיומת הקובץ עבור אחד מסוגי הקבצים העיקריים המשמשים לייצוג ESRI Shapefile. הוא מייצג מידע גיאוגרפי בצורה של נתונים וקטוריים לשימוש ביישומים של מערכות מידע גיאוגרפיות (GIS). הפורמט פותח כמפרטים פתוחים על מנת להקל על יכולת ההפעלה בין ESRI לבין מוצרים אחרים.
...
{{< blocks/products/pf/agp/other-supported-section title="המרות נתמכות אחרות" subTitle="ניתן גם להמיר Shapefile לפורמטים קבצים רבים אחרים כולל כמה המופיעים להלן." >}}
