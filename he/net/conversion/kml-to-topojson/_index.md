---
title: המרת KML לנתוני GIS TopoJSON באמצעות ‎.NET‎ או ‎C#‎
weight: 120
url: /he/net/conversion/kml-to-topojson/ 
description: נסה את ה-API שלנו באתר כדי להמיר KML ל-TopoJSON ב-.NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="המרת KML ל-TopoJSON ב-#C" h2="ייצוא KML ל-TopoJSON באמצעות ממשקי API בצד השרת, ללא צורך בתוכנות כמו ArcGIS, ArcMap, QGIS או Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TopoJSON" pfName="Aspose.GIS" subTitlepfName="ל-.NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="כיצד להמיר KML ל-TopoJSON באמצעות #C" %}}

 כדי להמיר KML ל-TopoJSON, נשתמש ב
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת KML ל-TopoJSON ב-#C" %}}
...
3.  נתיב קובץ מסוג מחרוזת לקובץ נתוני TopoJSON היעד
...
{{% blocks/products/pf/agp/code-block title="שמור KML כ-TopoJSON - #C" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="הדגמות חיות KML ל-TopoJSON" sectionDescription="המרת KML ל-TopoJSON עכשיו על ידי ביקור באתר [הדגמות החיות שלנו](https://products.aspose.app/gis/conversion/kml-to-topojson). להדגמה החיה יש את היתרונות הבאים" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" העלה את קובץ ה-KML שלך, הוא יומר באופן מיידי ל-TopoJSON." >}}
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" תקבל קישור להורדה." >}}

    {{% blocks/products/pf/agp/content h2="ספריית ‎.NET‎ GIS" %}}

 Aspose.GIS for .NET היא API לטיפול והמרת נתוני GIS. הוא תומך באופן מלא בקריאה, כתיבה והמרת פורמטים מוכרים של נתוני GIS כמו קבצי ESRI Shapefiles, GeoJSON, TopoJSON, מסדי נתונים ESRI Geodatabase, שפת סימון גיאוגרפיה, Google Earth, פורמט החלפה GPS, פורמטי MapInfo ו-OpenStreetMap. זהו API עצמאי מבוסס ‎.NET‎ ואינו דורש תוכנות GIS מבוססות כמו ArcGIS / ArcMap, QGIS וכו'. 
...
TopoJSON הוא הרחבה של GeoJSON המקודדת טופולוגיה. פורמט מבוסס JSON שנועד לייצג תכונות גיאוגרפיות עם התכונות הלא-מרחביות שלהן. פורמט זה מגדיר אובייקטים JSON שונים ואופן הצטרפותם. פורמט JSON מייצג מידע מצטבר על תכונות גיאוגרפיות, היקפיהן המרחביים ותכונותיהן.
