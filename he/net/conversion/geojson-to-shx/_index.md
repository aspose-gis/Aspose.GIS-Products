---
title: המרת GEOJSON לנתוני GIS SHX באמצעות .NET
weight: 60
url: /he/net/conversion/geojson-to-shx/
description: נסה את ממשקי ה-API שלנו באתר עבור המרת נתוני GIS שלך ב-.NET Framework, ‎.NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="המרת GEOJSON ל-SHX בשפת C#" h2="ייצוא GEOJSON ל-SHX באמצעות ממשקי API בצד השרת, ללא צורך בתוכנות כמו ArcGIS, ArcMap, QGIS או Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SHX" pfName="Aspose.GIS" subTitlepfName="עבור .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GEOJSON" >}}
...
{{% blocks/products/pf/agp/content h2="כיצד להמיר GEOJSON ל-SHX באמצעות C#" %}}

 כדי להמיר GEOJSON ל-SHX, נשתמש ב
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת GEOJSON ל-SHX בשפת C#" %}}
...
1.  נתיב קובץ מחרוזת למקור GEOJSON file
2.  מנהל התקן של המקור כדי ליידע את ה-API על פורמט הקלט. הגדר אותו ל-Drivers.GeoJson
3.  נתיב קובץ מחרוזת ליעד נתוני SHX file
4.  מנהל התקן של היעד לציין פורמט פלט. הגדר אותו ל-Drivers.Shapefile
...
{{% blocks/products/pf/agp/code-block title="שמור GEOJSON כ-SHX - C#" offSpacer="" %}}

```cs
// המרת נתוני GIS GEOJSON לנתוני SHX
...
{{< blocks/products/pf/agp/demobox sectionTitle="הדגמות חיות GEOJSON ל-SHX" sectionDescription="המרת GEOJSON ל-SHX עכשיו על ידי ביקור באתר [הדגמות החיות שלנו](https://products.aspose.app/gis/conversion/geojson-to-shx). להדגמה החיה יש את היתרונות הבאים" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" העלה את קובץ ה-GEOJSON שלך, הוא יומר באופן מיידי ל-SHX." >}}
...
GeoJSON הוא פורמט מבוסס JSON שנועד לייצג את התכונות הגיאוגרפיות עם התכונות הלא מרחביות שלהן. פורמט זה מגדיר אובייקטים שונים של JSON ואת אופן הצטרפותם. פורמט JSON מייצג מידע מצטבר על תכונות גיאוגרפיות, היקפים המרחביים שלהן ומאפיינים. אובייקט של קובץ זה עשוי לציין גיאומטריה (נקודה, LineString, Polygon), תכונה או אוסף של תכונות. התכונות משקפות כתובות ומקומות כנקודות, רחובות מרכזיים וגבולות כ-line strings ומדינות, מחוזות ואזורי קרקע כפוליגונים. באמצעות GeoJSON, יישומי ניתוב וניווט סלולריים שונים יכולים לציין את הכיסוי של השירותים שלהם. הרחבה של GeoJSON היא TopoJSON שהיא קטנה יותר בגודלה ומקודדת טופולוגיה גיאוגרפית.
קרא עוד
