---
title: המרת OSM לנתוני GIS בפורמט CSV באמצעות .NET או C#
weight: 120
url: /he/net/conversion/osm-to-csv/ 
description: נסה את ה-API הפרימיסי שלנו כדי להמיר OSM ל-CSV ב-.NET Framework, ‎.NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="המרת OSM ל-CSV ב-C#" h2="ייצוא OSM ל-CSV באמצעות ממשקי API בצד השרת, מבלי צורך בתוכנות כמו ArcGIS, ArcMap, QGIS או Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="Aspose.GIS" subTitlepfName="עבור .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="OSM" >}}
...
{{% blocks/products/pf/agp/content h2="כיצד להמיר OSM ל-CSV באמצעות C#" %}}

 כדי להמיר OSM ל-CSV, נשתמש ב
...
{{% blocks/products/pf/agp/feature-section-col title="שלבים להמרת OSM ל-CSV ב-C#" %}}
...
1.  נתיב קובץ מחרוזת לקובץ ה-OSM המקור
...
{{% blocks/products/pf/agp/code-block title="שמור OSM כ-CSV - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="הדגמות חיות של OSM ל-CSV" sectionDescription="המרת OSM ל-CSV עכשיו על ידי ביקור באתר [ההדגמות החיות שלנו](https://products.aspose.app/gis/conversion/osm-to-csv). להדגמה החיה יש את היתרונות הבאים" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" אין צורך להוריד את Aspose GIS API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" פשוט בחר CSV כפורמט פלט ו." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" העלה את קובץ ה-OSM שלך, הוא יומר באופן מיידי ל-CSV." >}}
