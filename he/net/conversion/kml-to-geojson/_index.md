...
weight: 120
url: /he/net/conversion/kml-to-geojson/ 
description: נסה את ה-API שלנו באתר כדי להמיר KML ל-GeoJSON ב-.NET Framework, ‎.NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="המרת KML ל-GeoJSON ב-C#" h2="ייצוא KML ל-GeoJSON באמצעות ממשקי API בצד השרת, ללא צורך בתוכנות כמו ArcGIS, ArcMap, QGIS או Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="ל-.NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
4.  מנהל התקן יעד לציין פורמט פלט. הגדר אותו ל-Drivers.GeoJson
...
{{< blocks/products/pf/agp/demobox sectionTitle="הדגמות חיות KML ל-GeoJSON" sectionDescription="המרת KML ל-GeoJSON עכשיו על ידי ביקור באתר [הדגמות החיות שלנו](https://products.aspose.app/gis/conversion/kml-to-geojson). להדגמה החיה יש את היתרונות הבאים">}}
...
GeoJSON הוא פורמט מבוסס JSON שנועד לייצג תכונות גיאוגרפיות עם התכונות הלא מרחביות שלהן. פורמט זה מגדיר אובייקטים JSON שונים ואופן הצטרפותם. JSON מייצג מידע מצטבר על תכונות גיאוגרפיות, היקפיהן המרחביים והמאפיינים שלהן.
