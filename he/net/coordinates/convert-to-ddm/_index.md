...
{{< blocks/products/pf/upper-banner h1=".NET APIs להמרת דרגה דקה עשרונית (DDM) עבור GIS" h2="פיתוח המרת DDM עם API שתוכנן במיוחד למפתחי .NET / C#." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET מאפשר לך להמיר דרגה דקה עשרונית (DDM) ליחידות גיאוגרפיות. הספרייה שלנו מאפשרת לך בקלות ובמהירות להמיר קו רוחב ואורך לפורמט יחידות רצוי. בנוסף, לספרייה שלנו יש אפשרות לחלץ מיקומים לנקודה מטקסט.
</p>
 ...
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li><b>רשת לאומית אמריקאית: </b>USNG</li>
   </ul>
  </div>
  <!--/right-->
 </div>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      תמיכה במערכת ייחוס גיאוגרפית עולמית (GEOREF)
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      תמיכה במערכת ייחוס רשת צבאית (MGRS)
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     תמיכה ברשת לאומית אמריקאית (USNG)
    </p>
   </div>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     גלריית יישומי אינטרנט
      ...
      <p>
        אנו מציגים יישומים חינמיים המשתמשים ב-.NET API כדי ליישם <a href="https://products.aspose.app/gis/coordinates/convert-to-ddm" >"המרת ל-DDM"</a> ואחרים. כאן תוכלו לחקור את הפונקציונליות והאיכות של עבודתו.
      </p>
...
{{< blocks/products/pf/slr-tab tabTitle="מדוע Aspose.GIS for .NET?" tabId="success-stories" >}}
