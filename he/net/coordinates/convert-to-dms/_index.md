---
title: המרת מעלות דקות ושניות (DMS) - ממשקי API עבור .NET
weight: 40
url: /he/net/coordinates/convert-to-dms
...
<p>
 Aspose.GIS for .NET מאפשר לך להמיר מעלות דקות ושניות (DMS) ליחידות גיאוגרפיות. הספרייה שלנו מאפשרת לך בקלות ובמהירות להמיר קו רוחב ואורך לפורמט יחידות רצוי. בנוסף, לספרייה שלנו יש אפשרות לחלץ מיקומים לנקודה מטקסט.
</p>
 ...
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    ...
    <li><b>מעלות דקות ושניות: </b>DMS</li>
   </ul>
  </div>
  <!--/left-->
  <div class="d1-col d1-right">
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     המרת קו רוחב ואורך ליחידות מבוססות מעלות
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     גלריית יישומי אינטרנט
      ...
      <p>
        אנו מציגים יישומים חינמיים המשתמשים ב-API של ‎.NET כדי ליישם <a href="https://products.aspose.app/gis/coordinates/convert-to-dms" >"המרת ל-DMS"</a> ואחרים. כאן תוכלו לחקור את הפונקציונליות והאיכות של עבודתו.
      </p>
