---
title: Converter Shapefile para TopoJSON Dados GIS via .NET ou C#
weight: 120
url: /pt/conversion/shapefile-to-topojson/ 
description: Experimente nossas APIs On-Premise para converter Shapefile para TopoJSON no .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter Shapefile para TopoJSON em C#" h2="Exportar Shapefile para TopoJSON usando APIs do lado do servidor, sem a necessidade de softwares como ArcGIS, ArcMap, QGIS ou Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TopoJSON" pfName="Aspose.GIS" subTitlepfName="para .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter Shapefile para TopoJSON Usando C#" %}}

 Para converter Shapefile para TopoJSON, usaremos o
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter Shapefile para TopoJSON em C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Salvar Shapefile como TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile para TopoJSON Demonstrações ao Vivo" sectionDescription="Converter Shapefile para TopoJSON agora mesmo visitando nosso [site de Demonstrações ao Vivo](https://products.aspose.app/gis/conversion/shapefile-to-topojson). A demonstração ao vivo tem os seguintes benefícios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Envie seu arquivo Shapefile, ele será convertido instantaneamente para TopoJSON." >}}
