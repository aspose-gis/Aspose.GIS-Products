---
title: Converter Shapefile para GeoJSON Dados GIS via .NET ou C#
weight: 120
url: /pt/net/conversion/shapefile-to-geojson/ 
description: Experimente nossas APIs On-Premise para converter Shapefile para GeoJSON em .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Converter Shapefile para GeoJSON em C#" h2="Exportar Shapefile para GeoJSON usando APIs do lado do servidor, sem a necessidade de softwares como ArcGIS, ArcMap, QGIS ou Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="Como Converter Shapefile para GeoJSON Usando C#" %}}

 Para converter Shapefile para GeoJSON, usaremos o
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter Shapefile para GeoJSON em C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Salvar Shapefile como GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile para GeoJSON Demonstrações ao Vivo" sectionDescription="Converter Shapefile para GeoJSON agora mesmo visitando nosso [site de Demonstrações ao Vivo](https://products.aspose.app/gis/conversion/shapefile-to-geojson). A demonstração ao vivo tem os seguintes benefícios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Envie seu arquivo Shapefile, ele será convertido instantaneamente para GeoJSON." >}}
...
SHP é a extensão de arquivo para um dos principais tipos de arquivos usados ​​para representação de Shapefiles ESRI. Ele representa informações geográficas na forma de dados vetoriais a serem usados ​​por aplicativos de Sistemas de Informações Geográficas (GIS). O formato foi desenvolvido como especificações abertas para facilitar a interoperabilidade entre ESRI e outros produtos de software.
