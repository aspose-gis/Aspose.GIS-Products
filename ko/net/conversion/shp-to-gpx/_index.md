...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 SHP를 GPX로 변환하는 방법" %}}

SHP를 GPX로 변환하려면 C# 플랫폼용 강력하고 사용하기 쉬운 GIS API인 [Aspose.GIS for .NET](https://products.aspose.com/gis/net) 
API를 사용합니다. 
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 SHP를 GPX로 변환하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="C# - SHP를 GPX로 저장" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SHP에서 GPX로의 라이브 데모" sectionDescription="[라이브 데모 웹사이트](https://products.aspose.com/gis/conversion/shp-to-gpx)를 방문하여 SHP를 즉시 GPX로 변환하세요. 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="SHP 파일을 업로드하면 즉시 GPX로 변환됩니다." >}}
...
GPX 확장자는 인터넷의 애플리케이션 및 웹 서비스 간에 GPS 데이터를 교환하기 위한 GPS Exchange 형식을 나타냅니다. 다양한 프로그램에서 가져오고 읽을 수 있는 GPS 데이터(예: 웨이포인트, 경로 및 트랙)를 포함하는 경량 XML 형식입니다. GPX는 개방되어 있으며 다양한 애플리케이션과 GPS 장치에서 지원됩니다.
...
{{< blocks/products/pf/agp/other-supported-section title="지원되는 다른 변환" subTitle="SHP를 다음과 같은 다른 많은 파일 형식으로도 변환할 수 있습니다." >}}
