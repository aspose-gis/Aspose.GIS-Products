---
title: .NET 또는 C#을 사용하여 GML to KML GIS 데이터 변환
weight: 120
url: /ko/net/conversion/gml-to-kml/ 
description: .NET Framework, .NET Core, C#에서 On-Premise API를 사용하여 GML을 KML로 변환해 보세요.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C#에서 GML을 KML로 변환" h2="ArcGIS, ArcMap, QGIS 또는 Google Earth와 같은 소프트웨어가 필요 없이 서버 측 API를 사용하여 GML을 KML로 내보내기." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GML" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 GML을 KML로 변환하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 GML을 KML로 변환하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="C# - GML을 KML로 저장" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML to KML 라이브 데모" sectionDescription="저희 [라이브 데모 웹사이트](https://products.aspose.app/gis/conversion/gml-to-kml)를 방문하여 GML을 즉시 KML로 변환해 보세요. 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="GML 파일을 업로드하면 즉시 KML로 변환됩니다." >}}
