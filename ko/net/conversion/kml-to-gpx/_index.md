---
title: .NET 또는 C#을(를) 사용하여 KML to GPX GIS 데이터 변환
weight: 120
url: /ko/net/conversion/kml-to-gpx/ 
description: .NET Framework, .NET Core, C#에서 On-Premise API를 사용하여 KML을 GPX로 변환해 보세요.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C#에서 KML을 GPX로 변환" h2="ArcGIS, ArcMap, QGIS 또는 Google Earth와 같은 소프트웨어가 필요 없이 서버 측 API를 사용하여 KML을 GPX로 내보내기." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GPX" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="C#을(를) 사용하여 KML을 GPX로 변환하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 KML을 GPX로 변환하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="C# - KML을 GPX로 저장" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML to GPX 라이브 데모" sectionDescription="[라이브 데모 웹사이트](https://products.aspose.app/gis/conversion/kml-to-gpx)를 방문하여 KML을 즉시 GPX로 변환해 보세요. 라이브 데모는 다음과 같은 이점을 제공합니다." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="KML 파일을 업로드하면 즉시 GPX로 변환됩니다." >}}
...
KML(Keyhole Markup Language)은 XML 표기법으로 지리 공간 정보를 포함합니다. KML은 이를 지원하는 GIS 애플리케이션에서 열 수 있습니다. 많은 애플리케이션이 국제 표준으로 채택된 후 KML 형식에 대한 지원을 시작했습니다.
