---
title: TOPOJSON을 SHX GIS 데이터로 .NET을 통해 변환
weight: 260
url: /ko/net/conversion/topojson-to-shx/
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 TOPOJSON을 SHX로 변환하는 방법" %}}

TOPOJSON을 SHX로 변환하려면 C# 플랫폼용 강력하고 사용하기 쉬운 GIS API인 [Aspose.GIS for .NET](https://products.aspose.com/gis/net) 
API를 사용합니다. 
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 TOPOJSON을 SHX로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

*VectorLayer.Convert* 
메서드를 사용하면 한 줄의 코드로 변환할 수 있습니다. 자세한 내용은 아래와 같습니다.
...
{{% blocks/products/pf/agp/code-block title="C# - TOPOJSON을 SHX로 저장" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TOPOJSON을 SHX로 변환하는 실시간 데모" sectionDescription="저희 [실시간 데모 웹사이트](https://products.aspose.com/gis/conversion/topojson-to-shx)를 방문하여 TOPOJSON을 즉시 SHX로 변환하세요. 실시간 데모에는 다음과 같은 이점이 있습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="Aspose GIS API를 다운로드할 필요가 없습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="SHX를 출력 형식으로 선택하기만 하면 됩니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="TOPOJSON 파일을 업로드하면 즉시 SHX로 변환됩니다." >}}
...
TopoJSON은 토폴로지를 인코딩하는 GeoJSON의 확장입니다. TopoJSON 파일에서 도형은 공유 선분이라고 하는 아크를 통해 함께 스티치됩니다.
자세히 보기
...
특성 도형의 위치 인덱스 형식으로, 빠르게 앞뒤로 검색할 수 있습니다.
자세히 보기
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/topojson-to-json" name="TOPOJSON TO JSON" description="JavaScript 객체 표기법" >}}
