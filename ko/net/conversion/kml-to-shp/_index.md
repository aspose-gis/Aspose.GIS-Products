...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 KML을 SHP로 변환하는 방법" %}}

KML을 SHP로 변환하려면 [Aspose.GIS for .NET](https://products.aspose.com/gis/net) API를 사용합니다. 이 API는 C# 플랫폼용으로 기능이 풍부하고 강력하며 사용하기 쉬운 GIS API입니다. 
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 KML을 SHP로 변환하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="C# - KML을 SHP로 저장" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML을 SHP로 변환하는 라이브 데모" sectionDescription="[라이브 데모 웹사이트](https://products.aspose.app/gis/conversion/kml-to-shp)를 방문하여 KML을 SHP로 즉시 변환해 보세요. 라이브 데모는 다음과 같은 이점을 제공합니다." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="KML 파일을 업로드하면 즉시 SHP로 변환됩니다." >}}
...
Shapefile은 다중 파일 형식(ESRI Shapefile로 알려짐)입니다. 주 파일은 SHP 확장자를 가지고 있습니다. Shapefile은 인기 있는 벡터 지리 파일 형식입니다. Esri 제품 간의 호환성을 위해 Esri에서 개발 및 유지 관리합니다.
