---
title: .NET 또는 C#을 사용하여 KML을 Shapefile GIS 데이터로 변환
weight: 120
url: /ko/net/conversion/kml-to-shapefile/ 
description: .NET Framework, .NET Core, C#에서 On-Premise API를 사용하여 KML을 Shapefile로 변환해 보세요.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C#에서 KML을 Shapefile로 변환" h2="ArcGIS, ArcMap, QGIS 또는 Google Earth와 같은 소프트웨어가 필요 없이 서버 측 API를 사용하여 KML을 Shapefile로 내보내세요." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Shapefile" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 KML을 Shapefile로 변환하는 방법" %}}

KML을 Shapefile로 변환하려면 [Aspose.GIS for .NET](https://products.aspose.com/gis/net) API를 사용합니다. 이 API는 C# 플랫폼용으로 기능이 풍부하고 강력하며 사용하기 쉬운 GIS API입니다. 
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 KML을 Shapefile로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

*VectorLayer.Convert* 메서드를 사용하면 코드가 한 줄만으로 변환할 수 있습니다. 자세한 내용은 아래 4개의 매개변수입니다.
...
{{% blocks/products/pf/agp/code-block title="KML을 Shapefile로 저장 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML을 Shapefile로 변환하는 라이브 데모" sectionDescription="[라이브 데모 웹사이트](https://products.aspose.app/gis/conversion/kml-to-shapefile)를 방문하여 KML을 Shapefile로 즉시 변환해 보세요. 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="KML 파일을 업로드하면 즉시 Shapefile로 변환됩니다." >}}
...
SHP는 ESRI Shapefile의 주요 파일 유형 중 하나에 대한 파일 확장자입니다. 벡터 데이터를 사용하여 지리 정보 시스템(GIS) 애플리케이션에서 사용되는 지리 공간 정보를 나타냅니다. 이 형식은 ESRI 및 기타 소프트웨어 제품 간의 상호 운용성을 용이하게 하기 위해 공개 사양으로 개발되었습니다.
