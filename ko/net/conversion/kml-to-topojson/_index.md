---
title: .NET 또는 C#을(를) 사용하여 KML을 TopoJSON GIS 데이터로 변환
weight: 120
url: /ko/net/conversion/kml-to-topojson/ 
description: .NET Framework, .NET Core, C#에서 On-Premise API를 사용하여 KML을 TopoJSON으로 변환해 보세요.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C#에서 KML을 TopoJSON으로 변환" h2="ArcGIS, ArcMap, QGIS 또는 Google Earth와 같은 소프트웨어가 필요 없이 서버 측 API를 사용하여 KML을 TopoJSON으로 내보내기" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TopoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="C#을(를) 사용하여 KML을 TopoJSON으로 변환하는 방법" %}}

KML을 TopoJSON으로 변환하려면 [Aspose.GIS for .NET](https://products.aspose.com/gis/net) 
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 KML을 TopoJSON으로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

*VectorLayer.Convert* 
메서드를 사용하여 코드가 한 줄로 변환할 수 있습니다. 아래에 자세히 설명된 4개의 매개변수를 사용합니다.

{{% /blocks/products/pf/agp/text %}}

1.  소스 KML 파일의 문자열 형식 파일 경로
2.  입력 형식을 API에 알리기 위한 소스 드라이버입니다. Drivers.Kml로 설정합니다.
3.  대상 TopoJSON 데이터 파일의 문자열 형식 파일 경로
...
{{% blocks/products/pf/agp/code-block title="C# - KML을 TopoJSON으로 저장" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML을 TopoJSON으로 변환하는 라이브 데모" sectionDescription="[라이브 데모 웹사이트](https://products.aspose.app/gis/conversion/kml-to-topojson)를 방문하여 KML을 TopoJSON으로 즉시 변환하십시오. 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="KML 파일을 업로드하면 즉시 TopoJSON으로 변환됩니다." >}}
...
TopoJSON은 토폴로지를 인코딩하는 GeoJSON 확장입니다. 지리적 특징과 비 공간 속성을 나타내도록 설계된 JSON 기반 형식입니다. 이 형식이 다양한 JSON(JavaScript Object Notation) 개체와 결합 방식을 정의합니다. JSON 형식은 지리적 특징, 공간 범위 및 속성에 대한 집합 정보를 나타냅니다.
