---
title: .NET 또는 C#을 사용하여 GeoJSON을 GPX GIS 데이터로 변환
weight: 120
url: /ko/net/conversion/geojson-to-gpx/ 
description: .NET Framework, .NET Core, C#에서 On-Premise API를 사용하여 GeoJSON을 GPX로 변환해 보세요.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C#에서 GeoJSON을 GPX로 변환" h2="ArcGIS, ArcMap, QGIS 또는 Google Earth와 같은 소프트웨어가 필요 없이 서버 측 API를 사용하여 GeoJSON을 GPX로 내보내기." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GPX" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GeoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 GeoJSON을 GPX로 변환하는 방법" %}}

GeoJSON을 GPX로 변환하려면 [Aspose.GIS for .NET](https://products.aspose.com/gis/net) API를 사용합니다. 이 API는 C# 플랫폼용으로 기능이 풍부하고 강력하며 사용하기 쉬운 GIS API입니다. 
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 GeoJSON을 GPX로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

*VectorLayer.Convert* 메서드를 사용하면 한 줄의 코드로 변환할 수 있습니다. 자세한 내용은 아래 4개의 매개변수를 참조하십시오.
...
{{% blocks/products/pf/agp/code-block title="GeoJSON을 GPX로 저장 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GeoJSON을 GPX로 실시간 데모" sectionDescription="[실시간 데모 웹사이트](https://products.aspose.app/gis/conversion/geojson-to-gpx)를 방문하여 GeoJSON을 즉시 GPX로 변환해 보세요. 실시간 데모는 다음과 같은 이점을 제공합니다." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="GeoJSON 파일을 업로드하면 즉시 GPX로 변환됩니다." >}}
