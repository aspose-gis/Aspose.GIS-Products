...
{{< blocks/products/pf/upper-banner h1="C#에서 TopoJSON을 GeoJSON으로 변환" h2="ArcGIS, ArcMap, QGIS 또는 Google Earth와 같은 소프트웨어가 필요 없이 서버 측 API를 사용하여 TopoJSON을 GeoJSON으로 내보내기" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TopoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 TopoJSON을 GeoJSON으로 변환하는 방법" %}}

TopoJSON을 GeoJSON으로 변환하려면 [Aspose.GIS for .NET](https://products.aspose.com/gis/net) API를 사용합니다. 이 API는 C# 플랫폼용 기능이 풍부하고 강력하며 사용하기 쉬운 GIS API입니다. 
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 TopoJSON을 GeoJSON으로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

*VectorLayer.Convert* 메서드를 사용하여 코드가 한 줄로 변환할 수 있습니다. 아래에 자세히 설명된 4개의 매개변수를 사용합니다.

{{% /blocks/products/pf/agp/text %}}

1. 소스 TopoJSON 파일의 문자열 형식 파일 경로
2. 소스 드라이버를 설정하여 API가 입력 형식을 알 수 있도록 합니다. Drivers.TopoJson으로 설정합니다.
3. 대상 GeoJSON 데이터 파일의 문자열 형식 파일 경로
4. 출력 형식을 지정하는 대상 드라이버입니다. Drivers.GeoJson으로 설정합니다.
...
{{% blocks/products/pf/agp/code-block title="TopoJSON을 GeoJSON으로 저장 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON을 GeoJSON으로 실시간 데모" sectionDescription="[실시간 데모 웹사이트](https://products.aspose.app/gis/conversion/topojson-to-geojson)를 방문하여 TopoJSON을 GeoJSON으로 지금 바로 변환하세요. 실시간 데모에는 다음과 같은 이점이 있습니다." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="TopoJSON 파일을 업로드하면 즉시 GeoJSON으로 변환됩니다." >}}
...
TopoJSON은 토폴로지를 인코딩하는 GeoJSON 확장입니다. 비공간 속성과 함께 지리적 특징을 나타내도록 설계된 JSON 기반 형식입니다. 이 형식은 다양한 JSON (JavaScript Object Notation) 객체와 결합 방식을 정의합니다. JSON 형식은 지리적 특징, 공간 범위 및 속성에 대한 집합 정보를 나타냅니다.

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="GeoJSON" readMoreLink="https://docs.fileformat.com/gis/geojson/" >}}

GeoJSON은 비공간 속성과 함께 지리적 특징을 나타내도록 설계된 JSON 기반 형식입니다. 이 형식은 다양한 JSON (JavaScript Object Notation) 객체와 결합 방식을 정의합니다. JSON 형식은 지리적 특징, 공간 범위 및 속성에 대한 집합 정보를 나타냅니다.
