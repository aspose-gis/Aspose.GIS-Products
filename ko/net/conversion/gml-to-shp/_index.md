---
title: .NET 또는 C#을 사용하여 GML을 SHP GIS 데이터로 변환
weight: 120
url: /ko/net/conversion/gml-to-shp/ 
description: .NET Framework, .NET Core, C#에서 On-Premise API를 사용하여 GML을 SHP로 변환해 보세요.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C#에서 GML을 SHP로 변환" h2="ArcGIS, ArcMap, QGIS 또는 Google Earth와 같은 소프트웨어가 필요 없이 서버 측 API를 사용하여 GML을 SHP로 내보내기." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SHP" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GML" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 GML을 SHP로 변환하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 GML을 SHP로 변환하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="GML을 SHP로 저장 - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML을 SHP로 변환하는 라이브 데모" sectionDescription="저희 [라이브 데모 웹사이트](https://products.aspose.app/gis/conversion/gml-to-shp)를 방문하여 GML을 SHP로 즉시 변환해 보세요. 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose GIS API를 다운로드할 필요가 없습니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" SHP를 출력 형식으로 선택하기만 하면 됩니다." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" GML 파일을 업로드하면 즉시 SHP로 변환됩니다." >}}
...
지리적 마크업 언어(GML)는 GIS에서 사용되는 XML 기반 형식입니다. GML은 인터넷을 통한 지리적 거래를 위한 개방형 교환 형식입니다. 이 형식은 데이터 및 구조 중심입니다.

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="SHP" readMoreLink="https://docs.fileformat.com/gis/shp/" >}}

Shapefile은 다중 파일 형식(ESRI Shapefile로 알려짐)입니다. 주 파일에는 SHP 확장자가 있습니다. Shapefile은 인기 있는 벡터 지리 파일 형식입니다. Esri 제품 간의 호환성을 위해 ESRI에서 개발 및 유지 관리합니다.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/gml-to-json" name="GML TO JSON" description="JavaScript 객체 표기법" >}}
