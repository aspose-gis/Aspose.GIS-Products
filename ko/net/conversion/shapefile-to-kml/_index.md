...
{{< blocks/products/pf/upper-banner h1="C#에서 Shapefile을 KML로 변환" h2="ArcGIS, ArcMap, QGIS 또는 Google Earth와 같은 소프트웨어가 필요 없이 서버 측 API를 사용하여 Shapefile을 KML로 내보내세요." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 Shapefile을 KML로 변환하는 방법" %}}

Shapefile을 KML로 변환하려면 [Aspose.GIS for .NET](https://products.aspose.com/gis/net) API를 사용합니다. 이 API는 C# 플랫폼용으로 기능이 풍부하고 강력하며 사용하기 쉬운 GIS API입니다. 
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 Shapefile을 KML로 변환하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="C# - Shapefile을 KML로 저장" offSpacer="" %}}
...
SHP는 ESRI Shapefile의 주요 파일 형식 중 하나에 대한 파일 확장자입니다. 벡터 데이터를 사용하여 지리 공간 정보를 표현하며 GIS(지리 정보 시스템) 애플리케이션에서 사용됩니다. 이 형식은 ESRI 및 다른 소프트웨어 제품 간의 상호 운용성을 용이하게 하기 위해 공개 사양으로 개발되었습니다.

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="KML" readMoreLink="https://docs.fileformat.com/gis/kml/" >}}

KML(Keyhole Markup Language)은 XML 표기법으로 지리 공간 정보를 포함합니다. KML을 지원하는 GIS 애플리케이션에서 열 수 있습니다. 많은 응용 프로그램이 국제 표준으로 채택된 후 KML 형식에 대한 지원을 시작했습니다.
