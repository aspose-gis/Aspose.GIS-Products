...
weight: 40
url: /bg/viewer/osm-to-png
description: Конвертирайте от OSM към PNG чрез библиотека, предназначена специално за разработчици на .NET. API за рендиране на карти за Kml, GeoJson Gpx, Kml и други файлове.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs за конвертиране на OSM към PNG" h2="Конвертирайте OSM към PNG с API, проектиран специално за разработчици на .NET / C#." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="за .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Преглед за конвертиране на OSM към PNG .NET API." >}}
...
{{< blocks/products/pf/carousel-item h3="Поддържани файлови формати" description="Aspose.GIS за .NET [поддържа популярни](https://docs.aspose.com/gis/net/supported-file-formats/) файлови формати ГИС." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
      Комбинирайте няколко слоя върху единa карта. 
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Галерия уеб приложения
      ...
      <p>
        Представяме безплатни приложения, които използват .NET API за имплементиране на <a href="https://products.aspose.app/gis/viewer/osm-to-png" >"Конвертор OSM към PNG"</a> и други. Тук можете да проучите функционалността и качеството на неговата работа. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Примерен код за .NET - Конвертор OSM към PNG
    </h2>
    <p>
     Ето как да конвертирате OSM към PNG с помощта на настройки по подразбиране:
    </p>
