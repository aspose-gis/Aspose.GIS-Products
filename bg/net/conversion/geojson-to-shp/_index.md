---
title: Преобразуване на GeoJSON в SHP GIS данни чрез .NET или C#
weight: 120
url: /bg/net/conversion/geojson-to-shp/
description: Опитайте нашите On-Premise API за преобразуване на GeoJSON в SHP на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразуване на GeoJSON в SHP в C#" h2="Експортиране на GeoJSON в SHP с помощта на сървърни API, без да са необходими софтуери като ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SHP" pfName="Aspose.GIS" subTitlepfName="за .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GeoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Как да преобразувате GeoJSON в SHP с помощта на C#" %}}

За да преобразувате GeoJSON в SHP, ще използваме
...
{{% blocks/products/pf/agp/feature-section-col title="Стъпки за преобразуване на GeoJSON в SHP в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Запазване на GeoJSON като SHP - C#" offSpacer="" %}}
