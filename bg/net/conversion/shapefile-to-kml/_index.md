---
title: Преобразуване на Shapefile в KML GIS данни чрез .NET или C#
weight: 120
url: /bg/net/conversion/shapefile-to-kml/ 
description: Опитайте нашите On-Premise API за преобразуване на Shapefile в KML на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразуване на Shapefile в KML в C#" h2="Експортиране на Shapefile в KML, използвайки сървърни API, без да са необходими софтуери като ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="Как да преобразувате Shapefile в KML, използвайки C#" %}}

 За да преобразувате Shapefile в KML, ще използваме
...
{{% blocks/products/pf/agp/feature-section-col title="Стъпки за преобразуване на Shapefile в KML в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Запазване на Shapefile като KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile към KML на живо демонстрации" sectionDescription="Преобразувайте Shapefile в KML точно сега, като посетите нашия [уебсайт за живи демонстрации](https://products.aspose.app/gis/conversion/shapefile-to-kml). Живата демонстрация има следните предимства" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Качете своя Shapefile файл, той ще бъде незабавно преобразуван в KML." >}}
...
SHP е файловото разширение за един от основните типове файлове, използвани за представяне на ESRI Shapefile. Той представлява геопространствена информация под формата на векторни данни, които да се използват от приложенията Geographic Information Systems (GIS). Форматът е разработен като отворени спецификации, за да улесни оперативната съвместимост между ESRI и други софтуерни продукти.

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="KML" readMoreLink="https://docs.fileformat.com/gis/kml/" >}}

KML (Keyhole Markup Language) съдържа геопространствена информация в XML нотация. KML може да се отвори в приложения Geographic Information System (GIS), ако го поддържат. Много приложения започнаха да предоставят поддръжка за KML формат след като беше приет като международен стандарт.
