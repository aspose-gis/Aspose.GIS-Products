---
title: Конвертиране на OSM в SHP GIS данни чрез .NET или C#
weight: 120
url: /bg/net/conversion/osm-to-shp/ 
description: Опитайте нашите On-Premise API за конвертиране на OSM в SHP на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Конвертиране на OSM в SHP в C#" h2="Експортирайте OSM в SHP, използвайки сървърни API, без да са необходими софтуери като ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SHP" pfName="Aspose.GIS" subTitlepfName="за .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="OSM" >}}
...
{{% blocks/products/pf/agp/content h2="Как да конвертирате OSM в SHP, използвайки C#" %}}

 За да конвертирате OSM в SHP, ще използваме
...
{{% blocks/products/pf/agp/feature-section-col title="Стъпки за конвертиране на OSM в SHP в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Запазване на OSM като SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="OSM към SHP на живо демонстрации" sectionDescription="Конвертирайте OSM в SHP веднага, като посетите нашия [уебсайт за живи демонстрации](https://products.aspose.app/gis/conversion/osm-to-shp). Живата демонстрация има следните предимства" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Качете своя OSM файл, той ще бъде незабавно конвертиран в SHP." >}}
