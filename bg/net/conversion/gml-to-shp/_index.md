---
title: Преобразуване на GML в SHP GIS данни чрез .NET или C#
weight: 120
url: /bg/net/conversion/gml-to-shp/
description: Опитайте нашите On-Premise API за преобразуване на GML в SHP на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразуване на GML в SHP в C#" h2="Експортиране на GML в SHP с помощта на сървърни API, без да са необходими софтуери като ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SHP" pfName="Aspose.GIS" subTitlepfName="за .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GML" >}}
...
{{% blocks/products/pf/agp/content h2="Как да преобразувате GML в SHP с помощта на C#" %}}

За да конвертирате GML в SHP, ще използваме
...
{{% blocks/products/pf/agp/feature-section-col title="Стъпки за преобразуване на GML в SHP в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Запазване на GML като SHP - C#" offSpacer="" %}}
