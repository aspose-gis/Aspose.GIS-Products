...
{{% blocks/products/pf/agp/content h2="Как да преобразувате TopoJSON в KML, използвайки C#" %}}

За да преобразувате TopoJSON в KML, ще използваме
...
{{% blocks/products/pf/agp/feature-section-col title="Стъпки за преобразуване на TopoJSON в KML в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Запазване на TopoJSON като KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON към KML на живо демонстрации" sectionDescription="Преобразувайте TopoJSON в KML веднага, като посетите нашия [уебсайт за живи демонстрации](https://products.aspose.app/gis/conversion/topojson-to-kml). Живата демонстрация има следните предимства" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Качете своя TopoJSON файл, той ще бъде незабавно преобразуван в KML." >}}
...
KML (Keyhole Markup Language) съдържа геопространствена информация в XML нотация. KML може да бъде отворен в Географски информационни системи (GIS), ако те го поддържат. Много приложения са започнали да поддържат KML формат след като е приет като международен стандарт.
