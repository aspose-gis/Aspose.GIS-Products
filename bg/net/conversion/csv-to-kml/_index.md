---
title: Преобразуване на CSV в KML GIS данни чрез .NET или C#
weight: 120
url: /bg/net/conversion/csv-to-kml/ 
description: Опитайте нашите On-Premise API за преобразуване на CSV в KML на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразуване на CSV в KML в C#" h2="Експортиране на CSV в KML, използвайки сървърни API, без да са необходими софтуери като ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="за .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Как да преобразувате CSV в KML, използвайки C#" %}}

 За да преобразувате CSV в KML, ще използваме
...
{{% blocks/products/pf/agp/feature-section-col title="Стъпки за преобразуване на CSV в KML в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Запазване на CSV като KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV към KML на живо демонстрации" sectionDescription="Преобразувайте CSV в KML веднага, като посетите нашия [уебсайт за живи демонстрации](https://products.aspose.app/gis/conversion/csv-to-kml). Живата демонстрация има следните предимства" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Качете своя CSV файл, той ще бъде незабавно преобразуван в KML." >}}
...
KML (Keyhole Markup Language) съдържа геопространствена информация в XML нотация. KML може да се отвори в Географски информационни системи (GIS) приложения, ако те го поддържат. Много приложения започнаха да предоставят поддръжка за KML формат след като той беше приет като международен стандарт.
