---
title: Преобразуване на CSV в GIS данни SHP чрез .NET или C#
weight: 120
url: /bg/net/conversion/csv-to-shp/ 
description: Опитайте нашите On-Premise API за преобразуване на CSV в SHP на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразуване на CSV в SHP в C#" h2="Експортиране на CSV в SHP с помощта на сървърни API, без да са необходими софтуери като ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SHP" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Как да преобразувате CSV в SHP с помощта на C#" %}}

 За да преобразувате CSV в SHP, ще използваме
...
{{% blocks/products/pf/agp/feature-section-col title="Стъпки за преобразуване на CSV в SHP в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Запазване на CSV като SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV към SHP на живо демонстрации" sectionDescription="Преобразувайте CSV в SHP точно сега, като посетите нашия [уебсайт за живи демонстрации](https://products.aspose.app/gis/conversion/csv-to-shp). Живата демонстрация има следните предимства" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Качете своя CSV файл, той ще бъде незабавно преобразуван в SHP." >}}
...
{{< blocks/products/pf/agp/other-supported-section title="Други поддържани преобразувания" subTitle="Можете също да конвертирате CSV в много други файлови формати, включително няколко, изброени по-долу." >}}
