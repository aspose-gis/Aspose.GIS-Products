---
title: Преобразуване на GPX в Shapefile GIS данни чрез .NET или C#
weight: 120
url: /bg/net/conversion/gpx-to-shapefile/
description: Опитайте нашите On-Premise API за преобразуване на GPX в Shapefile на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразуване на GPX в Shapefile в C#" h2="Експортиране на GPX в Shapefile с помощта на сървърни API, без да са необходими софтуери като ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Shapefile" pfName="Aspose.GIS" subTitlepfName="за .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GPX" >}}
...
{{% blocks/products/pf/agp/content h2="Как да преобразувате GPX в Shapefile с помощта на C#" %}}

За да преобразувате GPX в Shapefile, ще използваме
...
{{% blocks/products/pf/agp/feature-section-col title="Стъпки за преобразуване на GPX в Shapefile в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Запазване на GPX като Shapefile - C#" offSpacer="" %}}
