---
title: Преобразуване на TopoJSON в Shapefile GIS данни чрез .NET или C#
weight: 120
url: /bg/net/conversion/topojson-to-shapefile/
description: Опитайте нашите On-Premise API за преобразуване на TopoJSON в Shapefile на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразуване на TopoJSON в Shapefile в C#" h2="Експортиране на TopoJSON в Shapefile с помощта на сървърни API, без да са необходими софтуери като ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Shapefile" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TopoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Как да преобразувате TopoJSON в Shapefile с помощта на C#" %}}

За да преобразувате TopoJSON в Shapefile, ще използваме
...
{{% blocks/products/pf/agp/feature-section-col title="Стъпки за преобразуване на TopoJSON в Shapefile в C#" %}}
...
1.  Стрингов тип път към изходния TopоJSON файл
...
{{% blocks/products/pf/agp/code-block title="Запазване на TopoJSON като Shapefile - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON към Shapefile на живо демонстрации" sectionDescription="Преобразувайте TopoJSON в Shapefile точно сега, като посетите нашия [уебсайт за живи демонстрации](https://products.aspose.app/gis/conversion/topojson-to-shapefile). Живата демонстрация има следните предимства" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Качете своя TopoJSON файл, той ще бъде незабавно преобразуван в Shapefile." >}}
...
{{< blocks/products/pf/agp/other-supported-section title="Други поддържани преобразувания" subTitle="Можете също да преобразувате TopoJSON в много други файлови формати, включително няколко, изброени по-долу." >}}
