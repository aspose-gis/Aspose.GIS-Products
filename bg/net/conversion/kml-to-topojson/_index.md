---
title: Преобразуване на KML в TopoJSON GIS данни чрез .NET или C#
weight: 120
url: /bg/net/conversion/kml-to-topojson/ 
description: Опитайте нашите On-Premise API за преобразуване на KML в TopoJSON на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразуване на KML в TopoJSON в C#" h2="Експортиране на KML в TopoJSON с помощта на сървърни API, без да са необходими софтуери като ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TopoJSON" pfName="Aspose.GIS" subTitlepfName="за .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="Как да преобразувате KML в TopoJSON с помощта на C#" %}}

 За да преобразувате KML в TopoJSON, ще използваме
...
{{% blocks/products/pf/agp/feature-section-col title="Стъпки за преобразуване на KML в TopoJSON в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Запазване на KML като TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML към TopoJSON на живо демонстрации" sectionDescription="Преобразувайте KML в TopoJSON веднага, като посетите нашия [уебсайт за живи демонстрации](https://products.aspose.app/gis/conversion/kml-to-topojson). Живата демонстрация има следните предимства" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Качете своя KML файл, той ще бъде незабавно преобразуван в TopoJSON." >}}
...
KML (Keyhole Markup Language) съдържа геопространствена информация в XML нотация. KML може да бъде отворен в приложения за Географски Информационни Системи (GIS), ако те го поддържат. Много приложения са започнали да предоставят поддръжка за формата KML, след като той е приет като международен стандарт.

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="TopoJSON" readMoreLink="https://docs.fileformat.com/gis/geojson/" >}}

TopoJSON е разширение на GeoJSON, което кодира топология. Формат, базиран на JSON, предназначен за представяне на географски обекти с техните не-пространствени атрибути. Този формат определя различни JSON (JavaScript Object Notation) обекти и начина им на свързване. JSON форматът представлява колективна информация за Географските обекти, техните пространствени граници и свойства.
