---
title: Конвертиране във Световна Географска Референтна Система (GeoRef) - APIs за .NET
weight: 40
url: /bg/coordinates/convert-to-georef
...
<p>
 Aspose.GIS за .NET ви позволява да конвертирате Световна Географска Референтна Система (GeoRef) за геопространствени единици. Нашата библиотека ви позволява лесно и бързо да конвертирате географна ширина и дължина в желания формат на единица. Също така нашата библиотека съдържа възможност за извличане на местоположения до точка от текст.
</p>

<p>
 Aspose.GIS за .NET е проектиран с мисъл за простота, производителност, използваемост и преносимост. Той съдържа APIs за използване с платформи .NET Framework &amp; .NET Core, което ви позволява да изграждате крос-платформени приложения с голяма лекота.
</p>
...
{{< blocks/products/pf/carousel-item h3="С един поглед" description="Преглед на API за конвертиране на координати .NET / C#." >}}
...
{{< blocks/products/pf/carousel-item h3="Поддържани файлови формати" description="Aspose.GIS за .NET [поддържа популярни GIS](https://docs.aspose.com/gis/net/coordinates/)  единици на координати." >}}
 ...
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    ...
    <li><b>Референтна Географска Система: </b>GeoRef</li>
    <li><b>Национална Мрежова Система на САЩ: </b>USNG</li>
   </ul>
  </div>
  <!--/right-->
 </div>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Функции на API - Конвертиране в GeoRef
   </h2>
   <p>
   </p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Конвертиране на географна ширина и дължина в единици, базирани на градуси      
    </p>
   </div>
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Парсване на позиция на координати от текст 
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Поддръжка на Национална Мрежова Система на САЩ (USNG) Формат
    </p>
   </div>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Галерия уеб приложения
      ...
      <p>
        Представяме безплатни приложения, които използват .NET API за имплементиране на <a href="https://products.aspose.app/gis/coordinates/convert-to-georef" >"Конвертиране във GeoRef"</a> и други. Тук можете да проучите функционалността и качеството на неговата работа. 
      </p>

      <div class="row">
        <div class="col-md-4">{{< figure src="convert-to-dms.png" link="https://products.aspose.app/gis/coordinates/convert-to-dms" title="Конвертиране в DMS" alt="Конвертиране в DMS" class="img-fluid" width="100%" >}} </div>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Примерен код за .NET - Конвертиране във GeoRef 
    </h2>
    <p>
     Ето как да конвертирате координати на единица в формат GoeRef, използвайки настройки по подразбиране:
    </p>
