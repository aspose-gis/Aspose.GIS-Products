...
description: قم بتطوير عارض OSM باستخدام مكتبة مصممة خصيصًا لمطوري .NET. واجهات برمجة تطبيقات لرسم الخرائط لأنواع ملفات Kml و GeoJson Gpx و Kml وغيرها.
---

{{< blocks/products/pf/main-wrap-class />}}
{{< blocks/products/pf/upper-banner h1=".NET APIs لعرض OSM" h2="قم بتطوير عارض OSM باستخدام واجهة برمجة تطبيقات مصممة خصيصًا لمطوري .NET / C#." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 يمكّنك Aspose.GIS for .NET من إنشاء عارض OSM لبيانات جغرافية متجهة ونقطية. البيانات تكون مفيدة فقط عندما يتمكن شخص ما من رؤيتها. تجعل مكتبة .NET GIS من السهل والسريع تصدير بيانات GIS إلى صور متجهة أو نقطية وتوفر رموزًا غنية لمشاهدات معقدة.
</p>
...
{{< blocks/products/pf/carousel-item h3="عارض الخرائط" description="نظرة عامة على واجهة برمجة تطبيقات OSM Viewer .NET." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     معرض تطبيقات الويب
      ...
      <p>
        نقدم تطبيقات مجانية تستخدم .NET API لتنفيذ <a href="https://products.aspose.app/gis/viewer/osm" >"OSM Viewer"</a> وغيرها. هنا يمكنك استكشاف وظائفها وجودتها.
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     مثال لـ .NET - OSM Viewer
    </h2>
    <p>
     إليك كيفية عرض خريطة من تنسيق OSM باستخدام الإعدادات الافتراضية:
    </p>
