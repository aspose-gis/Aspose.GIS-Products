...
{{% blocks/products/pf/agp/content h2="كيفية تحويل GeoJSON إلى CSV باستخدام C#" %}}

 من أجل تحويل GeoJSON إلى CSV، سنستخدم
...
{{% blocks/products/pf/agp/code-block title="حفظ GeoJSON كـ CSV - C#" offSpacer="" %}}
