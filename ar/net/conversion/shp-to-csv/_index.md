...
{{% blocks/products/pf/agp/content h2="كيفية تحويل SHP إلى CSV باستخدام C#" %}}

 من أجل تحويل SHP إلى CSV، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لتحويل SHP إلى CSV في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="حفظ SHP كـ CSV - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SHP إلى CSV عروض توضيحية مباشرة" sectionDescription="تحويل SHP إلى CSV الآن من خلال زيارة [موقع العروض التوضيحية المباشرة](https://products.aspose.app/gis/conversion/shp-to-csv). تتمتع العروض التوضيحية المباشرة بالفوائد التالية" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" قم بتحميل ملف SHP الخاص بك، وسيتم تحويله على الفور إلى CSV." >}}
 ...
 Shapefile هو تنسيق متعدد الملفات (يُعرف باسم ESRI Shapefile). الرئيسي منها له امتداد SHP. Shapefile هو تنسيق ملف جغرافى متجه شائع. تم تطويره وصيانته بواسطة ESRI للتوافق بين منتجات Esri والبرامج الأخرى.
