---
title: تحويل ملف Shapefile إلى بيانات TopoJSON GIS باستخدام .NET أو C#
weight: 120
url: /ar/net/conversion/shapefile-to-topojson/
description: جرّب واجهات برمجة التطبيقات (APIs) الخاصة بنا لتشغيل عمليات التحويل من Shapefile إلى TopoJSON على .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="تحويل ملف Shapefile إلى TopoJSON في C#" h2="تصدير Shapefile إلى TopoJSON باستخدام واجهات برمجة تطبيقات (APIs) من جانب الخادم، دون الحاجة إلى برامج مثل ArcGIS أو ArcMap أو QGIS أو Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TopoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل ملف Shapefile إلى TopoJSON باستخدام C#" %}}

 من أجل تحويل ملف Shapefile إلى TopoJSON، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لتحويل ملف Shapefile إلى TopoJSON في C#" %}}
...
1.  مسار ملف سلسلة إلى ملف Shapefile المصدر
...
{{% blocks/products/pf/agp/code-block title="حفظ Shapefile كـ TopoJSON - C#" offSpacer="" %}}
