...
{{% blocks/products/pf/agp/content h2="كيفية تحويل KML إلى SHP باستخدام C#" %}}

 من أجل تحويل KML إلى SHP، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لتحويل KML إلى SHP في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="حفظ KML كـ SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="العروض التوضيحية المباشرة لتحويل KML إلى SHP" sectionDescription="حوّل KML إلى SHP الآن من خلال زيارة [موقع العروض التوضيحية المباشرة](https://products.aspose.app/gis/conversion/kml-to-shp). تمت�� النسخة التجريبية المباشرة بالفوائد التالية" >}}
 ...
 يحتوي KML (Keyhole Markup Language) على معلومات جغرافية في تدوين XML. يمكن فتح KML في تطبيقات نظم المعلومات الجغرافية (GIS) بشرط أن تدعمها. بدأت العديد من التطبيقات في توفير الدعم لتنسيق KML بعد اعتماده كمعيار دولي.

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="SHP" readMoreLink="https://docs.fileformat.com/gis/shp/" >}}

 Shapefile هو تنسيق متعدد الملفات (يُعرف باسم ESRI Shapefile). الرئيسية منها لها امتداد SHP. Shapefile هو تنسيق ملف جغرافى متجه شائع. تم تطويره وصيانته بواسطة ESRI للتوافق بين منتجات Esri والبرامج الأخرى.
