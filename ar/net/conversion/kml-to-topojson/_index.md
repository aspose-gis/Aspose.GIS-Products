...
weight: 120
url: /ar/net/conversion/kml-to-topojson/ 
description: جرّب واجهات برمجة التطبيقات (APIs) الخاصة بنا لتنفيذ التحويل من KML إلى TopoJSON على .NET Framework, .NET Core, C#.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert KML to TopoJSON Using C#" %}}
 ...
 من أجل تحويل KML إلى TopoJSON، سنستخدم
...
2.  السائق المصدر لإعلام واجهة برمجة التطبيقات بتنسيق الإدخال. اضبطه على Drivers.Kml
