...
weight: 120
url: /ar/net/conversion/gpx-to-geojson/ 
description: جرّب واجهات برمجة التطبيقات (APIs) الخاصة بنا المحلية لتحويل GPX إلى GeoJSON على .NET Framework، و.NET Core، وC#.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert GPX to GeoJSON Using C#" %}}
 ...
 من أجل تحويل GPX إلى GeoJSON، سنستخدم
...
يمثل امتداد GPX تنسيق تبادل GPS للتبادل بين تطبيقات وخدمات الويب على الإنترنت. إنه تنسيق XML خفيف الوزن يحتوي على بيانات GPS، أي نقاط الطريق والمسارات والتسجيلات ليتم استيرادها وقراءتها بواسطة برامج متعددة. GPX مفتوح ومدعوم من قبل مجموعة متنوعة من التطبيقات وأجهزة GPS.
