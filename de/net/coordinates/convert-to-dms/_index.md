---
title: Konvertieren in Grad Minuten Sekunden (DMS) - APIs für .NET
weight: 40
url: /de/net/coordinates/convert-to-dms
 ...
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    ...
    <li><b>Grad Dezimalminuten: </b>DDM</li>    
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    API-Funktionen - Konvertieren in DMS
   </h2>
   <p>
   </p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Web Apps Galerie
      ...
      <p>
        Wir präsentieren kostenlose Anwendungen, die die .NET API implementieren <a href="https://products.aspose.app/gis/coordinates/convert-to-dms" >"Konvertieren in DMS"</a> und andere. Hier können Sie die Funktionalität und Qualität ihrer Arbeit erkunden. 
      </p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Beispiel für .NET - Konvertieren in DMS 
    </h2>
    <p>
