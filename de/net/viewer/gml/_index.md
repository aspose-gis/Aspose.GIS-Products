...
weight: 40
url: /de/viewer/gml
description: Entwickeln Sie einen GML-Viewer mit einer Bibliothek, die speziell für .NET-Entwickler entwickelt wurde. Map Rendering APIs für Kml, GeoJson Gpx, Kml und andere Dateien.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs für GML Viewer" h2="Entwickeln Sie einen GML-Viewer mit einer API, die speziell für .NET / C# Entwickler entwickelt wurde." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="für .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Eine Übersicht über die GML Viewer .NET API." >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Verwenden Sie erweiterte Rendering: Kombinieren Sie Symbolisierer, Geometrie Generator, Mixed Geometry.
    </p>
   </div>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Web Apps Galerie
      ...
      <p>
        Wir präsentieren kostenlose Anwendungen, die die .NET API zur Implementierung eines <a href="https://products.aspose.app/gis/viewer/gml" >"GML Viewer"</a> und anderer verwenden. Hier können Sie die Funktionalität und Qualität seiner Arbeit erkunden. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Beispiel für .NET - GML Viewer
    </h2>
    <p>
     Hier erfahren Sie, wie eine Karte aus einem GML-Format mit den Standardeinstellungen gerendert wird:
    </p>
