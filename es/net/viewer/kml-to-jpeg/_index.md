...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Una descripción general para convertir KML a JPEG API .NET." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galería de aplicaciones web
      ...
      <p>
        Presentamos aplicaciones gratuitas que utilizan la API .NET para implementar el <a href="https://products.aspose.app/gis/viewer/kml-to-jpeg" >"Convertidor KML a JPEG"</a> y otras. Aquí puede explorar la funcionalidad y la calidad de su trabajo. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Muestra para .NET - Convertidor KML a JPEG
    </h2>
    <p>
     Aquí se muestra cómo convertir KML a JPEG utilizando la configuración predeterminada:
    </p>
