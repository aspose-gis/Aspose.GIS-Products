...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Una descripción general para convertir SHP a JPEG API .NET." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galería de aplicaciones web
      ...
      <p>
        Presentamos aplicaciones gratuitas que utilizan la API .NET para implementar el <a href="https://products.aspose.app/gis/viewer/shp-to-jpeg" >"Convertidor SHP a JPEG"</a> y otras. Aquí puede explorar la funcionalidad y la calidad de su trabajo. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Muestra para .NET - Convertidor SHP a JPEG
    </h2>
    <p>
     Aquí se muestra cómo convertir SHP a JPEG utilizando la configuración predeterminada:
    </p>
