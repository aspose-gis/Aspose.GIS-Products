...
{{% blocks/products/pf/agp/content h2="Cómo convertir TopoJSON a GeoJSON usando C#" %}}

Para convertir TopoJSON a GeoJSON, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir TopoJSON a GeoJSON en C#" %}}
...
1.  Un tipo de cadena de ruta de archivo para el archivo TopoJSON fuente
...
{{% blocks/products/pf/agp/code-block title="Guardar TopoJSON como GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo en vivo de TopoJSON a GeoJSON" sectionDescription="Convierta TopoJSON a GeoJSON ahora mismo visitando nuestro [sitio web de demostraciones en vivo](https://products.aspose.app/gis/conversion/topojson-to-geojson). La demo en vivo tiene los siguientes beneficios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Cargue su archivo TopoJSON, se convertirá instantáneamente a GeoJSON." >}}
...
GeoJSON es un formato basado en JSON diseñado para representar las características geográficas con sus atributos no espaciales. Este formato define diferentes objetos JSON (Notación de Objetos JavaScript) y su forma de unión. El JSON representa información colectiva sobre las características geográficas, sus extensiones espaciales y propiedades.
