...
{{% blocks/products/pf/agp/content h2="Cómo convertir KML a TopoJSON usando C#" %}}

Para convertir KML a TopoJSON, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir KML a TopoJSON en C#" %}}
...
3.  El tipo de cadena de ruta de archivo para los datos TopoJSON de destino
...
{{% blocks/products/pf/agp/code-block title="Guardar KML como TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML a TopoJSON Live Demos" sectionDescription="Convierta KML a TopoJSON ahora mismo visitando nuestro [sitio web de demostraciones en vivo](https://products.aspose.app/gis/conversion/kml-to-topojson). La demostración en vivo tiene los siguientes beneficios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Cargue su archivo KML, se convertirá instantáneamente a TopoJSON." >}}
