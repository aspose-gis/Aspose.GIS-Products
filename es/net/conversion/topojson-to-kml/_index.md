...
{{% blocks/products/pf/agp/content h2="Cómo convertir TopoJSON a KML usando C#" %}}

Para convertir TopoJSON a KML, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir TopoJSON a KML en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Guardar TopoJSON como KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demos en vivo de TopoJSON a KML" sectionDescription="Convierta TopoJSON a KML ahora mismo visitando nuestro [sitio web de demos en vivo](https://products.aspose.app/gis/conversion/topojson-to-kml). La demo en vivo tiene los siguientes beneficios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Cargue su archivo TopoJSON, se convertirá instantáneamente a KML." >}}
...
KML (Keyhole Markup Language) contiene información geoespacial en notación XML. KML se puede abrir en aplicaciones de Sistemas de Información Geográfica (GIS) siempre que las admitan. Muchas aplicaciones han comenzado a admitir el formato KML después de que se adoptó como estándar internacional.
