---
title: Convertir GML a GIS Data GDB vía .NET
weight: 290
url: /es/net/conversion/gml-to-gdb/
...
{{% blocks/products/pf/agp/content h2="Cómo convertir GML a GDB usando C#" %}}

Para convertir GML a GDB, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir GML a GDB en C#" %}}
...
3.  La ruta de archivo de tipo string al archivo de datos GDB de destino
...
{{% blocks/products/pf/agp/code-block title="Guardar GML como GDB - C#" offSpacer="" %}}
