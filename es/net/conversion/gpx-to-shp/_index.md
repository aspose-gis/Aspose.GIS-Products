...
{{% blocks/products/pf/agp/content h2="Cómo convertir GPX a SHP usando C#" %}}

Para convertir GPX a SHP, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir GPX a SHP en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Guardar GPX como SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de GPX a SHP" sectionDescription="Convierta GPX a SHP ahora mismo visitando nuestro [sitio web de demostraciones en vivo](https://products.aspose.app/gis/conversion/gpx-to-shp). La demostración en vivo tiene los siguientes beneficios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Cargue su archivo GPX, se convertirá instantáneamente a SHP." >}}
...
Shapefile es un formato de archivo múltiple (conocido como Shapefile ESRI). El principal tiene la extensión SHP. Shapefile es un formato de archivo geográfico vectorial popular. Desarrollado y mantenido por ESRI para la compatibilidad entre los productos Esri y otros programas.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/gpx-to-shapefile" name="GPX A Shapefile" description="ESRI Shapefile" >}}
