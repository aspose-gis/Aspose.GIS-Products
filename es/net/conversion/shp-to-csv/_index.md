...
{{% blocks/products/pf/agp/content h2="Cómo convertir SHP a CSV usando C#" %}}

Para convertir SHP a CSV, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir SHP a CSV en C#" %}}
...
1.  Una ruta de archivo de tipo cadena a la fuente SHP
...
{{% blocks/products/pf/agp/code-block title="Guardar SHP como CSV - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SHP a CSV Demostraciones en vivo" sectionDescription="Convierta SHP a CSV ahora mismo visitando nuestro [sitio web de demostraciones en vivo](https://products.aspose.app/gis/conversion/shp-to-csv). La demostración en vivo tiene los siguientes beneficios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Cargue su archivo SHP, se convertirá instantáneamente a CSV." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/shp-to-kml" name="SHP A KML" description="Lenguaje de Marcado de Claves" >}}
