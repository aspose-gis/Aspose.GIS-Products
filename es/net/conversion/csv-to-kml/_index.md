...
{{% blocks/products/pf/agp/content h2="Cómo convertir CSV a KML usando C#" %}}

Para convertir CSV a KML, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir CSV a KML en C#" %}}
...
1.  Una ruta de archivo de tipo string al archivo CSV fuente
...
{{% blocks/products/pf/agp/code-block title="Guardar CSV como KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV a KML Live Demos" sectionDescription="Convierta CSV a KML ahora mismo visitando nuestro [sitio web de Live Demos](https://products.aspose.app/gis/conversion/csv-to-kml). La demostración en vivo tiene los siguientes beneficios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Suba su archivo CSV, se convertirá instantáneamente a KML." >}}
