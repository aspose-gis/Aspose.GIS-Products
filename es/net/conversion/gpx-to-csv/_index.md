...
{{% blocks/products/pf/agp/content h2="Cómo convertir GPX a CSV usando C#" %}}

Para convertir GPX a CSV, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir GPX a CSV en C#" %}}

{{% blocks/products/pf/agp/text %}}

La conversión se puede realizar con una sola línea de código al usar el
método *VectorLayer.Convert* 
...
3.  La ruta de archivo de tipo cadena para el archivo de datos CSV de destino
...
{{% blocks/products/pf/agp/code-block title="Guardar GPX como CSV - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GPX a CSV Live Demos" sectionDescription="Convierta GPX a CSV ahora mismo visitando nuestro [sitio web de demostraciones en vivo](https://products.aspose.app/gis/conversion/gpx-to-csv). La demostración en vivo tiene los siguientes beneficios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Cargue su archivo GPX, se convertirá instantáneamente a CSV." >}}
