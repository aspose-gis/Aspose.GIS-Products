...
{{% blocks/products/pf/agp/content h2="Cómo convertir CSV a GeoJSON usando C#" %}}

Para convertir CSV a GeoJSON, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir CSV a GeoJSON en C#" %}}
...
3.  La ruta de archivo de tipo string al archivo de datos GeoJSON de destino
...
{{% blocks/products/pf/agp/code-block title="Guardar CSV como GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV a GeoJSON Live Demos" sectionDescription="Convierta CSV a GeoJSON ahora mismo visitando nuestro [sitio web de Live Demos](https://products.aspose.app/gis/conversion/csv-to-geojson). La demostración en vivo tiene los siguientes beneficios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Cargue su archivo CSV, se convertirá instantáneamente a GeoJSON." >}}
