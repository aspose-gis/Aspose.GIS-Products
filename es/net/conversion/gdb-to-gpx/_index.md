...
{{% blocks/products/pf/agp/content h2="Cómo convertir GDB a GPX usando C#" %}}

Para convertir GDB a GPX, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir GDB a GPX en C#" %}}
...
3.  La ruta de archivo de tipo cadena para el archivo de datos GPX de destino
...
{{% blocks/products/pf/agp/code-block title="Guardar GDB como GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GDB a GPX Live Demos" sectionDescription="Convierta GDB a GPX ahora mismo visitando nuestro [sitio web de demostraciones en vivo](https://products.aspose.app/gis/conversion/gdb-to-gpx). La demostración en vivo tiene los siguientes beneficios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Cargue su archivo GDB, se convertirá instantáneamente a GPX." >}}
