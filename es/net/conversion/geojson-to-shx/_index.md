...
{{% blocks/products/pf/agp/content h2="Cómo convertir GEOJSON a SHX usando C#" %}}

 Para convertir GEOJSON a SHX, utilizaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir GEOJSON a SHX en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Guardar GEOJSON como SHX - C#" offSpacer="" %}}

```cs
// Convertir datos GIS GEOJSON a datos SHX
...
{{< blocks/products/pf/agp/demobox sectionTitle="GEOJSON a SHX Live Demos" sectionDescription="Convierta GEOJSON a SHX ahora mismo visitando nuestro [sitio web de demostraciones en vivo](https://products.aspose.app/gis/conversion/geojson-to-shx). La demostración en vivo tiene los siguientes beneficios" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Suba su archivo GEOJSON, se convertirá instantáneamente a SHX." >}}
...
Formato de índice de forma, un índice posicional de la geometría de la característica para permitir la búsqueda hacia adelante y hacia atrás rápidamente
Leer Más
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/geojson-to-json" name="GEOJSON TO JSON" description="Notación de Objetos JavaScript" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/geojson-to-kml" name="GEOJSON TO KML" description="Lenguaje de Marcado Clave" >}}
