---
title: Convert GEOJSON to KML GIS Data via .NET 
weight: 40
...
{{% blocks/products/pf/agp/content h2="How to Convert GEOJSON to KML Using C#" %}}
 ...
 In order to convert GEOJSON to KML, weвЂ™ll use
...
VectorLayer.Convert(dir + "example.geojson", Drivers.GeoJson, dir + "output.kml", Drivers.Kml);
