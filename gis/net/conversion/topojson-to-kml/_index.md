---
title: Convert TOPOJSON to KML GIS Data via .NET 
weight: 270
...
{{% blocks/products/pf/agp/content h2="How to Convert TOPOJSON to KML Using C#" %}}

 In order to convert TOPOJSON to KML, weвЂ™ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for converting TOPOJSON to KML in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Save TOPOJSON as KML - C#" offSpacer="" %}}

```cs
// Convert TOPOJSON GIS data to KML data
VectorLayer.Convert(dir + "example.topojson", Drivers.TopoJson, dir + "output.kml", Drivers.Kml);
...
{{< blocks/products/pf/agp/demobox sectionTitle="TOPOJSON to KML Live Demos" sectionDescription="Convert TOPOJSON to KML right now by visiting our [Live Demos website](https://products.aspose.app/gis/conversion/topojson-to-kml). The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload your TOPOJSON file, it will be converted instantly to KML." >}}
