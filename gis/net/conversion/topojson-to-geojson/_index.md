---
title: Convert TOPOJSON to GEOJSON GIS Data via .NET 
weight: 30
...
{{< blocks/products/pf/upper-banner h1="Convert TOPOJSON to GEOJSON in C#" h2="Export TOPOJSON to GEOJSON using server side APIs, without needing softwares like ArcGIS, ArcMap, QGIS or Google Earth." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/gis/272x272/aspose_gis-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="GEOJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TOPOJSON" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert TOPOJSON to GEOJSON Using C#" %}}

 In order to convert TOPOJSON to GEOJSON, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for converting TOPOJSON to GEOJSON in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Save TOPOJSON as GEOJSON - C#" offSpacer="" %}}

```cs
// Convert TOPOJSON GIS data to GEOJSON data
VectorLayer.Convert(dir + "example.topojson", Drivers.TopoJson, dir + "output.geojson", Drivers.GeoJson);
...
{{< blocks/products/pf/agp/demobox sectionTitle="TOPOJSON to GEOJSON Live Demos" sectionDescription="Convert TOPOJSON to GEOJSON right now by visiting our [Live Demos website](https://products.aspose.app/gis/conversion/topojson-to-geojson). The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload your TOPOJSON file, it will be converted instantly to GEOJSON." >}}
