---
title: Convert JSON to KML GIS Data via .NET 
weight: 190
...
{{% blocks/products/pf/agp/content h2="How to Convert JSON to KML Using C#" %}}

 In order to convert JSON to KML, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for converting JSON to KML in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Save JSON as KML - C#" offSpacer="" %}}

```cs
// Convert JSON GIS data to KML data
VectorLayer.Convert(dir + "example.json", Drivers.TopoJson, dir + "output.kml", Drivers.Kml);
...
{{< blocks/products/pf/agp/demobox sectionTitle="JSON to KML Live Demos" sectionDescription="Convert JSON to KML right now by visiting our [Live Demos website](https://products.aspose.app/gis/conversion/json-to-kml). The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload your JSON file, it will be converted instantly to KML." >}}
