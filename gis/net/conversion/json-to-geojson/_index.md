---
title: Convert JSON to GEOJSON GIS Data via .NET 
weight: 180
...
{{< blocks/products/pf/upper-banner h1="Convert JSON to GEOJSON in C#" h2="Export JSON to GEOJSON using server side APIs, without needing softwares like ArcGIS, ArcMap, QGIS or Google Earth." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/gis/272x272/aspose_gis-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="GEOJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert JSON to GEOJSON Using C#" %}}

 In order to convert JSON to GEOJSON, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for converting JSON to GEOJSON in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Save JSON as GEOJSON - C#" offSpacer="" %}}

```cs
// Convert JSON GIS data to GEOJSON data
VectorLayer.Convert(dir + "example.json", Drivers.TopoJson, dir + "output.geojson", Drivers.GeoJson);
...
{{< blocks/products/pf/agp/demobox sectionTitle="JSON to GEOJSON Live Demos" sectionDescription="Convert JSON to GEOJSON right now by visiting our [Live Demos website](https://products.aspose.app/gis/conversion/json-to-geojson). The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload your JSON file, it will be converted instantly to GEOJSON." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/json-to-shx" name="JSON TO SHX" description="Shapefile File Extension" >}}
