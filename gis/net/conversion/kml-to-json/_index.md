---
title: Convert KML to JSON GIS Data via .NET 
weight: 100
...
{{< blocks/products/pf/upper-banner h1="Convert KML to JSON in C#" h2="Export KML to JSON using server side APIs, without needing softwares like ArcGIS, ArcMap, QGIS or Google Earth." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/gis/272x272/aspose_gis-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert KML to JSON Using C#" %}}

 In order to convert KML to JSON, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for converting KML to JSON in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Save KML as JSON - C#" offSpacer="" %}}

```cs
// Convert KML GIS data to JSON data
VectorLayer.Convert(dir + "example.kml", Drivers.Kml, dir + "output.json", Drivers.TopoJson);
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML to JSON Live Demos" sectionDescription="Convert KML to JSON right now by visiting our [Live Demos website](https://products.aspose.app/gis/conversion/kml-to-json). The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload your KML file, it will be converted instantly to JSON." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/kml-to-geojson" name="KML TO GEOJSON" description="JSON Based Format" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/kml-to-shx" name="KML TO SHX" description="Shapefile File Extension" >}}
