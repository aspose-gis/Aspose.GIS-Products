...
# Please note there can be unsupported conversion pairs
    ...
    <ul>
     <li>Shapefile to GeoPackage</li>
     <li>GeoJSON to GeoPackage</li>
     <li>KML to Shapefile</li>
     <li>GeoPackage to GeoJSON</li>
     <li>File Geodatabase to GeoPackage</li>
     <li>GPX to GeoPackage</li>
     <li>MapInfo TAB to GeoPackage</li>
    </ul>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
