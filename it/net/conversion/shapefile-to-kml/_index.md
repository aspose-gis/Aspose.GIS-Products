...
{{% blocks/products/pf/agp/content h2="Come convertire Shapefile in KML usando C#" %}}

Per convertire Shapefile in KML, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione di Shapefile in KML in C#" %}}
...
3.  Il percorso del file stringa al file dei dati KML di destinazione
...
{{% blocks/products/pf/agp/code-block title="Salva Shapefile come KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile to KML Live Demos" sectionDescription="Converti Shapefile in KML subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/shapefile-to-kml). La demo dal vivo ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file Shapefile, verrà convertito istantaneamente in KML." >}}
...
SHP è l'estensione del file per uno dei tipi di file principali utilizzati per la rappresentazione di ESRI Shapefile. Rappresenta informazioni geospaziali sotto forma di dati vettoriali da utilizzare con le applicazioni GIS (Geographic Information Systems). Il formato è stato sviluppato come specifiche aperte al fine di facilitare l'interoperabilità tra ESRI e altri prodotti software.
