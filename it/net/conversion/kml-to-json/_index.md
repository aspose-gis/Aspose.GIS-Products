...
{{% blocks/products/pf/agp/content h2="Come convertire KML in GeoJSON usando C#" %}}

Per convertire KML in GeoJSON, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da KML a GeoJSON in C#" %}}
...
3.  Il percorso file di tipo stringa per il file dei dati GeoJSON di destinazione
...
{{% blocks/products/pf/agp/code-block title="Salva KML come GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da KML a GeoJSON" sectionDescription="Converti KML in GeoJSON subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/kml-to-json). La demo live ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file KML, verrà convertito istantaneamente in GeoJSON." >}}
...
KML (Keyhole Markup Language) contiene informazioni geospaziali in notazione XML. KML può essere aperto in applicazioni di sistemi geografici (GIS) purché le supportino. Molte applicazioni hanno iniziato a fornire supporto per il formato KML dopo che è stato adottato come standard internazionale.
