...
{{% blocks/products/pf/agp/content h2="Come convertire GeoJSON in KML usando C#" %}}

Per convertire GeoJSON in KML, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da GeoJSON a KML in C#" %}}
...
3.  Il percorso file di tipo stringa per i dati KML di destinazione
...
{{% blocks/products/pf/agp/code-block title="Salva GeoJSON come KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da GeoJSON a KML" sectionDescription="Converti GeoJSON in KML subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/geojson-to-kml). La demo live ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file GeoJSON, verrà convertito istantaneamente in KML." >}}
