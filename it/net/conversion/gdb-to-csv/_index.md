...
{{% blocks/products/pf/agp/content h2="Come convertire GDB in CSV utilizzando C#" %}}

Per convertire da GDB a CSV, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da GDB a CSV in C#" %}}
...
2.  Driver di origine per far sapere all'API del formato di input. Impostalo su Drivers.FileGdb
3.  Il percorso file di tipo stringa per il file dati CSV di destinazione
4.  Driver di destinazione per specificare il formato di output. Impostalo su Drivers.Csv
...
{{% blocks/products/pf/agp/code-block title="Salva GDB come CSV - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da GDB a CSV" sectionDescription="Converti GDB in CSV subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/gdb-to-csv). La demo live ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file GDB, verrà convertito istantaneamente in CSV." >}}
