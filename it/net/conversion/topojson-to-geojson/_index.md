...
{{% blocks/products/pf/agp/content h2="Come convertire TopoJSON in GeoJSON usando C#" %}}

Per convertire TopoJSON in GeoJSON, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione di TopoJSON in GeoJSON in C#" %}}
...
4.  Driver di destinazione per specificare il formato di output. Impostalo su Drivers.GeoJson
...
{{% blocks/products/pf/agp/code-block title="Salva TopoJSON come GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da TopoJSON a GeoJSON" sectionDescription="Converti subito TopoJSON in GeoJSON visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/topojson-to-geojson). La demo live ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file TopoJSON, verrà convertito istantaneamente in GeoJSON." >}}
