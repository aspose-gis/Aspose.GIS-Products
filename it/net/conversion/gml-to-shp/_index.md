...
{{% blocks/products/pf/agp/content h2="Come convertire GML in SHP usando C#" %}}

Per convertire GML in SHP, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da GML a SHP in C#" %}}
...
3.  Il percorso file di tipo stringa per il file dei dati SHP di destinazione
...
{{% blocks/products/pf/agp/code-block title="Salva GML come SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da GML a SHP" sectionDescription="Converti GML in SHP subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/gml-to-shp). La demo live ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="Non è necessario scaricare l'API Aspose GIS." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="Seleziona semplicemente SHP come formato di output e." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file GML, verrà convertito istantaneamente in SHP." >}}
...
Shapefile è un formato multi file (conosciuto come ESRI Shapefile). Il principale ha l'estensione SHP. Shapefile è un popolare formato di file geografico vettoriale. Sviluppato e mantenuto da ESRI per la compatibilità tra i prodotti Esri e altri programmi.
