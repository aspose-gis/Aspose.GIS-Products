...
{{% blocks/products/pf/agp/content h2="Come convertire KML in TopoJSON usando C#" %}}

Per convertire KML in TopoJSON, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da KML a TopoJSON in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Salva KML come TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da KML a TopoJSON" sectionDescription="Converti KML in TopoJSON subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/kml-to-topojson). La demo live ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file KML, verrà convertito istantaneamente in TopoJSON." >}}
