...
{{% blocks/products/pf/agp/content h2="Come convertire GDB in SHP usando C#" %}}

Per convertire da GDB a SHP, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da GDB a SHP in C#" %}}
...
3.  Il percorso file di tipo stringa per i dati SHP di destinazione
...
{{% blocks/products/pf/agp/code-block title="Salva GDB come SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da GDB a SHP" sectionDescription="Converti GDB in SHP subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/gdb-to-shp). La demo live ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file GDB, verrà convertito istantaneamente in SHP." >}}
...
{{< blocks/products/pf/agp/other-supported-section title="Altre conversioni supportate" subTitle="Puoi anche convertire GDB in molti altri formati di file, inclusi alcuni elencati di seguito." >}}
