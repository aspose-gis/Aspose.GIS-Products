...
weight: 120
url: /it/conversion/kml-to-geojson/ 
...
2.  Driver di origine per far sapere all'API il formato di input. Impostalo su Drivers.Kml  
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da KML a GeoJSON" sectionDescription="Converti KML in GeoJSON subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/kml-to-geojson). La demo live ha i seguenti vantaggi" >}}
