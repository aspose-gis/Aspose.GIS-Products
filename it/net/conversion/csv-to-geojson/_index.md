---
title: Converti CSV in dati GIS GeoJSON tramite .NET o C#
weight: 120
url: /it/net/conversion/csv-to-geojson/
...
{{% blocks/products/pf/agp/content h2="Come convertire CSV in GeoJSON usando C#" %}}

Per convertire da CSV a GeoJSON, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da CSV a GeoJSON in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Salva CSV come GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV to GeoJSON Live Demos" sectionDescription="Converti CSV in GeoJSON subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/csv-to-geojson). La demo dal vivo ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file CSV, verrà convertito istantaneamente in GeoJSON." >}}
