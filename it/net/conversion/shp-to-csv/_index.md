...
{{% blocks/products/pf/agp/content h2="Come convertire SHP in CSV usando C#" %}}

Per convertire SHP in CSV, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da SHP a CSV in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Salva SHP come CSV - C#" offSpacer="" %}}
