...
{{% blocks/products/pf/agp/content h2="Come convertire GDB in GPX usando C#" %}}

Per convertire da GDB a GPX, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da GDB a GPX in C#" %}}
...
1.  Un percorso file di tipo stringa per il file GDB sorgente
2.  Driver sorgente per far sapere all'API del formato di input. Imposta su Drivers.FileGdb
3.  Il percorso file di tipo stringa per il file dati GPX di destinazione
...
{{% blocks/products/pf/agp/code-block title="Salva GDB come GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da GDB a GPX" sectionDescription="Converti GDB in GPX subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/gdb-to-gpx). La demo live ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file GDB, verrà convertito istantaneamente in GPX." >}}
