...
{{% blocks/products/pf/agp/content h2="Come convertire GPX in KML usando C#" %}}

Per convertire da GPX a KML, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da GPX a KML in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Salva GPX come KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GPX to KML Live Demos" sectionDescription="Converti GPX in KML subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/gpx-to-kml). La demo dal vivo ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file GPX, verrà convertito istantaneamente in KML." >}}
...
KML (Keyhole Markup Language) contiene informazioni geospaziali in notazione XML. KML può essere aperto in applicazioni GIS, a condizione che le supportino. Molte applicazioni hanno iniziato a fornire supporto per il formato KML dopo che è stato adottato come standard internazionale.
