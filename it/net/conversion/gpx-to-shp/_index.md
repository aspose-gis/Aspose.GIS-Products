...
{{% blocks/products/pf/agp/content h2="Come convertire GPX in SHP usando C#" %}}

Per convertire da GPX a SHP, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da GPX a SHP in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Salva GPX come SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GPX to SHP Live Demos" sectionDescription="Converti GPX in SHP subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/gpx-to-shp). La demo dal vivo ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file GPX, verrà convertito istantaneamente in SHP." >}}
...
Shapefile è un formato multi file (noto come ESRI Shapefile). Il principale ha l'estensione SHP. Shapefile è un popolare formato di file geografici vettoriali. Sviluppato e mantenuto da ESRI per la compatibilità tra i prodotti Esri e altri programmi.
