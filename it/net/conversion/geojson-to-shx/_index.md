...
{{% blocks/products/pf/agp/content h2="Come convertire GEOJSON in SHX usando C#" %}}

 Per convertire GEOJSON in SHX, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da GEOJSON a SHX in C#" %}}
...
3.  Il percorso file di tipo stringa per il file dati SHX di destinazione
...
{{% blocks/products/pf/agp/code-block title="Salva GEOJSON come SHX - C#" offSpacer="" %}}

```cs
// Converti i dati GIS GEOJSON in dati SHX
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da GEOJSON a SHX" sectionDescription="Converti GEOJSON in SHX subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/geojson-to-shx). La demo live ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Carica il tuo file GEOJSON, verrà convertito istantaneamente in SHX." >}}
...
Formato indice di forma, un indice posizionale della geometria delle caratteristiche per consentire la ricerca in avanti e all'indietro rapidamente
Leggi altro
