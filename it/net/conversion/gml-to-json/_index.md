...
{{% blocks/products/pf/agp/content h2="Come convertire GML in JSON utilizzando C#" %}}

Per convertire GML in JSON, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da GML a JSON in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Salva GML come JSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML to JSON Live Demos" sectionDescription="Converti GML in JSON subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/gml-to-json). La demo dal vivo ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file GML, verrà convertito istantaneamente in JSON." >}}
...
{{< blocks/products/pf/agp/other-supported-section title="Altre conversioni supportate" subTitle="Puoi anche convertire GML in molti altri formati di file, inclusi alcuni elencati di seguito." >}}
