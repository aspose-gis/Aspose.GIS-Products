...
{{% blocks/products/pf/agp/content h2="Come convertire KML in SHP usando C#" %}}

Per convertire KML in SHP, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da KML a SHP in C#" %}}
...
3.  Il percorso file di tipo stringa per il file dati SHP di destinazione
...
{{% blocks/products/pf/agp/code-block title="Salva KML come SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da KML a SHP" sectionDescription="Converti KML in SHP subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/kml-to-shp). La demo live ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file KML, verrà convertito istantaneamente in SHP." >}}
...
Shapefile è un formato multi file (noto come Shapefile ESRI). Il principale ha l'estensione SHP. Shapefile è un popolare formato di file vettoriale geografico. Sviluppato e mantenuto da ESRI per la compatibilità tra i prodotti Esri e altri programmi.
