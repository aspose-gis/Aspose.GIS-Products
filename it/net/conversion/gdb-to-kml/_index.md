...
{{% blocks/products/pf/agp/content h2="Come convertire GDB in KML usando C#" %}}

Per convertire da GDB a KML, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da GDB a KML in C#" %}}
...
1.  Un percorso file di tipo stringa per il file GDB di origine
2.  Driver di origine per far sapere all'API del formato di input. Imposta su Drivers.FileGdb
...
{{% blocks/products/pf/agp/code-block title="Salva GDB come KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live da GDB a KML" sectionDescription="Converti GDB in KML subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/gdb-to-kml). La demo live ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file GDB, verrà convertito istantaneamente in KML." >}}
...
KML (Keyhole Markup Language) contiene informazioni geospaziali in notazione XML. KML può essere aperto in applicazioni GIS se le supportano. Molte applicazioni hanno iniziato a fornire supporto per il formato KML dopo che è stato adottato come standard internazionale.
...
{{< blocks/products/pf/agp/other-supported-section title="Altre conversioni supportate" subTitle="Puoi anche convertire GDB in molti altri formati di file, tra cui alcuni elencati di seguito." >}}
