...
{{% blocks/products/pf/agp/content h2="Come convertire CSV in SHP usando C#" %}}

Per convertire da CSV a SHP, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da CSV a SHP in C#" %}}
...
4.  Driver di destinazione per specificare il formato di output. Impostalo su Drivers.Shapefile
...
{{% blocks/products/pf/agp/code-block title="Salva CSV come SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV to SHP Live Demos" sectionDescription="Converti CSV in SHP subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/csv-to-shp). La demo dal vivo ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file CSV, verrà convertito istantaneamente in SHP." >}}
