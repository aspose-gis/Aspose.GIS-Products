...
{{% blocks/products/pf/agp/content h2="Come convertire SHP in GPX usando C#" %}}

Per convertire da SHP a GPX, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la conversione da SHP a GPX in C#" %}}
...
3.  Il percorso file di tipo stringa per i dati GPX di destinazione
...
{{% blocks/products/pf/agp/code-block title="Salva SHP come GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SHP to GPX Live Demos" sectionDescription="Converti SHP in GPX subito visitando il nostro [sito web di demo live](https://products.aspose.app/gis/conversion/shp-to-gpx). La demo dal vivo ha i seguenti vantaggi" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Carica il tuo file SHP, verrà convertito istantaneamente in GPX." >}}
...
{{< blocks/products/pf/agp/other-supported-section title="Altre conversioni supportate" subTitle="Puoi anche convertire SHP in molti altri formati di file, inclusi alcuni elencati di seguito." >}}
