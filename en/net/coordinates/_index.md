...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Coordinates Converter API Features
   </h2>
   <p>
   </p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Web Apps Gallery
      ...
      <p>
        We present free applications that uses the .NET API to implement Coordinates Converter and other. Here you can explore the functionality and quality of its work. 
      </p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Coordinates Converter Sample for .NET
    </h2>
    <p>
