...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="An overview to convert SHAPEFILE to JPEG .NET API." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Web Apps Gallery
      ...
      <p>
        We present free applications that uses the .NET API to implement the <a href="https://products.aspose.app/gis/viewer/shapefile-to-jpeg" >"SHAPEFILE to JPEG Converter"</a> and other. Here you can explore the functionality and quality of its work. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Sample for .NET - SHAPEFILE to JPEG Converter
    </h2>
    <p>
     Here is how to convert SHAPEFILE to JPEG using default settings:
    </p>
