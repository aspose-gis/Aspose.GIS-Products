---
title: Convert SHP to GPX GIS Data via .NET or C#
weight: 120
url: /en/net/conversion/shp-to-gpx/ 
description: Try our On-Premise APIs to convert SHP to GPX on .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert SHP to GPX in C#" h2="Export SHP to GPX using server side APIs, without needing softwares like ArcGIS, ArcMap, QGIS or Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GPX" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SHP" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert SHP to GPX Using C#" %}}

 In order to convert SHP to GPX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for converting SHP to GPX in C#" %}}
...
1.  A string type file path to the source SHP file
...
{{< blocks/products/pf/agp/demobox sectionTitle="SHP to GPX Live Demos" sectionDescription="Convert SHP to GPX right now by visiting our [Live Demos website](https://products.aspose.app/gis/conversion/shp-to-gpx). The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload your SHP file, it will be converted instantly to GPX." >}}
