...
weight: 120
url: /en/net/conversion/gpx-to-shp/ 
description: Try our On-Premise APIs to convert GPX to SHP on .NET Framework, .NET Core, C#.
---
...
{{% blocks/products/pf/agp/content h2="How to Convert GPX to SHP Using C#" %}}
 ...
 In order to convert GPX to SHP, we’ll use
