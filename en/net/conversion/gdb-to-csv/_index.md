---
title: Convert GDB to CSV GIS Data via .NET or C#
weight: 120
url: /en/net/conversion/gdb-to-csv/ 
description: Try our On-Premise APIs to convert GDB to CSV on .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert GDB to CSV in C#" h2="Export GDB to CSV using server side APIs, without needing softwares like ArcGIS, ArcMap, QGIS or Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="CSV" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GDB" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert GDB to CSV Using C#" %}}

 In order to convert GDB to CSV, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for converting GDB to CSV in C#" %}}
...
1.  A string type file path to the source GDB file
1.  Source driver to let the API know about the input format. Set it to Drivers.FileGdb
...
{{% blocks/products/pf/agp/code-block title="Save GDB as CSV - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GDB to CSV Live Demos" sectionDescription="Convert GDB to CSV right now by visiting our [Live Demos website](https://products.aspose.app/gis/conversion/gdb-to-csv). The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload your GDB file, it will be converted instantly to CSV." >}}
...
GDB is the format used by the Esri ArcGIS platform. This is the folder that contains a collection of .gdbtable, .gdbtablx, .gdbindexes, .atx, .spx and .freelist files and so on.
