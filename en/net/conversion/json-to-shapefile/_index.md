---
title: Convert JSON to Shapefile GIS Data via .NET or C#
weight: 120
url: /en/net/conversion/json-to-shapefile/ 
description: Try our On-Premise APIs to convert JSON to Shapefile on .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert JSON to Shapefile in C#" h2="Export JSON to Shapefile using server side APIs, without needing softwares like ArcGIS, ArcMap, QGIS or Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Shapefile" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert JSON to Shapefile Using C#" %}}

 In order to convert JSON to Shapefile, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for converting JSON to Shapefile in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Save JSON as Shapefile - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="JSON to Shapefile Live Demos" sectionDescription="Convert JSON to Shapefile right now by visiting our [Live Demos website](https://products.aspose.app/gis/conversion/json-to-shapefile). The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload your JSON file, it will be converted instantly to Shapefile." >}}
