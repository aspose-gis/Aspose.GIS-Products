---
title: Convert Shapefile to TopoJSON GIS Data via .NET or C#
weight: 120
url: /en/net/conversion/shapefile-to-topojson/ 
description: Try our On-Premise APIs to convert Shapefile to TopoJSON on .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert Shapefile to TopoJSON in C#" h2="Export Shapefile to TopoJSON using server side APIs, without needing softwares like ArcGIS, ArcMap, QGIS or Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TopoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert Shapefile to TopoJSON Using C#" %}}

 In order to convert Shapefile to TopoJSON, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for converting Shapefile to TopoJSON in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Save Shapefile as TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile to TopoJSON Live Demos" sectionDescription="Convert Shapefile to TopoJSON right now by visiting our [Live Demos website](https://products.aspose.app/gis/conversion/shapefile-to-topojson). The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload your Shapefile file, it will be converted instantly to TopoJSON." >}}
