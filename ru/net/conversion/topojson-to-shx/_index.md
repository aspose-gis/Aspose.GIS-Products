...
{{% blocks/products/pf/agp/content h2="Как преобразовать TOPOJSON в SHX, используя C#" %}}

Для преобразования TOPOJSON в SHX мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Этапы преобразования TOPOJSON в SHX в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Сохранить TOPOJSON как SHX - C#" offSpacer="" %}}
