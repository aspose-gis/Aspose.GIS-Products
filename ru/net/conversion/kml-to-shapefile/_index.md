---
title: Преобразование KML в Shapefile GIS данных через .NET или C#
weight: 120
url: /ru/net/conversion/kml-to-shapefile/ 
description: Попробуйте наши локальные API для преобразования KML в Shapefile на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование KML в Shapefile в C#" h2="Экспорт KML в Shapefile с использованием серверных API, без необходимости программного обеспечения, такого как ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Shapefile" pfName="Aspose.GIS" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать KML в Shapefile, используя C#" %}}

Для преобразования KML в Shapefile мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Этапы преобразования KML в Shapefile в C#" %}}
...
2.  Исходный драйвер для уведомления API о входном формате. Установите его на Drivers.Kml
...
{{% blocks/products/pf/agp/code-block title="Сохранение KML как Shapefile - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML в Shapefile Live Demos" sectionDescription="Преобразуйте KML в Shapefile прямо сейчас, посетив наш [сайт с живыми демонстрациями](https://products.aspose.app/gis/conversion/kml-to-shapefile). Живая демоверсия имеет следующие преимущества" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Загрузите свой KML файл, он будет мгновенно преобразован в Shapefile." >}}
...
KML (Keyhole Markup Language) содержит геопространственную информацию в XML нотации. KML можно открывать в приложениях Geographic Information System (GIS), если они поддерживают его. Многие приложения начали поддерживать формат KML после того, как он был принят в качестве международного стандарта.
...
{{< blocks/products/pf/agp/other-supported-section title="Другие поддерживаемые преобразования" subTitle="Вы также можете преобразовывать KML во многие другие форматы файлов, включая несколько перечисленных ниже." >}}
