---
title: Преобразование TopoJSON в GeoJSON GIS данные через .NET или C#
weight: 120
url: /ru/net/conversion/topojson-to-geojson/ 
description: Попробуйте наши локальные API для преобразования TopoJSON в GeoJSON на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование TopoJSON в GeoJSON в C#" h2="Экспорт TopoJSON в GeoJSON с использованием серверных API, без необходимости использования программного обеспечения, такого как ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TopoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать TopoJSON в GeoJSON, используя C#" %}}

Для преобразования TopoJSON в GeoJSON мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Этапы преобразования TopoJSON в GeoJSON в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Сохранить TopoJSON как GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON в GeoJSON Live Demos" sectionDescription="Преобразуйте TopoJSON в GeoJSON прямо сейчас, посетив наш [сайт с живыми демонстрациями](https://products.aspose.app/gis/conversion/topojson-to-geojson). Живая демоверсия имеет следующие преимущества" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Загрузите свой файл TopoJSON, он будет мгновенно преобразован в GeoJSON." >}}
...
GeoJSON — это формат на основе JSON, предназначенный для представления географических объектов с их нестационарными атрибутами. Этот формат определяет различные объекты JSON (JavaScript Object Notation) и способ их соединения. JSON представляет коллективную информацию о географических объектах, их пространственных пределах и свойствах.
