...
{{% blocks/products/pf/agp/content h2="Как преобразовать KML в SHP, используя C#" %}}

Для преобразования KML в SHP мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Этапы преобразования KML в SHP в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Сохранение KML как SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML в SHP Live Demos" sectionDescription="Преобразуйте KML в SHP прямо сейчас, посетив наш [сайт с живыми демонстрациями](https://products.aspose.app/gis/conversion/kml-to-shp). Живая демоверсия имеет следующие преимущества" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Загрузите свой KML файл, он будет мгновенно преобразован в SHP." >}}
