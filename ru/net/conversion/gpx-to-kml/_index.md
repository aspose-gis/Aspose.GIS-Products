...
{{% blocks/products/pf/agp/content h2="Как преобразовать GPX в KML, используя C#" %}}

Для преобразования GPX в KML мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Этапы преобразования GPX в KML в C#" %}}
...
2.  Исходный драйвер для уведомления API о входном формате. Установите его на Drivers.Gpx
...
{{% blocks/products/pf/agp/code-block title="Сохранить GPX как KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GPX в KML Live Demos" sectionDescription="Преобразуйте GPX в KML прямо сейчас, посетив наш [веб-сайт с живыми демонстрациями](https://products.aspose.app/gis/conversion/gpx-to-kml). Живая демоверсия имеет следующие преимущества" >}}
...
{{< blocks/products/pf/agp/other-supported-section title="Другие поддерживаемые преобразования" subTitle="Вы также можете преобразовывать GPX во многие другие форматы файлов, включая несколько перечисленных ниже." >}}
