...
{{% blocks/products/pf/agp/content h2="Как преобразовать TopoJSON в Shapefile, используя C#" %}}

Для преобразования TopoJSON в Shapefile мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Этапы преобразования TopoJSON в Shapefile в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Сохранение TopoJSON как Shapefile - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON в Shapefile Live Demos" sectionDescription="Преобразуйте TopoJSON в Shapefile прямо сейчас, посетив наш [сайт с живыми демонстрациями](https://products.aspose.app/gis/conversion/topojson-to-shapefile). Живая демоверсия имеет следующие преимущества" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Загрузите свой файл TopoJSON, он будет мгновенно преобразован в Shapefile." >}}
