---
title: Преобразование GML в JSON GIS данные через .NET или C#
weight: 120
url: /ru/net/conversion/gml-to-json/ 
description: Попробуйте наши локальные API для преобразования GML в JSON на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование GML в JSON в C#" h2="Экспорт GML в JSON с использованием серверных API, без необходимости программного обеспечения, такого как ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="Aspose.GIS" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GML" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать GML в JSON, используя C#" %}}

Для преобразования GML в JSON мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Этапы преобразования GML в JSON в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Сохранить GML как JSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML to JSON Live Demos" sectionDescription="Преобразуйте GML в JSON прямо сейчас, посетив наш [Live Demos website](https://products.aspose.app/gis/conversion/gml-to-json). Живая демонстрация имеет следующие преимущества" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Загрузите свой GML файл, он будет мгновенно преобразован в JSON." >}}
