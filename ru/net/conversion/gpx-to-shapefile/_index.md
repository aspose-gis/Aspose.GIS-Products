---
title: Преобразование GPX в Shapefile GIS данные через .NET или C#
weight: 120
url: /ru/net/conversion/gpx-to-shapefile/ 
description: Попробуйте наши локальные API для преобразования GPX в Shapefile на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование GPX в Shapefile в C#" h2="Экспорт GPX в Shapefile с использованием серверных API, без необходимости программного обеспечения, такого как ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Shapefile" pfName="Aspose.GIS" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GPX" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать GPX в Shapefile, используя C#" %}}

Для преобразования GPX в Shapefile мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Этапы преобразования GPX в Shapefile в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Сохранить GPX как Shapefile - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GPX в Shapefile Live Demos" sectionDescription="Преобразуйте GPX в Shapefile прямо сейчас, посетив наш [сайт с живыми демонстрациями](https://products.aspose.app/gis/conversion/gpx-to-shapefile). Живая демоверсия имеет следующие преимущества" >}}
...
SHP — это расширение файла для одного из основных типов файлов, используемых для представления ESRI Shapefile. Он представляет геопространственную информацию в виде векторных данных, которые должны использоваться приложениями Geographic Information Systems (GIS). Формат был разработан как открытые спецификации для облегчения совместимости между ESRI и другими программными продуктами.
