---
title: Преобразование GPX в SHP GIS данные через .NET или C#
weight: 120
url: /ru/net/conversion/gpx-to-shp/ 
description: Попробуйте наши локальные API для преобразования GPX в SHP на .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Преобразование GPX в SHP в C#" h2="Экспорт GPX в SHP с использованием серверных API, без необходимости программного обеспечения, такого как ArcGIS, ArcMap, QGIS или Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SHP" pfName="Aspose.GIS" subTitlepfName="для .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GPX" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать GPX в SHP, используя C#" %}}

Для преобразования GPX в SHP мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Этапы преобразования GPX в SHP в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Сохранить GPX как SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GPX в SHP Live Demos" sectionDescription="Преобразуйте GPX в SHP прямо сейчас, посетив наш [Live Demos веб-сайт](https://products.aspose.app/gis/conversion/gpx-to-shp). Живая демонстрация имеет следующие преимущества" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Загрузите свой GPX файл, он будет мгновенно преобразован в SHP." >}}
