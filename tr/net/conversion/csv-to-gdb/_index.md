---
title: CSV'yi .NET veya C# ile GDB GIS Verisine Dönüştürme
weight: 120
url: /tr/net/conversion/csv-to-gdb/ 
description: CSV'yi .NET Framework, .NET Core, C# üzerinde On-Premise API'lerimiz aracılığıyla GDB'ye dönüştürmeyi deneyin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="C#'ta CSV'yi GDB'ye Dönüştür" h2="ArcGIS, ArcMap, QGIS veya Google Earth gibi yazılımlara ihtiyaç duymadan sunucu tarafı API'leri kullanarak CSV'yi GDB'ye aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GDB" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#'ta CSV'yi GDB'ye Dönüştürme Adımları" %}}
...
3.  Hedef GDB veri dosyasına dosya yolu dize türünde
...
{{% blocks/products/pf/agp/code-block title="CSV'yi GDB Olarak Kaydetme - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV'den GDB'ye Canlı Demolar" sectionDescription="[Canlı Demo web sitemizi](https://products.aspose.app/gis/conversion/csv-to-gdb) ziyaret ederek CSV'yi şimdi GDB'ye dönüştürün. Canlı demoda aşağıdaki avantajlar vardır" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text="Aspose GIS API'sini indirmeye gerek yok." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text="Sadece çıktı formatı olarak GDB seçin ve." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="CSV dosyanızı yükleyin, anında GDB'ye dönüştürülecektir." >}}
...
GDB, Esri ArcGIS platformu tarafından kullanılan formattır. .gdbtable, .gdbtablx, .gdbindexes, .atx, .spx ve vb. dosyaları içeren klasördür.
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/csv-to-gpx" name="CSV TO GPX" description="GPS Değişim Formatı" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/csv-to-kml" name="CSV TO KML" description="Anahtar Kelime İşaretleme Dili" >}}
