---
title: GML'i .NET veya C# ile JSON GIS Verisine Dönüştürün
weight: 120
url: /tr/net/conversion/gml-to-json/ 
description: GML'yi .NET Framework, .NET Core, C# üzerinde On-Premise API'lerimiz aracılığıyla JSON'a dönüştürmek için deneyin.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="GML'yi C#'ta JSON'a Dönüştürün" h2="ArcGIS, ArcMap, QGIS veya Google Earth gibi yazılımlara ihtiyaç duymadan sunucu tarafı API'leri kullanarak GML'yi JSON'a aktarın." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GML" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#'ta GML'yi JSON'a Dönüştürme Adımları" %}}
...
1.  Kaynak GML dosyasına ait string türünde dosya yolu
2.  Giriş formatı hakkında API'ye bilgi vermek için kaynak sürücüsü. Bunu Drivers.Gml olarak ayarlayın
3.  Hedef JSON verisine ait string türünde dosya yolu
4.  Çıkış formatını belirtmek için hedef sürücüsü. Bunu Drivers.GeoJson olarak ayarlayın
...
{{% blocks/products/pf/agp/code-block title="GML'yi JSON olarak Kaydet - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML'den JSON'a Canlı Demolar" sectionDescription="[Canlı Demolar web sitemizi](https://products.aspose.app/gis/conversion/gml-to-json) ziyaret ederek GML'yi şimdi JSON'a dönüştürün. Canlı demoda aşağıdaki avantajlar vardır" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text="GML dosyanızı yükleyin, anında JSON'a dönüştürülecektir." >}}
...
Coğrafi İşaretleme Dili (GML olarak bilinir), GIS'de kullanılan XML tabanlı bir formattır. GML, İnternet üzerinden coğrafi işlemler için açık bir değişim formatıdır. Bu format veri ve yapı odaklıdır.

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="JSON" readMoreLink="https://docs.fileformat.com/gis/geojson/" >}}

Coğrafi özellikleri ve mekansal olmayan özellikleriyle temsil etmek için tasarlanmış JSON tabanlı format. Bu format, farklı JSON (JavaScript Object Notation) nesnelerini ve bunların birleştirilme şeklini tanımlar. JSON, Coğrafi özellikler, uzamsal kapsamları ve özellikleri hakkında toplu bilgi içerir.
