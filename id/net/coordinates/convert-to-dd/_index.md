---
title: Konversi ke Derajat Desimal (DD) - API untuk .NET
weight: 40
url: /id/net/coordinates/convert-to-dd
...
<p>
 Aspose.GIS for .NET dirancang dengan kesederhanaan, kinerja, kegunaan &amp; portabilitas dalam pikiran. Ini berisi API untuk digunakan dengan platform .NET Framework &amp; .NET Core, memungkinkan Anda membangun aplikasi lintas platform dengan sangat mudah.
</p>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galeri Aplikasi Web
      ...
      <p>
        Kami menyajikan aplikasi gratis yang menggunakan API .NET untuk mengimplementasikan <a href="https://products.aspose.app/gis/coordinates/convert-to-dd" >"Konversi ke DD"</a> dan lainnya. Di sini Anda dapat menjelajahi fungsionalitas dan kualitas pekerjaannya. 
      </p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Contoh untuk .NET - Konversi ke DD 
    </h2>
    <p>
     Berikut adalah cara mengonversi unit koordinat ke format GoeRef menggunakan pengaturan default:
    </p>
