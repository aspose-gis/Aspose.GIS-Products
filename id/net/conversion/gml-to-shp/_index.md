---
title: Konversi GML ke SHP Data GIS melalui .NET atau C#
weight: 120
url: /id/net/conversion/gml-to-shp/ 
description: Coba API On-Premise kami untuk mengonversi GML ke SHP pada .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi GML ke SHP di C#" h2="Ekspor GML ke SHP menggunakan API sisi server, tanpa memerlukan perangkat lunak seperti ArcGIS, ArcMap, QGIS atau Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SHP" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GML" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi GML ke SHP Menggunakan C#" %}}

 Untuk mengonversi GML ke SHP, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah untuk mengonversi GML ke SHP di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Simpan GML sebagai SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung GML ke SHP" sectionDescription="Konversi GML ke SHP sekarang juga dengan mengunjungi [situs web Demo Langsung](https://products.aspose.app/gis/conversion/gml-to-shp). Demo langsung memiliki manfaat berikut" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Unggah file GML Anda, itu akan langsung dikonversi ke SHP." >}}
...
Bahasa Markup Geografis (dikenal sebagai GML) adalah format berbasis XML yang digunakan di GIS. GML adalah format pertukaran terbuka untuk transaksi geografis di Internet. Format ini berorientasi data dan struktur.
