---
title: Konversi Shapefile ke Data GIS KML melalui .NET atau C#
weight: 120
url: /id/net/conversion/shapefile-to-kml/ 
description: Coba API On-Premise kami untuk mengonversi Shapefile ke KML pada .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi Shapefile ke KML di C#" h2="Ekspor Shapefile ke KML menggunakan API sisi server, tanpa memerlukan perangkat lunak seperti ArcGIS, ArcMap, QGIS atau Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi Shapefile ke KML Menggunakan C#" %}}

 Untuk mengonversi Shapefile ke KML, kita akan menggunakan
...
{{% blocks/products/pf/agp/code-block title="Simpan Shapefile sebagai KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Shapefile ke KML" sectionDescription="Konversi Shapefile ke KML sekarang juga dengan mengunjungi [situs web Demo Langsung](https://products.aspose.app/gis/conversion/shapefile-to-kml). Demo langsung memiliki manfaat berikut" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Unggah file Shapefile Anda, itu akan langsung dikonversi ke KML." >}}
