---
title: Konversi SHP ke GPX Data GIS melalui .NET atau C#
weight: 120
url: /id/net/conversion/shp-to-gpx/
description: Coba API On-Premise kami untuk mengonversi SHP ke GPX pada .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi SHP ke GPX di C#" h2="Ekspor SHP ke GPX menggunakan API sisi server, tanpa memerlukan perangkat lunak seperti ArcGIS, ArcMap, QGIS atau Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GPX" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="SHP" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi SHP ke GPX Menggunakan C#" %}}

 Untuk mengonversi SHP ke GPX, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah untuk mengonversi SHP ke GPX di C#" %}}
...
1.  Jenis string jalur file ke file SHP sumber
...
{{% blocks/products/pf/agp/code-block title="Simpan SHP sebagai GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung SHP ke GPX" sectionDescription="Konversi SHP ke GPX sekarang dengan mengunjungi [situs web Demo Langsung](https://products.aspose.app/gis/conversion/shp-to-gpx). Demo langsung memiliki manfaat berikut" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Unggah file SHP Anda, itu akan langsung dikonversi ke GPX." >}}
...
{{< blocks/products/pf/agp/other-supported-section title="Konversi Lain yang Didukung" subTitle="Anda juga dapat mengonversi SHP ke banyak format file lain termasuk beberapa yang tercantum di bawah ini." >}}
