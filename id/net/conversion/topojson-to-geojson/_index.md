---
title: Konversi TopoJSON ke Data GIS GeoJSON melalui .NET atau C#
weight: 120
url: /id/net/conversion/topojson-to-geojson/ 
description: Coba API On-Premise kami untuk mengonversi TopoJSON ke GeoJSON pada .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi TopoJSON ke GeoJSON di C#" h2="Ekspor TopoJSON ke GeoJSON menggunakan API sisi server, tanpa memerlukan perangkat lunak seperti ArcGIS, ArcMap, QGIS atau Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TopoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi TopoJSON ke GeoJSON Menggunakan C#" %}}

 Untuk mengonversi TopoJSON ke GeoJSON, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah untuk mengonversi TopoJSON ke GeoJSON di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Simpan TopoJSON sebagai GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung TopoJSON ke GeoJSON" sectionDescription="Konversi TopoJSON ke GeoJSON sekarang juga dengan mengunjungi [situs web Demo Langsung](https://products.aspose.app/gis/conversion/topojson-to-geojson). Demo langsung memiliki manfaat berikut" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Unggah file TopoJSON Anda, itu akan langsung dikonversi ke GeoJSON." >}}
