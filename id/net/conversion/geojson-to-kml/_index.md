---
title: Konversi GeoJSON ke Data GIS KML melalui .NET atau C#
weight: 120
url: /id/net/conversion/geojson-to-kml/
description: Coba API On-Premise kami untuk mengonversi GeoJSON ke KML pada .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi GeoJSON ke KML di C#" h2="Ekspor GeoJSON ke KML menggunakan API sisi server, tanpa memerlukan perangkat lunak seperti ArcGIS, ArcMap, QGIS atau Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="KML" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GeoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi GeoJSON ke KML Menggunakan C#" %}}

 Untuk mengonversi GeoJSON ke KML, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah untuk mengonversi GeoJSON ke KML di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Simpan GeoJSON sebagai KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung GeoJSON ke KML" sectionDescription="Konversi GeoJSON ke KML sekarang juga dengan mengunjungi [situs web Demo Langsung](https://products.aspose.app/gis/conversion/geojson-to-kml). Demo langsung memiliki manfaat berikut" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Unggah file GeoJSON Anda, itu akan langsung dikonversi ke KML." >}}
