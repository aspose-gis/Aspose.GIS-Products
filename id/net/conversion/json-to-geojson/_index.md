---
title: Konversi JSON ke Data GIS GeoJSON melalui .NET atau C#
weight: 120
url: /id/net/conversion/json-to-geojson/ 
description: Coba API On-Premise kami untuk mengonversi JSON ke GeoJSON pada .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi JSON ke GeoJSON di C#" h2="Ekspor JSON ke GeoJSON menggunakan API sisi server, tanpa memerlukan perangkat lunak seperti ArcGIS, ArcMap, QGIS atau Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="untuk .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi JSON ke GeoJSON Menggunakan C#" %}}

 Untuk mengonversi JSON ke GeoJSON, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah untuk mengonversi JSON ke GeoJSON di C#" %}}
...
1.  Jenis string file path ke file data GeoJSON tujuan
...
{{% blocks/products/pf/agp/code-block title="Simpan JSON sebagai GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung JSON ke GeoJSON" sectionDescription="Konversi JSON ke GeoJSON sekarang juga dengan mengunjungi [situs web Demo Langsung](https://products.aspose.app/gis/conversion/json-to-geojson). Demo langsung memiliki manfaat berikut" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Unggah file JSON Anda, itu akan langsung dikonversi ke GeoJSON." >}}
