---
title: Konversi Shapefile ke Data GIS GeoJSON melalui .NET atau C#
weight: 120
url: /id/net/conversion/shapefile-to-geojson/ 
description: Coba API On-Premise kami untuk mengonversi Shapefile ke GeoJSON pada .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi Shapefile ke GeoJSON di C#" h2="Ekspor Shapefile ke GeoJSON menggunakan API sisi server, tanpa memerlukan perangkat lunak seperti ArcGIS, ArcMap, QGIS atau Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi Shapefile ke GeoJSON Menggunakan C#" %}}

 Untuk mengonversi Shapefile ke GeoJSON, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah untuk mengonversi Shapefile ke GeoJSON di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Simpan Shapefile sebagai GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Shapefile ke GeoJSON" sectionDescription="Konversi Shapefile ke GeoJSON sekarang juga dengan mengunjungi [situs web Demo Langsung](https://products.aspose.app/gis/conversion/shapefile-to-geojson). Demo langsung memiliki manfaat berikut" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Unggah file Shapefile Anda, itu akan langsung dikonversi ke GeoJSON." >}}
...
GeoJSON adalah format berbasis JSON yang dirancang untuk mewakili fitur geografis dengan atribut non-spasialnya. Format ini mendefinisikan berbagai objek JSON (JavaScript Object Notation) dan cara penggabungannya. JSON mewakili informasi kolektif tentang fitur Geografis, luas spasialnya, dan propertinya.
