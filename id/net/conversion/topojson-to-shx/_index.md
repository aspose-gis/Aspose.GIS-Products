---
title: Konversi TOPOJSON ke SHX GIS Data melalui .NET 
weight: 260
url: /id/net/conversion/topojson-to-shx/ 
description: Coba API On-Premise kami untuk konversi data GIS Anda pada .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Konversi TOPOJSON ke SHX di C#" h2="Ekspor TOPOJSON ke SHX menggunakan API sisi server, tanpa memerlukan perangkat lunak seperti ArcGIS, ArcMap, QGIS atau Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SHX" pfName="Aspose.GIS" subTitlepfName="untuk .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TOPOJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi TOPOJSON ke SHX Menggunakan C#" %}}

 Untuk mengonversi TOPOJSON ke SHX, kita akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah untuk mengonversi TOPOJSON ke SHX di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Simpan TOPOJSON sebagai SHX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung TOPOJSON ke SHX" sectionDescription="Konversi TOPOJSON ke SHX sekarang juga dengan mengunjungi [situs web Demo Langsung](https://products.aspose.app/gis/conversion/topojson-to-shx). Demo langsung memiliki manfaat berikut" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Unggah file TOPOJSON Anda, itu akan langsung dikonversi ke SHX." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/topojson-to-json" name="TOPOJSON KE JSON" description="Notasi Objek JavaScript" >}}
