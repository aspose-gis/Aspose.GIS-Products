---
title: Omzetten naar Decimal Degree Minutes (DDM) - API's voor .NET
weight: 40
url: /nl/net/coordinates/convert-to-ddm
...
<p>
 Aspose.GIS voor .NET stelt u in staat om Decimal Degree Minutes (DDM) voor geospatiale eenheden om te zetten. Onze bibliotheek maakt het eenvoudig en snel converteren van breedte- en lengtegraden naar een gewenst formaat mogelijk. Bovendien bevat onze bibliotheek de mogelijkheid om locaties uit een tekst te extraheren.
</p>

<p>
 Aspose.GIS voor .NET is ontworpen met het oog op eenvoud, prestaties, bruikbaarheid en portabiliteit. Het bevat API's die kunnen worden gebruikt met .NET Framework &amp; .NET Core platforms, waardoor u eenvoudig cross-platform applicaties kunt bouwen.
</p>
...
<div class="diagram1 d1-net">
 <div class="d1-row">
  ...
  <div class="d1-col d1-right">
   ...
   <ul>
    <li>Extracteer Breedte- en Lengtegraden</li>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    API Functies - Omzetten naar DDM
   </h2>
   <p>
   </p>
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Zet Breedte- en Lengtegraden om naar op graden gebaseerde eenheden      
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Web Apps Galerij
      ...
      <p>
        We presenteren gratis applicaties die de .NET API gebruiken om <a href="https://products.aspose.app/gis/coordinates/convert-to-ddm" >"Om te zetten naar DDM"</a> en andere te implementeren. Hier kunt u de functionaliteit en kwaliteit van het werk verkennen. 
      </p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Voorbeeld voor .NET - Omzetten naar DDM 
    </h2>
    <p>
     Hier is hoe u eenheden coördinaten kunt omzetten naar GoeRef formaat met behulp van de standaardinstellingen:
    </p>
