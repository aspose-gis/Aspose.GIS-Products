---
title: Omzetten naar Decimal Degrees (DD) - API's voor .NET
weight: 40
url: /nl/net/coordinates/convert-to-dd
...
<p>
 Aspose.GIS voor .NET stelt u in staat om Decimal Degrees (DD) voor geospatiale eenheden om te zetten. Onze bibliotheek maakt het eenvoudig en snel om breedte- en lengtegraad naar een gewenst formaat van eenheden om te zetten. Ook bevat onze bibliotheek de mogelijkheid om locaties uit een tekst te extraheren.
</p>
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-4">
    ...
    <p class="col-lg-10">
     Zet Breedte- en Lengtegraad om naar op graden gebaseerde eenheden      
    </p>
   </div>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Web Apps Galerij
      ...
      <p>
        We presenteren gratis applicaties die de .NET API gebruiken om <a href="https://products.aspose.app/gis/coordinates/convert-to-dd" >"Om te zetten naar DD"</a> en andere implementaties uit te voeren. Hier kunt u de functionaliteit en kwaliteit van het werk verkennen. 
      </p>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Voorbeeld voor .NET - Omzetten naar DD 
    </h2>
    <p>
