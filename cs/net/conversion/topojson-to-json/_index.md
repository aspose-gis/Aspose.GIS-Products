---
title: Převod TOPOJSON na JSON GIS data pomocí .NET
weight: 160
url: /cs/net/conversion/topojson-to-json/
description: Vyzkoušejte naše On-Premise API pro převod vašich GIS dat v .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převod TOPOJSON na JSON v C#" h2="Export TOPOJSON do JSON pomocí serverových API, bez nutnosti softwaru jako ArcGIS, ArcMap, QGIS nebo Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JSON" pfName="Aspose.GIS" subTitlepfName="pro .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TOPOJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést TOPOJSON na JSON pomocí C#" %}}

Abychom mohli převést TOPOJSON na JSON, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postupy pro převod TOPOJSON na JSON v C#" %}}
...
1.  Řetězcový typ souborové cesty ke zdrojovému TOPOJSON souboru
...
{{% blocks/products/pf/agp/code-block title="Uložte TOPOJSON jako JSON - C#" offSpacer="" %}}

```cs
// Převod GIS dat TOPOJSON na data JSON
...
{{< blocks/products/pf/agp/demobox sectionTitle="TOPOJSON na JSON Živé ukázky" sectionDescription="Převod TOPOJSON na JSON hned teď návštěvou našich [webových stránek s živými ukázkami](https://products.aspose.app/gis/conversion/topojson-to-json). Živá ukázka má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Nahrajte svůj TOPOJSON soubor, okamžitě se převede na JSON." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/topojson-to-geojson" name="TOPOJSON NA GEOJSON" description="Formát založený na JSON" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/topojson-to-kml" name="TOPOJSON NA KML" description="Jazyk značkování Keyhole" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/topojson-to-shx" name="TOPOJSON NA SHX" description="Přípona souboru Shapefile" >}}
