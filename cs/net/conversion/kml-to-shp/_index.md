---
title: Převod KML na SHP GIS data pomocí .NET nebo C#
weight: 120
url: /cs/net/conversion/kml-to-shp/ 
description: Vyzkoušejte naše On-Premise API pro převod KML na SHP v .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převod KML na SHP v C#" h2="Exportujte KML do SHP pomocí serverových API, bez nutnosti softwaru jako ArcGIS, ArcMap, QGIS nebo Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SHP" pfName="Aspose.GIS" subTitlepfName="pro .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="KML" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést KML na SHP pomocí C#" %}}

Pro převod KML na SHP použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postupy pro převod KML na SHP v C#" %}}
...
1.  Cílový ovladač pro určení výstupního formátu. Nastavte jej na Drivers.Shapefile
...
{{% blocks/products/pf/agp/code-block title="Uložte KML jako SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML na SHP živé ukázky" sectionDescription="Převádějte KML na SHP hned teď návštěvou našich [živých stránek s ukázkami](https://products.aspose.app/gis/conversion/kml-to-shp). Živá ukázka má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Nahrajte svůj KML soubor, okamžitě se převede na SHP." >}}
...
{{< blocks/products/pf/agp/other-supported-section title="Další podporované převody" subTitle="KML můžete také převést do mnoha dalších formátů souborů, včetně několika uvedených níže." >}}
