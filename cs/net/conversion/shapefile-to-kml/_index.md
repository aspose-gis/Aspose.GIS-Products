...
{{% blocks/products/pf/agp/content h2="Jak převést Shapefile do KML pomocí C#" %}}

Abychom mohli převést Shapefile do KML, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postupy pro převod Shapefile do KML v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Uložení Shapefile jako KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile to KML Live Demos" sectionDescription="Převod Shapefile do KML hned teď návštěvou našich [Live Demos webových stránek](https://products.aspose.app/gis/conversion/shapefile-to-kml). Živá ukázka má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Nahrajte svůj Shapefile soubor, okamžitě se převede na KML." >}}
