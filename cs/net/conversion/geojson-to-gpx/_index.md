---
title: Převod GeoJSON do GIS dat GPX pomocí .NET nebo C#
weight: 120
url: /cs/net/conversion/geojson-to-gpx/ 
description: Vyzkoušejte naše On-Premise API pro převod GeoJSON do GPX na .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převod GeoJSON do GPX v C#" h2="Exportujte GeoJSON do GPX pomocí serverových API, bez nutnosti softwaru jako ArcGIS, ArcMap, QGIS nebo Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GPX" pfName="Aspose.GIS" subTitlepfName="pro .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GeoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést GeoJSON do GPX pomocí C#" %}}

Abychom mohli převést GeoJSON do GPX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postupy pro převod GeoJSON do GPX v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Uložte GeoJSON jako GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GeoJSON to GPX Live Demos" sectionDescription="Převádějte GeoJSON do GPX hned teď návštěvou našich [Live Demos webových stránek](https://products.aspose.app/gis/conversion/geojson-to-gpx). Živá ukázka má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Nahrajte svůj soubor GeoJSON, okamžitě se převede na GPX." >}}
...
GeoJSON je formát založený na JSON, který má reprezentovat geografické objekty s jejich nestrannými atributy. Tento formát definuje různé JSON (JavaScript Object Notation) objekty a způsob jejich spojování. JSON představuje kolektivní informace o geografických objektech, jejich prostorových rozsahech a vlastnostech.
