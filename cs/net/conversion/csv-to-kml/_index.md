...
{{% blocks/products/pf/agp/content h2="Jak převést CSV do KML pomocí C#" %}}

Abychom mohli převést CSV do KML, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postupy pro převod CSV do KML v C#" %}}
...
2.  Zdrojový ovladač, který API sdělí o vstupním formátu. Nastavte jej na Drivers.Csv
...
{{% blocks/products/pf/agp/code-block title="Uložte CSV jako KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV to KML Live Demos" sectionDescription="Převod CSV do KML hned teď návštěvou našich [Live Demos webových stránek](https://products.aspose.app/gis/conversion/csv-to-kml). Živá ukázka má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Nahrajte svůj CSV soubor, okamžitě se převede na KML." >}}
