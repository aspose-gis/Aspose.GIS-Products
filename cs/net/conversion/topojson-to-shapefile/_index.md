---
title: Převod TopoJSON do GIS dat Shapefile pomocí .NET nebo C#
weight: 120
url: /cs/net/conversion/topojson-to-shapefile/ 
description: Vyzkoušejte naše On-Premise API pro převod TopoJSON do Shapefile na .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převod TopoJSON do Shapefile v C#" h2="Export TopoJSON do Shapefile pomocí serverových API, bez nutnosti softwaru jako ArcGIS, ArcMap, QGIS nebo Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="Shapefile" pfName="Aspose.GIS" subTitlepfName="pro .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TopoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést TopoJSON do Shapefile pomocí C#" %}}

Pro převod TopoJSON do Shapefile použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postupy pro převod TopoJSON do Shapefile v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Uložení TopoJSON jako Shapefile - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON to Shapefile Live Demos" sectionDescription="Převod TopoJSON do Shapefile hned teď návštěvou našich [Live Demos webových stránek](https://products.aspose.app/gis/conversion/topojson-to-shapefile). Živá ukázka má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Nahrajte svůj TopoJSON soubor, okamžitě se převede na Shapefile." >}}
