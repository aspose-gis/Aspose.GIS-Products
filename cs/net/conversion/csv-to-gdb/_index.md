---
title: Převod CSV do GIS dat GDB pomocí .NET nebo C#
weight: 120
url: /cs/net/conversion/csv-to-gdb/ 
description: Vyzkoušejte naše On-Premise API pro převod CSV do GDB na .NET Framework, .NET Core, C#.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Převod CSV do GDB v C#" h2="Exportujte CSV do GDB pomocí serverových API, bez nutnosti softwaru jako ArcGIS, ArcMap, QGIS nebo Google Earth." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GDB" pfName="Aspose.GIS" subTitlepfName="pro .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="CSV" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést CSV do GDB pomocí C#" %}}

Abychom mohli převést CSV do GDB, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postupy pro převod CSV do GDB v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Uložte CSV jako GDB - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV to GDB Live Demos" sectionDescription="Převod CSV do GDB hned teď návštěvou našich [Live Demos webových stránek](https://products.aspose.app/gis/conversion/csv-to-gdb). Živá ukázka má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Nahrajte svůj CSV soubor, okamžitě se převede na GDB." >}}
...
Soubory s příponou CSV (Comma Separated Values) představují prosté textové soubory, které obsahují záznamy dat s hodnotami oddělenými čárkami. Každý řádek v CSV souboru je nový záznam z množiny záznamů obsažených v souboru. Takové soubory se generují při přenosu dat mezi různými úložnými systémy. Vzhledem k tomu, že všechny aplikace rozpoznávají záznamy oddělené čárkou, import takových datových souborů do databáze je velmi pohodlný.

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="GDB" readMoreLink="" >}}

GDB je formát používaný platformou Esri ArcGIS. Jedná se o složku, která obsahuje sbírku .gdbtable, .gdbtablx, .gdbindexes, .atx, .spx a .freelist souborů atd.
