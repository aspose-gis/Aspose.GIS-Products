...
{{% blocks/products/pf/agp/content h2="Jak převést GML do KML pomocí C#" %}}

Abychom mohli převést GML do KML, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Postupy pro převod GML do KML v C#" %}}
...
1.  Cílový ovladač pro určení výstupního formátu. Nastavte jej na Drivers.Kml
...
{{% blocks/products/pf/agp/code-block title="Uložte GML jako KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML to KML Live Demos" sectionDescription="Převádějte GML do KML hned teď návštěvou našich [Live Demos webových stránek](https://products.aspose.app/gis/conversion/gml-to-kml). Živá ukázka má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Nahrajte svůj soubor GML, okamžitě se převede na KML." >}}
