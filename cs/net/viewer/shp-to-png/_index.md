...
weight: 40
url: /cs/viewer/shp-to-png
description: Převeďte soubory z formátu SHP do PNG pomocí knihovny navržené speciálně pro vývojáře .NET. API pro vykreslování map Kml, GeoJson Gpx, Kml a dalších souborů.
---

{{< blocks/products/pf/main-wrap-class />}}
{{< blocks/products/pf/upper-banner h1=".NET APIs pro konverzi SHP do PNG" h2="Převeďte SHP do PNG pomocí API navrženého speciálně pro vývojáře .NET / C#." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="pro .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET umožňuje převádět SHP do PNG pro vektorová a rastrová geoprostrorová data. Data jsou užitečná pouze tehdy, když je někdo může vidět. Knihovna GIS pro .NET usnadňuje a urychluje export dat GIS do vektorových nebo rastrových obrázků a poskytuje bohatou symboliku pro složité scénáře vizualizace. 
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Přehled pro konverzi SHP do PNG .NET API." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galerie webových aplikací
      ...
      <p>
        Představujeme bezplatné aplikace, které používají .NET API pro implementaci <a href="https://products.aspose.app/gis/viewer/shp-to-png" >"Konvertoru SHP do PNG"</a> a další. Zde si můžete prohlédnout funkčnost a kvalitu jeho práce. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Ukázka pro .NET - Konvertor SHP do PNG
    </h2>
    <p>
     Zde je postup, jak převést SHP do PNG pomocí výchozích nastavení:
    </p>
