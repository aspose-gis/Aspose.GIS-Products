...
weight: 40
url: /cs/viewer/shapefile-to-jpeg
...
<p>
 Aspose.GIS for .NET umožňuje převést SHAPEFILE do JPEG pro vektorová a rastrová geoprostrorová data. Data jsou užitečná pouze tehdy, když je někdo vidí. Knihovna GIS pro .NET usnadňuje a urychluje export geografických dat do vektorových nebo rastrových obrázků a poskytuje bohatou symboliku pro složité scénáře vizualizace. 
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Přehled pro konverzi SHAPEFILE do JPEG .NET API." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galerie webových aplikací
      ...
      <p>
        Představujeme bezplatné aplikace, které používají .NET API pro implementaci <a href="https://products.aspose.app/gis/viewer/shapefile-to-jpeg" >"Konvertoru SHAPEFILE do JPEG"</a> a další. Zde si můžete prohlédnout funkčnost a kvalitu jeho práce. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Ukázka pro .NET - Konvertor SHAPEFILE do JPEG
    </h2>
    <p>
     Zde je postup, jak převést SHAPEFILE do JPEG pomocí výchozích nastavení:
    </p>
