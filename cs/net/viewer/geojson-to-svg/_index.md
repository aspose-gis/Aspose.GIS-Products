...
weight: 40
url: /cs/viewer/geojson-to-svg
description: Převeďte data z GeoJSON do SVG pomocí knihovny navržené speciálně pro vývojáře .NET. API pro vykreslování map Kml, GeoJson Gpx, Kml a dalších souborů.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs pro převod GeoJSON do SVG" h2="Převeďte GeoJSON do SVG pomocí API navrženého speciálně pro vývojáře .NET / C#." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="pro .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET umožňuje převádět GeoJSON do SVG pro vektorové a rastrové geoprostorová data. Data jsou užitečná pouze tehdy, když je někdo vidí. Knihovna GIS pro .NET usnadňuje a urychluje export dat GIS do vektorových nebo rastrových obrázků a poskytuje bohatou symboliku pro složité scénáře vizualizace. 
</p>

<p>
 Aspose.GIS for .NET je navrženo s ohledem na jednoduchost, výkon, použitelnost a přenositelnost. Obsahuje API pro použití s platformami .NET Framework &amp; .NET Core, což vám umožňuje vytvářet aplikace pro více platforem s velkou snadností.
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Přehled pro převod GeoJSON do SVG .NET API." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galerie webových aplikací
      ...
      <p>
        Představujeme bezplatné aplikace, které používají .NET API pro implementaci <a href="https://products.aspose.app/gis/viewer/geojson-to-svg" >"Konvertoru GeoJSON do SVG"</a> a další. Zde si můžete prohlédnout funkčnost a kvalitu jeho práce. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Ukázka pro .NET - Konvertor GeoJSON do SVG
    </h2>
    <p>
     Zde je postup, jak převést GeoJSON do SVG pomocí výchozích nastavení:
    </p>
