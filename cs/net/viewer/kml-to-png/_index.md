...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Přehled pro konverzi KML do PNG .NET API." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galerie webových aplikací
      ...
      <p>
        Představujeme bezplatné aplikace, které používají .NET API pro implementaci <a href="https://products.aspose.app/gis/viewer/kml-to-png" >"Konvertoru KML do PNG"</a> a další. Zde si můžete prohlédnout funkčnost a kvalitu jeho práce. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Ukázka pro .NET - Konvertor KML do PNG
    </h2>
    <p>
     Zde je postup, jak převést KML do PNG pomocí výchozích nastavení:
    </p>
