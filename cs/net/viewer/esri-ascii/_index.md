...
weight: 40
url: /cs/viewer/esri-ascii
description: Vyvíjejte prohlížeč ESRI-ASCII pomocí knihovny navržené speciálně pro vývojáře .NET. API pro vykreslování map Kml, GeoJson Gpx, Kml a dalších souborů.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs pro prohlížeč ESRI-ASCII" h2="Vyvíjejte prohlížeč ESRI-ASCII s API navrženým speciálně pro vývojáře .NET / C#." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="pro .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET umožňuje vytvářet prohlížeč ESRI-ASCII pro formáty geodat s vektorovými a rastrovými daty. Data jsou užitečná pouze tehdy, když je někdo může vidět. Knihovna GIS pro .NET usnadňuje a urychluje export geografických dat do vektorových nebo rastrových obrázků a poskytuje bohatou symboliku pro složité scénáře vizualizace. 
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Přehled API prohlížeče ESRI-ASCII pro .NET." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galerie webových aplikací
      ...
      <p>
        Představujeme bezplatné aplikace, které používají .NET API pro implementaci <a href="https://products.aspose.app/gis/viewer/esri-ascii" >"ESRI-ASCII Viewer"</a> a další. Zde si můžete prohlédnout funkčnost a kvalitu jeho práce. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Ukázka pro .NET - ESRI-ASCII Viewer
    </h2>
    <p>
     Zde je postup, jak vykreslit mapu z formátu ESRI-ASCII pomocí výchozích nastavení:
    </p>
