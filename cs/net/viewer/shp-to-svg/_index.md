...
<p>
 Aspose.GIS pro .NET umožňuje převádět SHP do SVG pro vektorová a rastrová geoprostrorová data. Data jsou užitečná pouze tehdy, když je někdo může vidět. Knihovna GIS pro .NET usnadňuje a urychluje export geografických dat do vektorových nebo rastrových obrázků a poskytuje bohatou symboliku pro složité vizualizační scénáře. 
</p>

<p>
 Aspose.GIS pro .NET je navrženo s ohledem na jednoduchost, výkon, použitelnost a přenositelnost. Obsahuje API pro použití s platformami .NET Framework &amp; .NET Core, což vám umožňuje vytvářet aplikace nezávislé na platformě s velkou snadností.
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Přehled pro konverzi SHP do SVG .NET API." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galerie webových aplikací
      ...
      <p>
        Představujeme bezplatné aplikace, které používají .NET API pro implementaci <a href="https://products.aspose.app/gis/viewer/shp-to-svg" >"Konvertoru SHP do SVG"</a> a další. Zde si můžete prohlédnout funkčnost a kvalitu jeho práce. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Ukázka pro .NET - Konvertor SHP do SVG
    </h2>
    <p>
     Zde je postup, jak převést SHP do SVG pomocí výchozích nastavení:
    </p>
