...
weight: 40
url: /cs/viewer/shapefile-to-svg
description: Převeďte soubor SHAPEFILE do SVG pomocí knihovny navržené speciálně pro vývojáře .NET. Map Rendering APIs pro Kml, GeoJson Gpx, Kml a další soubory.
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET APIs pro konverzi SHAPEFILE do SVG" h2="Převeďte SHAPEFILE do SVG pomocí API navrženého speciálně pro vývojáře .NET / C#." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="pro .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET umožňuje převést SHAPEFILE do SVG pro vektorově a rastrově geospaciální data. Data jsou užitečná pouze tehdy, když je někdo vidí. Knihovna GIS pro .NET usnadňuje a urychluje export dat GIS do vektorových nebo rastrových obrázků a poskytuje bohatou symboliku pro složité scénáře vizualizace. 
</p>
...
{{< blocks/products/pf/carousel-item h3="Map Viewer" description="Přehled pro konverzi SHAPEFILE do SVG .NET API." >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galerie webových aplikací
      ...
      <p>
        Představujeme bezplatné aplikace, které používají .NET API pro implementaci <a href="https://products.aspose.app/gis/viewer/shapefile-to-svg" >"Konvertoru SHAPEFILE do SVG"</a> a další. Zde si můžete prohlédnout funkčnost a kvalitu jeho práce. 
      </p>
...
<!--Code sample-->
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Ukázka pro .NET - Konvertor SHAPEFILE do SVG
    </h2>
    <p>
     Zde je postup, jak převést SHAPEFILE do SVG pomocí výchozích nastavení:
    </p>
