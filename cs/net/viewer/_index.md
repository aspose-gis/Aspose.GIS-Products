...
<p>
 Aspose.GIS for .NET umožňuje vytvářet prohlížeč map pro formáty vektorových a rastrových geodat. Data jsou užitečná pouze tehdy, když je někdo může vidět. Knihovna GIS pro .NET usnadňuje a urychluje export dat GIS do vektorových nebo rastrových obrázků a poskytuje bohatou symboliku pro složité vizualizační scénáře. 
</p>
...
{{< blocks/products/pf/carousel-item h3="Prohlížeč map" description="Přehled API pro vykreslování map .NET." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    <li>Symbolizer bodů</li>
    <li>Symbolizer čar</li>
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Galerie map
      ...
      <div class="row">
        <div class="col-md-12">{{< figure src="london-roads.png" title="Mapa londýnských silnic" alt="Mapa londýnských silnic" class="img-fluid" width="100%" >}} </div>
      </div>
      <div class="row">
        <div class="col-md-6">{{< figure src="city-quarter.png" title="Mapa městské čtvrti" alt="Mapa městské čtvrti" class="img-fluid" width="100%" >}} </div>
        <div class="col-md-6">{{< figure src="africa-rivers.png" title="Mapa řek Afriky" alt="Mapa řek Afriky" class="img-fluid" width="100%">}} </div>
      </div>
   </div>

   <div class="col-lg-12">
    <h2 class="h2title">
     Prohlížeč map - Ukázka kódu pro .NET
    </h2>
    <p>
     Zde je postup, jak vykreslit mapu ze souboru shapefile do SVG pomocí výchozích nastavení:
    </p>
