---
title: .NET 坐标转换 API - Aspose
weight: 40
url: /zh/net/coordinates
description: 通过专门为 .NET 开发人员设计的库开发坐标转换器。支持 DD、DMS、DDM、GeoRef 和其他格式的坐标转换 API。
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1=".NET GIS 坐标转换 API" h2="为 .NET / C# 开发人员设计 API，开发坐标转换器。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/gis/net" >}}
...
<p>
 Aspose.GIS for .NET 使您可以创建用于地理空间单位的坐标转换器。我们的库允许您轻松快速地将纬度和经度转换为所需的单位格式。此外，我们的库还包含从文本中提取位置点的可能性。
</p>

<p>
 Aspose.GIS for .NET 的设计考虑了简单性、性能、可用性和可移植性。它包含与 .NET Framework 和 .NET Core 平台一起使用的 API，使您可以轻松构建跨平台应用程序。
</p>
...
{{< blocks/products/pf/carousel-item h3="概览" description=".NET / C# API 坐标转换器的概述。" >}}
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Web 应用库
      ...
      <p>
        我们展示了使用 .NET API 实现坐标转换器和其他功能的免费应用程序。您可以在这里探索其功能和质量。
      </p>
