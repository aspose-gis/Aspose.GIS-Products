...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 OSM 转换为 SHP" %}}

 为了将 OSM 转换为 SHP，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="使用 C# 将 OSM 转换为 SHP 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 OSM 保存为 SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="OSM 到 SHP 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/osm-to-shp) 立即将 OSM 转换为 SHP。在线演示具有以下优点" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 OSM 文件，它将立即转换为 SHP。" >}}
