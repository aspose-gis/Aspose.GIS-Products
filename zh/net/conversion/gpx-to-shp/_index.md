...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 GPX 转换为 SHP" %}}

 为了将 GPX 转换为 SHP，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="使用 C# 将 GPX 转换为 SHP 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 GPX 保存为 SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GPX 到 SHP 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/gpx-to-shp) 立即将 GPX 转换为 SHP。在线演示具有以下优势" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 无需下载 Aspose GIS API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 仅选择 SHP 作为输出格式。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 GPX 文件，它将立即转换为 SHP。" >}}
...
GPX 扩展名代表用于在互联网上的应用程序和服务之间交换 GPS 数据的 GPS Exchange 格式。它是一种轻量级的 XML 格式，包含 GPS 数据，即航点、路线和轨迹，以便被多个程序导入和读取。 GPX 是开放的，并受各种应用程序和 GPS 设备的支持。

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="SHP" readMoreLink="https://docs.fileformat.com/gis/shp/" >}}

 Shapefile 是一种多文件格式（称为 ESRI Shapefile）。主要的扩展名为 SHP。Shapefile 是一种流行的矢量地理文件格式。由 ESRI 开发和维护，以兼容 Esri 产品和其他程序。
