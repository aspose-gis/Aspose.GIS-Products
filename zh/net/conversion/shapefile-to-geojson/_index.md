---
title: 将 Shapefile 转换为 GeoJSON GIS 数据，使用 .NET 或 C#
weight: 120
url: /zh/net/conversion/shapefile-to-geojson/ 
description: 使用我们的本地 API 将 Shapefile 转换为 GeoJSON 在 .NET Framework、.NET Core、C# 上。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 C# 中将 Shapefile 转换为 GeoJSON" h2="使用服务器端 API 将 Shapefile 导出到 GeoJSON，无需像 ArcGIS、ArcMap、QGIS 或 Google Earth 这样的软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 Shapefile 转换为 GeoJSON" %}}

 为了将 Shapefile 转换为 GeoJSON，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 Shapefile 转换为 GeoJSON 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 Shapefile 保存为 GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile 到 GeoJSON 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/shapefile-to-geojson) 立即将 Shapefile 转换为 GeoJSON。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 Shapefile 文件，它将立即转换为 GeoJSON。" >}}
...
SHP 是用于表示 ESRI Shapefile 的主要文件类型之一的文件扩展名。它以矢量数据的形式表示地理空间信息，供地理信息系统 (GIS) 应用程序使用。该格式是作为开放规范开发的，以便促进 ESRI 与其他软件产品之间的互操作性。
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的转换" subTitle="您还可以将 Shapefile 转换为许多其他文件格式，包括下面列出的几种。" >}}
