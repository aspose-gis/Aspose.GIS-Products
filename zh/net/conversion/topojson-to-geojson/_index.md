---
title: 将 TopoJSON 转换为 GeoJSON GIS 数据，使用 .NET 或 C#
weight: 120
url: /zh/net/conversion/topojson-to-geojson/
description: 使用我们的本地 API 将 TopoJSON 转换为 GeoJSON 在 .NET Framework、.NET Core、C# 上。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="在 C# 中将 TopoJSON 转换为 GeoJSON" h2="使用服务器端 API 将 TopoJSON 导出到 GeoJSON，无需像 ArcGIS、ArcMap、QGIS 或 Google Earth 这样的软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TopoJSON" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 TopoJSON 转换为 GeoJSON" %}}

 为了将 TopoJSON 转换为 GeoJSON，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 TopoJSON 转换为 GeoJSON 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

可以使用 *VectorLayer.Convert* 方法进行转换，只需一行代码即可。它接受四个参数，如下详细所述。
...
{{% blocks/products/pf/agp/code-block title="将 TopoJSON 保存为 GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON 到 GeoJSON 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/topojson-to-geojson) 立即将 TopoJSON 转换为 GeoJSON。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 TopoJSON 文件，它将立即转换为 GeoJSON。" >}}
...
GeoJSON 是一个基于 JSON 的格式，旨在表示地理特征及其非空间属性。此格式定义了不同的 JSON（JavaScript 对象表示法）对象及其连接方式。JSON 代表有关地理特征、其空间范围和属性的集体信息。
