---
title: 将 JSON 转换为 GeoJSON GIS 数据，使用 .NET 或 C#
weight: 120
url: /zh/net/conversion/json-to-geojson/
description: 使用我们的本地 API 将 JSON 转换为 GeoJSON 在 .NET Framework、.NET Core 和 C# 上。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/upper-banner h1="在 C# 中将 JSON 转换为 GeoJSON" h2="使用服务器端 API 将 JSON 导出到 GeoJSON，无需像 ArcGIS、ArcMap、QGIS 或 Google Earth 这样的软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="GeoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="JSON" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 JSON 转换为 GeoJSON" %}}

 为了将 JSON 转换为 GeoJSON，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 JSON 转换为 GeoJSON 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 JSON 保存为 GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="JSON 到 GeoJSON 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/json-to-geojson) 立即将 JSON 转换为 GeoJSON。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 JSON 文件，它将立即转换为 GeoJSON。" >}}
...
基于 JSON 的格式，设计用于表示地理要素及其非空间属性。此格式定义了不同的 JSON（JavaScript 对象表示法）对象及其连接方式。JSON 代表有关地理要素、其空间范围和属性的集体信息。

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="GeoJSON" readMoreLink="https://docs.fileformat.com/gis/geojson/" >}}

GeoJSON 是基于 JSON 的格式，设计用于表示地理要素及其非空间属性。此格式定义了不同的 JSON（JavaScript 对象表示法）对象及其连接方式。JSON 代表有关地理要素、其空间范围和属性的集体信息。
