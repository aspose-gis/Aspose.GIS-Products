...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 GDB 转换为 GPX" %}}

 为了将 GDB 转换为 GPX，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="将 GDB 转换为 GPX 在 C# 中的步骤" %}}
...
2.  源驱动程序，让 API 了解输入格式。将其设置为 Drivers.FileGdb
...
{{% blocks/products/pf/agp/code-block title="将 GDB 保存为 GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GDB 到 GPX 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/gdb-to-gpx) 立即将 GDB 转换为 GPX。在线演示具有以下优势" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 无需下载 Aspose GIS API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 仅选择 GPX 作为输出格式，然后。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 GDB 文件，它将立即转换为 GPX。" >}}
...
GDB 是 Esri ArcGIS 平台使用的格式。这是一个包含 .gdbtable、.gdbtablx、.gdbindexes、.atx、.spx 和 .freelist 文件等的文件夹。

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="GPX" readMoreLink="https://docs.fileformat.com/gis/gpx/" >}}

GPX 扩展名代表 GPS Exchange 格式，用于在互联网上的应用程序和服务之间交换 GPS 数据。它是一种轻量级的 XML 格式，包含 GPS 数据，即航点、路线和轨迹，以便多个程序导入和读取。 GPX 是开放的，并受各种应用程序和 GPS 设备的支持。
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的转换" subTitle="您还可以将 GDB 转换为许多其他文件格式，包括以下列出的几种。" >}}

{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/gdb-to-csv" name="GDB TO CSV" description="逗号分隔值" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/gdb-to-kml" name="GDB TO KML" description="关键词标记语言" >}}
