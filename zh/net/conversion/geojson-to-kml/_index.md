...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 GeoJSON 转换为 KML" %}}

 为了将 GeoJSON 转换为 KML，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 GeoJSON 转换为 KML 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 GeoJSON 保存为 KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GeoJSON 到 KML 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/geojson-to-kml) 立即将 GeoJSON 转换为 KML。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 GeoJSON 文件，它将立即转换为 KML。" >}}
...
KML（Keyhole Markup Language）包含以 XML 符号表示的地理空间信息。如果它们支持 KML，则可以在地理信息系统 (GIS) 应用程序中打开 KML。许多应用程序在采用为国际标准后开始提供对 KML 格式的支持。
