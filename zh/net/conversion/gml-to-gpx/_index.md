...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 GML 转换为 GPX" %}}

 为了将 GML 转换为 GPX，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 GML 转换为 GPX 的步骤" %}}
...
4.  目标驱动程序以指定输出格式。设置为 Drivers.Gpx
...
{{% blocks/products/pf/agp/code-block title="将 GML 保存为 GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML 到 GPX 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/gml-to-gpx) 立即将 GML 转换为 GPX。在线演示具有以下优势" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 无需下载 Aspose GIS API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 仅选择 GPX 作为输出格式。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 GML 文件，它将立即转换为 GPX。" >}}
...
地理标记语言 (也称为 GML) 是 GIS 中使用的基于 XML 的格式。GML 是在互联网上进行地理事务的开放交换格式。这种格式是数据和结构导向的。

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="GPX" readMoreLink="https://docs.fileformat.com/gis/gpx/" >}}

GPX 扩展名代表 GPS 交换格式，用于在互联网上的应用程序和服务之间交换 GPS 数据。它是一种轻量级的 XML 格式，包含 GPS 数据，即航点、路线和轨迹，以便被多个程序导入和读取。 GPX 是开放的，并受到各种应用程序和 GPS 设备的支持。
