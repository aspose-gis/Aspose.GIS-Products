...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 KML 转换为 GPX" %}}

 为了将 KML 转换为 GPX，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="使用 C# 将 KML 转换为 GPX 的步骤" %}}
...
4.  目标驱动程序指定输出格式。将其设置为 Drivers.Gpx
...
{{% blocks/products/pf/agp/code-block title="将 KML 保存为 GPX - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML 到 GPX 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/kml-to-gpx) 立即将 KML 转换为 GPX。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 KML 文件，它将立即转换为 GPX。" >}}
...
GPX 扩展表示用于在互联网上的应用程序和服务之间交换 GPS 数据的 GPS Exchange 格式。它是一种轻量级的 XML 格式，包含 GPS 数据，即航点、路线和轨迹，以便多个程序导入和读取。 GPX 是开放的，并受各种应用程序和 GPS 设备的支持。
