---
title: 将 GDB 转换为 SHP GIS 数据，使用 .NET 或 C#
weight: 120
url: /zh/net/conversion/gdb-to-shp/ 
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 GDB 转换为 SHP" %}}

 为了将 GDB 转换为 SHP，我们将使用
...
{{% blocks/products/pf/agp/code-block title="将 GDB 保存为 SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GDB 到 SHP 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/gdb-to-shp) 立即将 GDB 转换为 SHP。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 GDB 文件，它将立即转换为 SHP。" >}}
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的转换" subTitle="您还可以将 GDB 转换为许多其他文件格式，包括以下列出的内容。" >}}
