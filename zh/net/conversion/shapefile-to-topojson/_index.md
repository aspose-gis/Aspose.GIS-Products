---
title: 将 Shapefile 转换为 TopoJSON GIS 数据，使用 .NET 或 C#
weight: 120
url: /zh/net/conversion/shapefile-to-topojson/ 
description: 使用我们的本地 API 将 Shapefile 转换为 TopoJSON 在 .NET Framework、.NET Core、C# 上。
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="将 Shapefile 转换为 TopoJSON 在 C#" h2="使用服务器端 API 将 Shapefile 导出为 TopoJSON，无需像 ArcGIS、ArcMap、QGIS 或 Google Earth 这样的软件。" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/gis/aspose_gis-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TopoJSON" pfName="Aspose.GIS" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="Shapefile" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 Shapefile 转换为 TopoJSON" %}}

 为了将 Shapefile 转换为 TopoJSON，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 Shapefile 转换为 TopoJSON 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 Shapefile 保存为 TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile 到 TopoJSON 在线演示" sectionDescription="通过访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/shapefile-to-topojson) 立即将 Shapefile 转换为 TopoJSON。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 Shapefile 文件，它将立即转换为 TopoJSON。" >}}
...
TopoJSON 是一个编码拓扑的 GeoJSON 扩展。基于 JSON 的格式，旨在表示地理特征及其非空间属性。此格式定义了不同的 JSON（JavaScript 对象表示法）对象以及它们的连接方式。JSON 格式代表有关地理特征、其空间范围和属性的集体信息。
