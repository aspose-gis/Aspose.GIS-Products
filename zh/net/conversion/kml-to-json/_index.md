...
weight: 120
url: /zh/net/conversion/kml-to-json/
...
2.  源驱动程序让 API 了解输入格式。将其设置为 Drivers.Kml
...
<!-- aboutfile Starts -->
{{< blocks/products/pf/agp/demobox sectionTitle="KML 到 GeoJSON 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/kml-to-json) 立即将 KML 转换为 GeoJSON。在线演示具有以下优势" >}}
