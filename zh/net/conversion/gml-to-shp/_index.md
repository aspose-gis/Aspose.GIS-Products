...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 GML 转换为 SHP" %}}

 为了将 GML 转换为 SHP，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="将 GML 转换为 SHP 在 C# 中的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 GML 保存为 SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML 到 SHP 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/gml-to-shp) 立即将 GML 转换为 SHP。在线演示具有以下优势" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 无需下载 Aspose GIS API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 仅选择 SHP 作为输出格式，然后。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 GML 文件，它将立即转换为 SHP。" >}}
...
地理标记语言 (也称为 GML) 是 GIS 中使用的基于 XML 的格式。GML 是在 Internet 上进行地理交易的开放交换格式。此格式是数据和结构导向的。

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="SHP" readMoreLink="https://docs.fileformat.com/gis/shp/" >}}

Shapefile 是一种多文件格式（也称为 ESRI Shapefile）。主文件具有 SHP 扩展名。Shapefile 是一种流行的矢量地理文件格式。由 ESRI 开发和维护，以兼容 Esri 产品和其他程序。
