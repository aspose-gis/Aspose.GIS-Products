...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 KML 转换为 GeoJSON" %}}

 为了将 KML 转换为 GeoJSON，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="使用 C# 将 KML 转换为 GeoJSON 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 KML 保存为 GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML 到 GeoJSON 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/kml-to-geojson) 立即将 KML 转换为 GeoJSON。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 KML 文件，它将立即转换为 GeoJSON。" >}}
...
GeoJSON 是一种基于 JSON 的格式，旨在表示具有非空间属性的地形特征。此格式定义了不同的 JSON（JavaScript 对象表示法）对象及其连接方式。JSON 代表有关地理特征、其空间范围和属性的集体信息。
