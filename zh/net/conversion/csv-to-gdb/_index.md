...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 CSV 转换为 GDB" %}}

 为了将 CSV 转换为 GDB，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="使用 C# 将 CSV 转换为 GDB 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 CSV 保存为 GDB - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV 到 GDB 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/csv-to-gdb) 立即将 CSV 转换为 GDB。在线演示具有以下优点" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 CSV 文件，它将立即转换为 GDB。" >}}
...
GDB 是 Esri ArcGIS 平台使用的格式。这是包含 .gdbtable、.gdbtablx、.gdbindexes、.atx、.spx 和 .freelist 文件等的文件夹。
