...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 GML 转换为 KML" %}}

 为了将 GML 转换为 KML，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="使用 C# 将 GML 转换为 KML 的步骤" %}}
...
4.  目标驱动程序以指定输出格式。将其设置为 Drivers.Kml
...
{{% blocks/products/pf/agp/code-block title="将 GML 保存为 KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML 到 KML 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/gml-to-kml) 立即将 GML 转换为 KML。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 GML 文件，它将立即转换为 KML。" >}}
...
地理标记语言 (也称为 GML) 是 GIS 中使用的基于 XML 的格式。GML 是在互联网上进行地理交易的开放交换格式。此格式是数据和结构导向的。

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="KML" readMoreLink="https://docs.fileformat.com/gis/kml/" >}}

KML（Keyhole Markup Language）包含以 XML 符号表示的地理空间信息。如果它们支持 KML，则可以在地理信息系统 (GIS) 应用程序中打开 KML。在采用为国际标准后，许多应用程序已开始提供对 KML 格式的支持。
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/gml-to-kml" name="GML TO KML" description="关键词标记语言" >}}
