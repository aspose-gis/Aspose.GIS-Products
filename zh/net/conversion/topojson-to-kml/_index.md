...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 TopoJSON 转换为 KML" %}}

 为了将 TopoJSON 转换为 KML，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 TopoJSON 转换为 KML 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 TopoJSON 保存为 KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="TopoJSON 到 KML 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/topojson-to-kml) 立即将 TopoJSON 转换为 KML。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 TopoJSON 文件，它将立即转换为 KML。" >}}
...
TopoJSON 是一个编码拓扑的 GeoJSON 扩展。基于 JSON 的格式，旨在表示地理要素及其非空间属性。此格式定义了不同的 JSON（JavaScript 对象表示法）对象及其连接方式。JSON 格式代表有关地理特征、其空间范围和属性的集体信息。
