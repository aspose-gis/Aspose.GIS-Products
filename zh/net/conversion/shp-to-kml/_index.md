...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 SHP 转换为 KML" %}}

 为了将 SHP 转换为 KML，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="使用 C# 将 SHP 转换为 KML 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 SHP 保存为 KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="SHP 到 KML 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/shp-to-kml) 立即将 SHP 转换为 KML。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 SHP 文件，它将立即转换为 KML。" >}}
