...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 OSM 转换为 KML" %}}

 为了将 OSM 转换为 KML，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 OSM 转换为 KML 的步骤" %}}
...
1.  指向源 OSM 文件字符串类型的文件路径
2.  源驱动程序，让 API 了解输入格式。将其设置为 Drivers.OsmXml
...
{{% blocks/products/pf/agp/code-block title="将 OSM 保存为 KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="OSM 到 KML 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/osm-to-kml) 立即将 OSM 转换为 KML。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 OSM 文件，它将立即转换为 KML。" >}}
...
OSM 格式是 OpenStreetMap 特有的。OpenStreetMap 项目维护着一个免费的世界街道数据库。

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="KML" readMoreLink="https://docs.fileformat.com/gis/kml/" >}}

KML（Keyhole Markup Language）包含以 XML 符号表示的地空信息。如果它们支持，则可以在地理信息系统 (GIS) 应用程序中打开 KML。在它被采用为国际标准后，许多应用程序都开始提供对 KML 格式的支持。
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的转换" subTitle="您还可以将 OSM 转换为许多其他文件格式，包括下面列出的几种。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/osm-to-kml" name="OSM TO KML" description="关键词标记语言" >}}
