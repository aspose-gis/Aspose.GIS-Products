...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 GML 转换为 JSON" %}}

 为了将 GML 转换为 JSON，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 GML 转换为 JSON 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 GML 保存为 JSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GML 到 JSON 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/gml-to-json) 立即将 GML 转换为 JSON。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 GML 文件，它将立即转换为 JSON。" >}}
...
基于 JSON 的格式，旨在用它们的非空间属性表示地理要素。此格式定义了不同的 JSON（JavaScript 对象表示法）对象及其连接方式。JSON 代表有关地理特征、它们的空间范围和属性的集体信息。
