...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 Shapefile 转换为 KML" %}}

 为了将 Shapefile 转换为 KML，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 Shapefile 转换为 KML 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 Shapefile 保存为 KML - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Shapefile 到 KML 在线演示" sectionDescription="通过访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/shapefile-to-kml) 立即将 Shapefile 转换为 KML。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 Shapefile 文件，它将立即转换为 KML。" >}}
...
SHP 是用于表示 ESRI Shapefile 的主要文件类型之一的文件扩展名。它以矢量数据的形式表示地理空间信息，供地理信息系统 (GIS) 应用程序使用。该格式已作为开放规范开发，以便促进 ESRI 与其他软件产品之间的互操作性。

        {{< /blocks/products/pf/agp/about-file-text >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="KML" readMoreLink="https://docs.fileformat.com/gis/kml/" >}}

KML（Keyhole Markup Language）包含以 XML 符号表示的地理空间信息。如果 KML 支持，则可以在地理信息系统 (GIS) 应用程序中打开 KML。在它被采用为国际标准后，许多应用程序都开始支持 KML 格式。
...
{{< blocks/products/pf/agp/other-supported-section title="其他支持的转换" subTitle="您还可以将 Shapefile 转换为许多其他文件格式，包括下面列出的几个。" >}}
