...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 GPX 转换为 TopoJSON" %}}

 为了将 GPX 转换为 TopoJSON，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 GPX 转换为 TopoJSON 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 可以通过使用
 *VectorLayer.Convert*
 方法，只需一行代码即可完成转换。它接受四个参数，如下所述。
...
4.  目标驱动程序以指定输出格式。设置为 Drivers.TopoJson
...
{{% blocks/products/pf/agp/code-block title="将 GPX 保存为 TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GPX 到 TopoJSON 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/gpx-to-topojson) 立即将 GPX 转换为 TopoJSON。在线演示具有以下优势" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 无需下载 Aspose GIS API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 仅选择 TopoJSON 作为输出格式，然后。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 GPX 文件，它将立即转换为 TopoJSON。" >}}
