...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 GeoJSON 转换为 SHP" %}}

 为了将 GeoJSON 转换为 SHP，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="将 GeoJSON 转换为 SHP 在 C# 中的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 GeoJSON 保存为 SHP - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="GeoJSON 到 SHP 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/geojson-to-shp) 立即将 GeoJSON 转换为 SHP。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 GeoJSON 文件，它将立即转换为 SHP。" >}}
...
GeoJSON 是一种基于 JSON 的格式，旨在表示地理要素及其非空间属性。此格式定义了不同的 JSON（JavaScript 对象表示法）对象以及它们的连接方式。JSON 代表有关地理特征、其空间范围和属性的集体信息。
 ...
 Shapefile 是一种多文件格式（称为 ESRI Shapefile）。主文件具有 SHP 扩展名。Shapefile 是一种流行的矢量地理文件格式。由 ESRI 开发和维护，以确保 Esri 产品和其他程序之间的兼容性。
