...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 CSV 转换为 GeoJSON" %}}

 为了将 CSV 转换为 GeoJSON，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中将 CSV 转换为 GeoJSON 的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 CSV 保存为 GeoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="CSV 到 GeoJSON 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/csv-to-geojson) 立即将 CSV 转换为 GeoJSON。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 CSV 文件，它将立即转换为 GeoJSON。" >}}
...
GeoJSON 是一种基于 JSON 的格式，旨在表示地理要素及其非空间属性。此格式定义了不同的 JSON（JavaScript 对象表示法）对象以及它们的连接方式。JSON 表示有关地理特征、其空间范围和属性的集体信息。
