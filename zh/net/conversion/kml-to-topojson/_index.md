...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 KML 转换为 TopoJSON" %}}

 为了将 KML 转换为 TopoJSON，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="使用 C# 将 KML 转换为 TopoJSON 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 可以通过使用
 *VectorLayer.Convert* 
 方法用一行代码完成转换。它接受四个参数，如下所述。
...
{{% blocks/products/pf/agp/code-block title="将 KML 保存为 TopoJSON - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="KML 到 TopoJSON 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/kml-to-topojson) 立即将 KML 转换为 TopoJSON。在线演示具有以下优势" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 无需下载 Aspose GIS API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 仅选择 TopoJSON 作为输出格式。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 KML 文件，它将立即转换为 TopoJSON。" >}}
...
KML（Keyhole Markup Language）包含以 XML 符号表示的地空间信息。如果它们支持 KML，则可以在地理信息系统 (GIS) 应用程序中打开 KML。在它被采用为国际标准后，许多应用程序已经开始提供对 KML 格式的支持。
