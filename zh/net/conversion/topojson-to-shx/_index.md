...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 TOPOJSON 转换为 SHX" %}}

 为了将 TOPOJSON 转换为 SHX，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="将 TOPOJSON 转换为 SHX 在 C# 中的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="将 TOPOJSON 保存为 SHX - C#" offSpacer="" %}}

```cs
// 将 TOPOJSON GIS 数据转换为 SHX 数据
...
{{< blocks/products/pf/agp/demobox sectionTitle="TOPOJSON 到 SHX 在线演示" sectionDescription="访问我们的 [在线演示网站](https://products.aspose.app/gis/conversion/topojson-to-shx) 立即将 TOPOJSON 转换为 SHX。在线演示具有以下优势" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 上传您的 TOPOJSON 文件，它将立即转换为 SHX。" >}}
...
TopoJSON 是 GeoJSON 的扩展，用于编码拓扑结构。 与分别表示几何图形不同，TopoJSON 文件中的几何图形通过称为弧线的共享线段拼接在一起。
了解更多
...
形状索引格式，是对特征几何的位置索引，以便能够快速向前和向后查找
了解更多
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/topojson-to-geojson" name="TOPOJSON TO GEOJSON" description="基于 JSON 的格式" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/topojson-to-json" name="TOPOJSON TO JSON" description="JavaScript 对象表示法" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/gis/net/conversion/topojson-to-kml" name="TOPOJSON TO KML" description="Keyhole 标记语言" >}}
